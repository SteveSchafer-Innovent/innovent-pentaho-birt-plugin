...
}function r(t){n.log=n.logger("[DEF]"),et&&et.forEach(function(n){n(t)})}function e(){return n.debug
}function i(n,t){n=u(n,t);var r=c("log",n);return r.log=r,r.level=e,ut.forEach(function(t){r[t]=c(ot[t]||t,n)
}),r}function u(t,r){return t&&(n.fun.is(t)?t.call(r):t)}function o(t,r,o){var a=function(e){if(n.debug>1){var a=t[r||"log"]=i(o,t);
a[e||"log"].apply(a,V.call(arguments,1))}else"error"===e&&s.apply(null,n.array.append([u(o,t)],arguments,1))
},c=a.bind("log");return c.log=c,c.level=e,ut.forEach(function(n){c[n]=a.bind(n)}),c
}function a(){function n(){}return n.log=n,n.level=e,ut.forEach(function(t){n[t]=n
...
}t||(t=at(r));var u=this;return i.init=e,i.propertyName=t,i}function p(n){var t;n&&(n instanceof Array?(t=n,n=t.join(".")):t=n.split(".")),t&&t.length>1?(this.name=t.pop(),this.namespace=t.join(".")):(this.name=n||null,this.namespace=null)
}function y(t,r){var e=r||ct;if(t){var i=t.split("."),u=i.length;if(u){var o,a=0;
if(e===n.global){o=i[0];var s=n.getOwn(ft,o);s&&(e=s,a++)}for(;u>a;)o=i[a++],e=e[o]||(e[o]={})
}}return e}function v(n){return function(t){return d(t,V.call(arguments,1),n)}}function d(t,r,e){for(var i,u=0,o=r.length;o>u;)(i=r[u++])&&(i=n.object.as(i.prototype||i),i&&g(t,i,e));
return t}function g(n,t,r){for(var e in t)m(n,e,t[e],r)}function m(t,r,e,i){if(void 0!==e){var u,o=n.object.asNative(t[r]);
o?(u=n.object.as(e),u?(Z.call(t,r)||(t[r]=o=Object.create(o)),g(o,u,i)):t[r]=e):(u=n.object.asNative(e),u&&(e=(i||Object.create)(u)),t[r]=e)
...
}finally{n.base=e}}return t?r&&r!==t&&S(t)?(N(e),n.fun.wraps(e?i:u,t)):t:r}function S(n){return pt.test(n)
}function N(t){if(t===G)throw n.error.invalidArgument("proto","Cannot change Object.prototype.");
return t}function Q(t){N(n.protoOf(t))}function C(t,r){var e=n.fun.as(t[r]);return e===G[r]?null:e
}function T(t,r,e){t=tt(t);var i=n.protoOf(t),u=n.rootProtoOf(t),o=n.get(e,"enumerable",!0);
return n.array.each(r,function(r){(r=tt(r))&&(nt?n.ownKeys(r).forEach(function(n){I(t,n,nt(r,n),i,u,o)
}):n.eachOwn(r,function(n,r){M(t,r,n,i,u,o)}))}),n}function E(t,r,e,i){t=tt(t);var u=n.get(i,"enumerable",!0);
...
}function I(t,r,e,i,u,o){var a;if(k(r))if(e.get||e.set){var s=q(i,r);s&&((e.get||s.get)&&(e.get=n.overrides(e.get,s.get,u)),(e.set||s.set)&&(e.set=n.overrides(e.set,s.set,u))),o||(e.enumerable=!1),Y(t,r,e)
}else void 0!==(a=e.value)&&P(t,r,a,u,o);return n}function q(t,r){var e;if(r in t)for(;t=n.protoOf(t);)if(e=nt(t,r))return e
...
}function F(t){return n.fun.is(t)&&t.meta instanceof R}function D(t,r){n.methods(this,t,r);
var e=this.Ctor;return e&&L.call(this,e,t),this}function L(t,r){var e=this.prototype;
n.array.each(r,function(r){n.each(tt(r),function(r,i){n.isPropPrivate(i)||(r=e[i],n.fun.is(r)?K(t,i,r):t[i]=r)
})})}function K(t,r,e){function i(){var n=this.meta,t=e.apply(n,arguments);return t===n?this:t
}t[r]=n.fun.wraps(i,e)}function B(t){var r=n.classOf(this);return r(t,this)}function z(t,r){function e(r,e){if(void 0!==e){var o=r[t];
if(null===e)r.___proto&&Z.call(r,t)&&(delete r[t],e=r[t],s&&e!==o&&s(e,o,this,t));
...
if(null==u){if(!a)return;if(Z.call(r,t))return n.configure(i,e),void 0;if(!o)return;
...
r&&(this.fieldsPrivProp=r.constructor===J?n.get(e,"fieldsPrivProp")||dt:r.fieldsPrivProp)
}function U(){for(;this._source.next();){var t=this._selectMany?this._selectMany.call(this._ctx,this._source.item,this._source.index):this._source.item;
if(null!=t)return this._manySource=n.query(t),!0}}function $(n,t){return t?(n=n.toString().split("e"),+(n[0]+"e"+(n[1]?+n[1]+t:t))):n
}var W=function(){for(var n in{toString:1})if("toString"===n)return!1;return!0}(),G=Object.prototype,Z=G.hasOwnProperty,H=W?["toString","valueOf"]:null;
Object.keys||(Object.keys=function(n){if(n!==Object(n))throw new TypeError("Object.keys called on non-object");
var t=[];for(var r in n)Z.call(n,r)&&t.push(r);return H&&H.forEach(function(r){Z.call(n,r)&&t.push(r)
...
});var V=Array.prototype.slice,X=[],Y=function(){var n=Object.defineProperty;if(n)try{n({},"test",{})
}catch(t){return null}return n}(),nt=function(){var n=Y&&Object.getOwnPropertyDescriptor;
return n&&null===n({value:null},"value").value?n:void 0}(),tt=function(n){return n.prototype||n
};n.global=this,n.copyOwn=function(n,t){var r,e;arguments.length>=2?(r=n||{},e=t):(r={},e=n);
for(var i in e)Z.call(e,i)&&(r[i]=e[i]);return r},n.copyOwn(n,{get:function(n,t,r){var e;
...
}},getOwn:function(n,t,r){var e;return n&&Z.call(n,t)&&null!=(e=n[t])?e:r},hasOwn:function(n,t){return!!n&&Z.call(n,t)
},protoOf:Object.getPrototypeOf||function(n){return n.__proto__||n.constructor&&n.constructor.prototype
},rootProtoOf:function(t){for(var r=null,e=n.protoOf(t);e&&e!==G&&e!==r;)e=n.protoOf(r=e);
return r},hasOwnProp:Z,set:function(n){for(var t=n||{},r=arguments,e=1,i=r.length-1;i>e;e+=2)t[r[e]]=r[e+1];
...
for(var a=1;o>a;a+=2)e=u[a],void 0===i[e]&&(i[e]=u[a+1])}return i},setNonEnum:function(){if(!Y)return function(n,t,r){return n[t]=r,n
};var n={enumerable:!1,configurable:!0,writable:!0,value:void 0};return function(t,r,e){return n.value=e,Y(t,r,n),n.value=null,t
}}(),setConst:function(){if(!Y)return function(n,t,r){return n[t]=r,n};var n={enumerable:!1,configurable:!1,writable:!1,value:void 0};
return function(t,r,e){return n.value=e,Y(t,r,n),n.value=null,t}}(),eachOwn:function(n,t,r){for(var e in n)Z.call(n,e)&&t.call(r,n[e],e,n);
n&&H&&H.forEach(function(e){Z.call(n,e)&&t.call(r,n[e],e,n)})},each:function(n,t,r){for(var e in n)t.call(r,n[e],e,n);
n&&H&&H.forEach(function(e){Z.call(n,e)&&t.call(r,n[e],e,n)})},copy:function(t,r){var e,i;
...
return n&&H&&H.forEach(function(n){t.push(n)}),t},values:function(t){var r=[];return n.each(t,function(n){r.push(n)
}),r},uniqueIndex:function(t,r,e){var i={};return n.each(t,function(n,t){r&&(n=r.call(e,n)),null==n||Z.call(i,n)||(i[n]=t)
...
return n.apply(r,t||X)||r},isPropPrivate:function(n){return!!n&&"_"===n.charAt(0)
...
},lazy:function(n,t,r,e){return n[t]||(n[t]=r?r.call(e,t):[])},copy:function(n){return V.apply(n,V.call(arguments,1))
...
}else if(r.call(e,t,0)===!1)return!1;return!0},like:n.copyOwn(function(n){return rt.is(n)?n:[n]
},{is:function(n){return!!n&&null!=n.length&&"string"!=typeof n},as:function(n){return rt.is(n)?n:null
...
return i>=0?t.splice(i,1)[0]:void 0}};var rt=n.array.like;rt.to=rt,n.string={is:function(n){return"string"==typeof n
...
};var et=null;n.addOnDebugChanged=function(n){et||(et=[]).push(n)};var it,ut=["info","debug","error","warn","group","groupEnd"],ot={group:"groupCollapsed"};
n.logger=function(t,r,e){return n.debug>1?i(t,r):r?o(r,e,t):it||(it=a())},n.setDebug(n.debug),n.priv={key:f};
var at=function(t){return"_"+n.nullyTo(t,"safe")+(new Date).getTime()+Math.round(1e3*Math.random())
},st=n.priv.key();n.copyOwn(n,{scope:function(n,t){return n.call(t)},firstDefined:function(n,t,r){var e,i=0,u=n.length;
...
};var ct=n,ft={},lt=[];n.globalSpace=function(n,t){return ft[n]=t},n.space=function(t,r,e){n.fun.is(r)&&(e=r,r=null),n.string.is(r)&&(r=y(r));
var i=y(t,r);if(e){lt.push(ct);try{e(i)}finally{ct=lt.pop()}}return i},n.describe=function(t,r){var e=n.get(r,"maxLevel")||5,i=[];
...
}return t.push("'new ???'"),!0}},n.mixin=v(Object.create),n.copyOwn(n.mixin,{custom:v,inherit:n.mixin,copy:v(n.copy),share:v(n.identity)}),n.create=function(){var t=V.call(arguments),r=!0,e=t.shift();
...
},n.attached.is=function(n){return!(!n||n.indexOf("$")<0)};var ht={tryConfigure:1,configure:1,$type:1};
...
}),t},isPropConfigurable:function(n){return!!n&&"_"!==n.charAt(0)&&!Z.call(ht,n)},setters:function(t,r){return r&&b.expand1(r).forEach(function(r){n.each(r,function(n,r){b.setter(t,r,n)
...
var pt=/\.\s*base\b/;n.methods=T,n.method=E,n.abstractMethod=n.fail.notImplemented,n("MetaType",R);
var yt={Ctor:1,BaseType:1,prototype:1};n.copyOwn(R,{methods:D,add:n.configurable(!1,function(){return D.apply(this,arguments)
...
return n.fun.inherit(t,i),n.copyx(t,i,{where:function(n,t){return Z.call(n,t)&&"_"!==t.charAt(0)&&!Z.call(yt,t)
...
},type:n.configurable(!0,function(){return this.constructor}),add:n.configurable(!1,function(t,r){return F(t)&&this._mixMetaType(t.meta),n.methods(this.Ctor,t,r),this
...
return r.configure(n)})});var vt=(new R).close().Ctor.add({override:function(t,r){return M(this,t,r,n.protoOf(this),vt.prototype,!0),this
},toString:function(){return"[object "+String(n.qualNameOf(n.classOf(this)))+"]"}},{enumerable:!1});
n("Object",vt),n.type=n.argumentsTypeBound(["string","function","object"],function(t,r,e){var i=r?r.MetaType:R,u=i.extend().Ctor;
...
}return r},createAs:function(t){function r(r,e){return n.as(r,t,e)}return r},isSubClassOf:function(t,r){return!(!t||!r||t!==r&&!n.is(tt(t),r))
}});var dt=st.property();n.copyOwn(n,{instance:function(t,r,e,i,u){var o=n.fields(t,e,u);
return i&&n.instanceAccessors(t,o,i),t.createChild=B,r&&n.configure(t,r),o},fields:function(t,r,e){var i=n.classOf(t);
r&&n.is(r,i)||(r=i.defaults),void 0===e&&(e=dt);var u=r&&e&&e(r),o=u?Object.create(u):{};
return o.___proto=r,e&&e.init(t,o),o},classAccessors:function(t,r,e){var i=tt(t);
for(var u in r)i[u]=n.classAccessor(u,r[u],e);return n},classAccessor:function(n,t,r){function e(t){var e=r(this);
return arguments.length?i.call(this,e,t):e[n]}var i=z(n,t);return r||(r=dt),e},instanceAccessors:function(t,r,e){for(var i in e)t[i]=n.instanceAccessor(t,i,e[i],r);
return n},instanceAccessor:function(n,t,r,e){function i(r){return arguments.length?u.call(n,e,r):e[t]
}var u=z(t,r);return i}}),n.MetaType.subType(J,{methods:{fields:function(t){var r={};
...
}t.push(r),this.base(t);var i=this;t.push(e)}}}),n("FieldsBase",J.Ctor);var gt=1,mt={},_t="__def_id__";
return n.nextId=function(t){if(t){var r=n.getOwn(mt,t)||1;return mt[t]=r+1,r}return gt++
},n.id=function(t){var r=n.getOwn(t,_t);return r||n.setConst(t,_t,r=n.nextId()),r
...
},methods:{has:function(n){return Z.call(this.source,n)},add:function(n){var t=this.source;
return Z.call(t,n)||(this.count++,t[n]=!0),this},rem:function(n){return Z.call(this.source,n)&&(delete this.source[n],this.count--),this
...
},methods:{has:function(n){return Z.call(this.source,n)},get:function(n){return Z.call(this.source,n)?this.source[n]:void 0
},set:function(n,t){var r=this.source;return Z.call(r,n)||this.count++,r[n]=t,this
},rem:function(n){return Z.call(this.source,n)&&(delete this.source[n],this.count--),this
...
if(!t.count)return this.clone();var r={},e=0,i=this.source,u=t.source;return n.eachOwn(i,function(n,t){Z.call(u,t)||(r[t]=n,e++)
}),n.eachOwn(u,function(n,t){Z.call(i,t)||(r[t]=n,e++)}),new n.Map(r,e)},intersect:function(t,r){return r||(r=new n.Map),n.eachOwn(this.source,function(n,e){t.has(e)&&r.set(e,n)
...
},methods:{has:function(n){return Z.call(this._map,n)},count:function(){return this._list.length
},get:function(n){var t=this._map;return Z.call(t,n)?t[n].value:void 0},at:function(n){var t=this._list[n];
return t?t.value:void 0},add:function(t,r,e){var i=this._map,u=Z.call(i,t)&&i[t];
return u?u.value!==r&&(u.value=r):(u=i[t]={key:t,value:r},null==e?this._list.push(u):n.array.insertAt(this._list,e,u)),this
},rem:function(n){var t=this._map,r=Z.call(t,n)&&t[n];if(r){var e=this._list.indexOf(r);
...
})}}})),n.html={escape:function(t){return n.string.to(t).replace(/&/gm,"&amp;").replace(/</gm,"&lt;").replace(/>/gm,"&gt;").replace(/"/gm,"&quot;")
},tag:function(t,r){r=r?n.ownKeys(r).map(function(t){var e=r[t];return n.empty(e)?"":" "+t+'="'+String(e)+'"'
}).join(""):"";var e=arguments.length>2?V.call(arguments,2).map(function(t){return null!=t&&(n.fun.is(t)&&(t=t()),t=n.array.is(t)?t.map(n.string.to).join(""):n.string.to(t)),t||""
}).join(""):"";return"<"+t+r+">"+e+"</"+t+">"},classes:function(t){t=t?t+"-":"";var r=[];
return V.call(arguments,1).forEach(function(e){n.empty(e)||r.push(t+n.css.escapeClass(e))
...
return this.each(function(e){var i=n?n.call(t,e):e;null==i||Z.call(r,i)||(r[i]=e)
...
}),n.type("ArrayLikeQuery",n.Query).init(function(t){function r(){for(;++i<u;)if(Z.call(t,i))return e.index=i,e.item=t[i],!0;
...
this._manySource=null}if(!U.call(this))break}}}),n.type("DistinctQuery",n.Query).init(function(n,t,r){function e(){for(;n.next();){var e=n.item,a=t?t.call(r,e,n.index):e;
if(null!=a&&!Z.call(o,a))return i.item=e,i.index=++u,o[a]=!0}return i._finish(),!1
...
var r=this._count;if(r>t){for(var e=r-t-1,i=this._source;!Z.call(i,e);){if(--e<0)return!1;
...
return u.push(c),r},r.rowSep=function(n){return u.push(u.length?n?f:c:s),r},r},n.round10=function(n,t){return t?(n=+n,isNaN(n)||"number"!=typeof t||t%1!==0?0/0:(n=Math.round($(n,t)),$(n,-t))):Math.round(n)
},n.mult10=function(n,t){return t?$(+n,t):n},n.delta=function(n,t){if(n===t)return 0;
var r=n-t;return 0>r?-r:r},ct=n.global,n});