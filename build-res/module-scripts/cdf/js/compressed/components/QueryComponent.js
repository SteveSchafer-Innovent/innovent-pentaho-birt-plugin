...
e.queryState=o,o.setAjaxOptions({async:!1}),r||(r=function(t){var r=void 0;"function"==typeof e.postFetch&&(r=e.postFetch(t)),void 0!=r&&(t=r),void 0!=e.resultvar&&e.dashboard.setParameter(e.resultvar,e.result),e.result=void 0!=t.resultset?t.resultset:t,"undefined"!=typeof t.resultset&&(e.metadata=t.metadata,e.queryInfo=t.queryInfo)
