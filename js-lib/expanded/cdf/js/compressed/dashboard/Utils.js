...
for(var n in r)if(r.hasOwnProperty(n)){var t=r[n];e[t[0]]=t[1]}return e}function o(r){var e=[];
...
for(var t in e){var a="function"==typeof e[t]?e[t]():e[t];"string"==typeof a&&(a=a.replace(/"/g,"'")),n+='"<input type="hidden" name="'+t+'" value="'+a+'"/>'
}n+="</form>",jQuery(n).appendTo("body").submit().remove()},u.clone=function(r){var e=r instanceof Array?[]:{};
