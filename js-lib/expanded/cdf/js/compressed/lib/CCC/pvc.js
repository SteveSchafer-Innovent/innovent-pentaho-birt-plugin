...
return a}t||e.fail.argumentRequired("specs");var d={};return e.each(t,function(e,t){var n=new X(t,a,i,e);
d[n.name]=n}),a.option=a,a.specified=s,a.defaultValue=c,a.isSpecified=r,a.isDefined=o,a.specify=l,a.defaults=u,a
}function s(e){return function(t){var i,n;for(i=0,L=e.length;L>i;i++)if(n=e[i],"string"==typeof n&&(n=this[n]),n.call(this,t)===!0)return!0
...
switch(i){case"linear":return new q.color.LinearScalesBuild(t).buildMap();case"discrete":return new q.color.DiscreteScalesBuild(t).buildMap();
case"normal":return new q.color.NormalScalesBuild(t).buildMap()}throw e.error.argumentInvalid("scaleType","Unexistent scale type '{0}'.",[i])
}function f(t){t||e.fail.argumentRequired("keyArgs");var i=t.type||e.fail.argumentRequired("keyArgs.type");
switch(i){case"linear":return new q.color.LinearScalesBuild(t).build();case"discrete":return new q.color.DiscreteScalesBuild(t).build();
case"normal":return new q.color.NormalScalesBuild(t).build()}throw e.error.argumentInvalid("scaleType","Unexistent scale type '{0}'.",[i])
}function v(e,i){if(this.event=t.event,this.pvMark=e,e){var n=this.sign=e.sign||null;
!i&&n&&(i=n.scene()),i?this.index=i.childIndex():(this.index=null,i=new q.visual.Scene(null,{panel:this.panel}))
}else this.sign=null,this.index=null,i=new q.visual.Scene(null,{panel:this.panel,source:this.chart.root.data});
this.scene=i}function p(){e.MetaType.apply(this,arguments),this._vars=e.create(this.baseType&&this.baseType._vars)
}function g(e){this._renderId!==e&&(this._renderId=e,this.renderState={})}function m(e){var t;
e&&(t=e.ownerScene)&&(e=t);var i=this._active;return i!==e?(i&&b.call(i,!1),this._active=i=e||null,i&&b.call(i,!0),!0):!1
}function b(e){this.isActive!==e&&(e?this.isActive=!0:delete this.isActive)}function x(e,t){return function(){var i=this.vars[e];
return void 0===i&&(i=this[t](),void 0===i&&(i=null),this.vars[e]=i),i}}function y(t){if(t.isRequired)throw e.error.operationInvalid("The required visual role '{0}' is unbound.",[t.name])
}function _(t,i){if(t!==i)throw e.error.operationInvalid("Invalid state.")}function S(e){return e.dataPartValue
}function w(e){return e.isDiscrete()?"discrete":e.lastDimensionValueType()===Date?"timeSeries":"numeric"
}function C(i){var n;if(i){var a;e.eachOwn(i,function(e,n){a=!0,i[n]=t.fillStyle(e)
}),a&&(n=i)}return n}function k(){var e,i=this.scaleType;if(i)if("discrete"===i)if(0===this.index)e=q.createColorScheme();
else{var n=this;e=function(){return n.chart._getRoleColorScale(n.role.grouping)}}else nt||(nt=["red","yellow","green"].map(t.color)),e=nt.slice();
else e=q.createColorScheme();return e}function P(t){if(!e.object.is(t)){var i=this.option("Position");
t=(new Q).setSize(t,{singleProp:q.BasePanel.orthogonalLength[i]})}return t}function M(e){var t=this.option("Position");
return q.parseAlign(t,e)}function D(e){return(new Q).setSize(e,{singleProp:"width"})
}function R(t){var i=I(t)||e.assert("There must exist an ancestor sign");return new q.visual.BasicSign(i.panel,t)
}function I(e){var t;do e=e.parent;while(!(!e||(t=e.sign)||e.proto&&(t=e.proto.sign)));
return t}function T(e,i,n,a,r,s,o,l){if(!e)return null;var u;null==a&&(a=1/0),null==o&&(o=1/0),null==n&&(n=0),null==s&&(s=0),n>a&&(a=n),s>o&&(o=s),null!=i?n>i?i=n:i>a&&(i=a):t.floatEqual(n,a)&&(i=n),null!=r?s>r?r=s:r>o&&(r=o):t.floatEqual(s,o)&&(r=s);
var c=null!=i,h=null!=r;if(c||h){if(c&&h)return t.floatZero(i)&&t.floatZero(r)?T(e,null,0,1/0,null,0,1/0,l):(l=i/(i+r),{mode:"abs",ratio:l,value:e*(i+r),band:i,space:r});
...
if(u=1/l-1,p){if(n=s/u,g&&n>=a)return T(e,i,n,a,r,s,o,l)}else if(v&&(s=u*n,m&&s>=o))return T(e,i,n,a,r,s,o,l);
g?o=u*a:m&&(a=o/u)}return{mode:"rel",ratio:l,min:e*(n+s),max:e*(a+o)}}function A(e){return q.parseDomainScope(e,this.orientation)
}function O(t){if(t){if(e.hasOwn(Z.namesSet,t)){var i=q.BasePanel["y"===this.orientation?"horizontalAlign":"verticalAlign2"];
return i[t]}e.debug>=2&&e.log(e.format("Invalid axis position value '{0}'.",[t]))
}return"x"===this.orientation?"bottom":"left"}function B(e){var t=this.option("Position");
return Q.toOrtho(e,t)}function V(e){var t=this.option("Position");return Q.to(e,{singleProp:q.BasePanel.orthogonalLength[t]})
}function z(){var e=["axis"],t=this.scaleType;return t&&("discrete"!==t&&e.push("continuousAxis"),e.push(t+"Axis")),this.v1SecondOrientedId&&e.push(this.v1SecondOrientedId+"Axis"),e.push(this.orientedId+"Axis"),e.push(this.id+"Axis"),e
}function N(e){if("trend"===this.name)return null;var t=this.option("TrendType");
if(!t&&e&&(t=e.type),!t||"none"===t)return null;e=e?Object.create(e):{};var i=q.trends.get(t);
e.info=i,e.type=t;var n=this.option("TrendLabel");return e.label=null!=n?String(n):i.dataPartAtom.f,e
}function E(e,t){return{resolveV1:function(i){return 0===this.globalIndex?(this._specifyChartOption(i,"show"+e)||i.defaultValue(t),!0):void 0
}}}function F(e){return{resolveV1:function(t){return this._specifyChartOption(t,"show"+e),!0
...
return!0});var W=1,q=e.globalSpace("pvc",{});q.data=i;var H=Array.prototype.slice;
q.invisibleFill="rgba(127,127,127,0.00001)",!function(){var i=function(e){t.Behavior.tipsy.setDebug(e)
...
},q.defaultCompatVersion=function(e){var t=q.BaseChart.prototype.defaults;return null!=e?t.compatVersion=e:t.compatVersion
},q.cloneMatrix=function(e){return e.map(function(e){return e.slice()})},q.normAngle=t.Shape.normalizeAngle,q.orientation={vertical:"vertical",horizontal:"horizontal"},q.removeTipsyLegends=function(){var e=t.Behavior.tipsy;
e&&e.removeAll&&e.removeAll()},q.createDateComparer=function(e,i){return i||(i=t.identity),function(t,n){return e.parse(i(t))-e.parse(i(n))
}},q.buildIndexedId=e.indexedId,q.makeEnumParser=function(t,i,n){if(e.array.is(i)){var a={};
...
}},q.unionExtents=function(e,t){if(e)t&&(t.min<e.min&&(e.min=t.min),t.max>e.max&&(e.max=t.max));
else{if(!t)return null;e={min:t.min,max:t.max}}return e},null==n.support.svg&&(n.support.svg=document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure","1.1")),q.extensionTag="extension",q.extendType=function(t,i,n){if(i){var a,r=t.meta&&t.meta._vars,s=function(t,i){void 0!==t&&(a||(a={}),r&&r[i]&&(i="_"+i+"EvalCore"),a[i]=e.fun.to(t))
};n?n.forEach(function(e){s(i[e],e)}):e.each(s),a&&t.add(a)}};var G=[null];q.makeExtensionAbsId=function(t,i){if(!t)return i;
var n=[];i=e.array.to(i)||G,t=e.array.to(t);for(var r=0,s=i.length;s>r;r++)for(var o=0,l=t.length;l>o;o++){var u=a(t[o],i[r]);
u&&n.push(u)}return n},q.uniqueExtensionAbsPrefix=function(){return"_"+((new Date).getTime()+Math.floor(1e5*Math.random()))
...
},q.toGrayScale=function(e,i,n,a){e=t.color(e);var r=.299*e.r+.587*e.g+.114*e.b;void 0===n?n=200:null==n&&(n=255),void 0===a?a=30:null==a&&(a=0);
var s=n-a;return r=0>=s?n:a+r/255*s,null==i?i=e.opacity:0>i&&(i=-i*e.opacity),r=Math.round(r),t.rgb(r,r,r,i)
},q.time={intervals:{y:31536e6,m:2592e6,d30:2592e6,w:6048e5,d7:6048e5,d:864e5,h:36e5,M:6e4,s:1e3,ms:1},withoutTime:function(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate())
...
if(n){var a=n>0?7-n:-n;e=new Date(e+a*q.time.intervals.d)}return e},closestOrSelf:function(e,t){var i=e.getDay(),n=i-t;
if(n){var a=q.time.intervals.d,r=n>0?1:-1;n=Math.abs(n),e=new Date(n>=4?e.getTime()+r*(7-n)*a:e.getTime()-r*n*a)
}return e}}};var U=t.Mark,j=U.prototype.zOrder;U.prototype.zOrder=function(e){var t=this.borderPanel;
return t&&t!==this?j.call(t,e):j.call(this,e)},U.prototype.wrapper=function(e){return this._wrapper=e,this
},U.prototype.wrap=function(t,i){return t&&e.fun.is(t)&&this._wrapper&&!t._cccWrapped&&(t=this._wrapper(t,i),t._cccWrapped=!0),t
},t.Mark.prototype.call=function(e){e.call(this,this)},U.prototype.lock=function(e,t){return void 0!==t&&this[e](t),(this._locked||(this._locked={}))[e]=!0,this
},U.prototype.isIntercepted=function(e){return this._intercepted&&this._intercepted[e]
},U.prototype.isLocked=function(e){return this._locked&&this._locked[e]},U.prototype.ensureEvents=function(e){var t=this.propertyValue("events",!0);
return t&&"none"!==t||this.events(e||"all"),this},U.prototype.addMargin=function(i,n){if(0!==n){var a=e.nullyTo(this.propertyValue(i),0),r=t.functor(a);
this[i](function(){return n+r.apply(this,H.call(arguments))})}return this},U.prototype.addMargins=function(t){var i=e.get(t,"all",0);
...
},U.prototype.eachInstanceWithData=function(e,t){this.eachInstance(function(i,n,a){i.mark.sign&&i[n].data&&e.call(t,i,n,a)
})},U.prototype.eachSceneWithDataOnRect=function(e,t,i,n){function a(n,a){if(n.intersectsRect(e)){var r=a.data;
...
n=(o?n.center():n).apply(i),a(n,e[t])})}},U.prototype.eachDatumOnRect=function(e,t,i,n){function a(n,a){if(n.intersectsRect(e)){var r=a.data;
...
})}},U.prototype.getOwnerInstance=function(e,t){var i=e[t].data;return i instanceof q.visual.Scene&&(i=i.ownerScene)?i.childIndex():t
...
},U.prototype.hasDelegateValue=function(e,t){var i=this.$propertiesMap[e];return i?!t||i.tag===t:!!this.proto&&this.proto.hasDelegateValue(e,t)
},q.parseValuesOverflow=q.makeEnumParser("valuesOverflow",["show","trim","hide"],"hide"),q.parseMultiChartOverflow=q.makeEnumParser("multiChartOverflow",["grow","fit","clip"],"grow"),q.parseLegendClickMode=q.makeEnumParser("legendClickMode",["toggleSelected","toggleVisible","none"],"toggleVisible"),q.parseTooltipAutoContent=q.makeEnumParser("tooltipAutoContent",["summary","value"],"value"),q.parseSelectionMode=q.makeEnumParser("selectionMode",["rubberBand","focusWindow"],"rubberBand"),q.parseClearSelectionMode=q.makeEnumParser("clearSelectionMode",["emptySpaceClick","manual"],"emptySpaceClick"),q.parsePointingMode=q.makeEnumParser("pointingMode",["over","near"],"near"),q.parsePointingCollapse=q.makeEnumParser("pointingCollapse",["none","x","y"],"none"),q.parseShape=q.makeEnumParser("shape",t.Scene.hasSymbol,null),q.parseDataTypeCheckingMode=q.makeEnumParser("typeCheckingMode",["none","minimum","extended"],"minimum"),q.parseContinuousColorScaleType=function(t){if(t)switch(t=(""+t).toLowerCase()){case"linear":case"normal":case"discrete":break;
default:e.debug>=2&&e.log("[Warning] Invalid 'ScaleType' option value: '"+t+"'."),t=null
}return t},q.parseDomainScope=function(t,i){if(t)switch(t=(""+t).toLowerCase()){case"cell":case"global":break;
...
}return t},q.parseDomainRoundingMode=function(t){if(t)switch(t=(""+t).toLowerCase()){case"none":case"nice":case"tick":break;
default:e.debug>=2&&e.log("[Warning] Invalid 'DomainRoundMode' value: '"+t+"'."),t=null
}return t},q.parseOverlappedLabelsMode=function(t){if(t)switch(t=(""+t).toLowerCase()){case"leave":case"hide":case"rotatethenhide":break;
default:e.debug>=2&&e.log("[Warning] Invalid 'OverlappedLabelsMode' option value: '"+t+"'."),t=null
}return t},q.parseTrendType=function(t){if(t){if(t=(""+t).toLowerCase(),"none"===t)return t;
if(q.trends.has(t))return t;e.debug>=2&&e.log("[Warning] Invalid 'TrendType' value: '"+t+"'.")
}},q.parseNullInterpolationMode=function(t){if(t){switch(t=(""+t).toLowerCase()){case"none":case"linear":case"zero":return t
}e.debug>=2&&e.log("[Warning] Invalid 'NullInterpolationMode' value: '"+t+"'.")}},q.parseAlign=function(t,i){i&&(i=(""+i).toLowerCase());
var n,a;return"left"===t||"right"===t?(n=i&&q.BasePanel.verticalAlign[i],n||(n="middle",a=!!i)):(n=i&&q.BasePanel.horizontalAlign[i],n||(n="center",a=!!i)),a&&e.debug>=2&&e.log(e.format("Invalid alignment value '{0}'. Assuming '{1}'.",[i,n])),n
},q.parseAnchor=function(t){if(t){switch(t=(""+t).toLowerCase()){case"top":case"left":case"center":case"bottom":case"right":return t
}e.debug>=2&&e.log(e.format("Invalid anchor value '{0}'.",[t]))}},q.parseAnchorWedge=function(t){if(t){switch(t=(""+t).toLowerCase()){case"outer":case"inner":case"center":case"start":case"end":return t
}e.debug>=2&&e.log(e.format("Invalid wedge anchor value '{0}'.",[t]))}},q.parsePosition=function(t,i){if(t&&(t=(""+t).toLowerCase(),!e.hasOwn(Z.namesSet,t))){var n=i||"left";
e.debug>=2&&e.log(e.format("Invalid position value '{0}. Assuming '{1}'.",[t,n])),t=n
}return t||i||"left"};var K=e.type("pvc.Offset").init(function(e,t){1===arguments.length?null!=e&&this.setOffset(e):(null!=e&&(this.x=e),null!=t&&(this.y=t))
}).add({describe:function(t,i,n){return e.describeRecursive(t,e.copyOwn(this),i,n)
},setOffset:function(t,i){if("string"==typeof t){var n=t.split(/\s+/).map(function(e){return Y.parse(e)
...
},set:function(t,i){null!=i&&e.hasOwn(K.namesSet,t)&&(i=Y.parse(i),null!=i&&("all"===t?K.names.forEach(function(e){this[e]=i
},this):this[t]=i))},resolve:function(e){var t={};return Q.names.forEach(function(i){var n=K.namesSizeToOffset[i],a=this[n];
if(null!=a)if("number"==typeof a)t[n]=a;else if(e){var r=e[i];null!=r&&(t[n]=a.resolve(r))
}},this),t}});K.type().add({names:["x","y"],namesSizeToOffset:{width:"x",height:"y"},namesSidesToOffset:{left:"x",right:"x",top:"y",bottom:"y"},as:function(e){return null==e||e instanceof K||(e=(new K).setOffset(e)),e
}}).add({namesSet:t.dict(K.names,e.retTrue)});var Y=q.PercentValue=function(e){this.percent=e
};Y.prototype.resolve=function(e){return this.percent*e},Y.prototype.divide=function(e){return new Y(this.percent/e)
},Y.divide=function(e,t){return e instanceof Y?e.divide(t):e/t},Y.parse=function(t){if(null!=t&&""!==t){switch(typeof t){case"number":return t;
case"string":var i=t.match(/^(.+?)\s*(%)?$/);if(i){var n=+i[1];if(!isNaN(n)){if(!i[2])return n;
if(n>=0)return new Y(n/100)}}break;case"object":if(t instanceof Y)return t}e.debug&&e.log(e.format("Invalid margins component '{0}'",[""+t]))
}},Y.resolve=function(e,t){return e instanceof Y?e.resolve(t):e};var Z=q.Sides=function(e){null!=e&&this.setSides(e)
};Z.hnames="left right".split(" "),Z.vnames="top bottom".split(" "),Z.names="left right top bottom".split(" "),Z.namesSet=t.dict(Z.names,e.retTrue),Z.as=function(e){return null==e||e instanceof Z||(e=(new Z).setSides(e)),e
},Z.to=function(e){return null!=e&&e instanceof Z||(e=(new Z).setSides(e)),e},Z.prototype.describe=function(t,i,n){return e.describeRecursive(t,e.copyOwn(this),i,n)
},Z.prototype.setSides=function(t){if("string"==typeof t){var i=t.split(/\s+/).map(function(e){return Y.parse(e)
...
case 0:return this}}else{if("number"==typeof t)return this.set("all",t),this;if("object"==typeof t){if(t instanceof Y)this.set("all",t);
else{this.set("all",t.all),this.set("width",t.width),this.set("height",t.height);
for(var n in t)Z.namesSet.hasOwnProperty(n)&&this.set(n,t[n])}return this}}return e.debug&&e.log("Invalid 'sides' value: "+e.describe(t)),this
},Z.prototype.set=function(t,i){if(i=Y.parse(i),null!=i)switch(t){case"all":Z.names.forEach(function(e){this[e]=i
},this);break;case"width":this.left=this.right=Y.divide(i,2);break;case"height":this.top=this.bottom=Y.divide(i,2);
break;default:e.hasOwn(Z.namesSet,t)&&(this[t]=i)}},Z.prototype.resolve=function(e,t){"object"==typeof e&&(t=e.height,e=e.width);
var i={};return Z.names.forEach(function(n){var a=0,r=this[n];null!=r&&(a="number"==typeof r?r:r.resolve("left"===n||"right"===n?e:t)),i[n]=a
},this),Z.updateSize(i)},Z.updateSize=function(e){return e.width=(e.left||0)+(e.right||0),e.height=(e.bottom||0)+(e.top||0),e
},Z.resolvedMax=function(e,t){var i={};return Z.names.forEach(function(n){i[n]=Math.max(e[n]||0,t[n]||0)
}),i},Z.inflate=function(e,t){var i={};return Z.names.forEach(function(n){i[n]=(e[n]||0)+t
}),Z.updateSize(i)};var Q=e.type("pvc.Size").init(function(e,t){1===arguments.length?null!=e&&this.setSize(e):(null!=e&&(this.width=e),null!=t&&(this.height=t))
}).add({describe:function(t,i,n){return e.describeRecursive(t,e.copyOwn(this),i,n)
},setSize:function(t,i){if("string"==typeof t){var n=t.split(/\s+/).map(function(e){return Y.parse(e)
});switch(n.length){case 1:return this.set(e.get(i,"singleProp","all"),n[0]),this;
...
if("object"==typeof t){if(t instanceof Y)this.set(e.get(i,"singleProp","all"),t);
else{this.set("all",t.all);for(var a in t)"all"!==a&&this.set(a,t[a])}return this
}}return e.debug&&e.log("Invalid 'size' value: "+e.describe(t)),this},set:function(t,i){return null==i||"all"!==t&&!e.hasOwn(Q.namesSet,t)||(i=Y.parse(i),null!=i&&("all"===t?Q.names.forEach(function(e){this[e]=i
},this):this[t]=i)),this},clone:function(){return new Q(this.width,this.height)},intersect:function(e){return new Q(Math.min(this.width,e.width),Math.min(this.height,e.height))
},resolve:function(e){var t={};return Q.names.forEach(function(i){var n=this[i];if(null!=n)if("number"==typeof n)t[i]=n;
else if(e){var a=e[i];null!=a&&(t[i]=n.resolve(a))}},this),t}});Q.names=["width","height"],Q.namesSet=t.dict(Q.names,e.retTrue),Q.toOrtho=function(e,t){if(null!=e){var i;
t&&(i=q.BasePanel.orthogonalLength[t]),e=Q.to(e,{singleProp:i}),t&&delete e[q.BasePanel.oppositeLength[i]]
}return e},Q.to=function(e,t){return null==e||e instanceof Q||(e=(new Q).setSize(e,t)),e
...
return n.length<i&&(n+=e.array.create(i-n.length," ").join("")),"["+n+"]"}}),r.resolvers=s,r.constant=o,r.specify=l,r.defaultValue=u,q.options=r;
var X=e.type().init(function(t,i,n,a){this.name=t,this.option=i,this._dv=this.value=e.get(a,"value"),this._resolve=e.get(a,"resolve");
...
},_addInitSteps:function(e){function t(){this.option=q.options(i.optionsDef,this)
}this.base(e);var i=this;e.push(t)}}});var $=c.Ctor;if(e("pvc.visual.OptionsBase",$.configure({init:function(t,i,n,a){this.type=i,this.chart=t,this.index=null==n?0:n,this.name=e.get(a,"name"),this.id=e.indexedId(this.type,this.index),this.optionId=this._buildOptionId(a);
...
n&&(this._fixed=n,t.push(q.options.specify(function(e){return n[e.name]}))),this._registerResolversNormal(t,i);
...
return!1},_resolveFixed:q.options.specify(function(e){return this._fixed?this._fixed[e.name]:void 0
...
}}})),e.scope(function(){var t=e.makeEnum(["Interactive","ShowsActivity","ShowsSelection","ShowsTooltip","Selectable","Unselectable","Hoverable","Clickable","DoubleClickable","SelectableByClick","SelectableByRubberband","SelectableByFocusWindow","Animatable"]);
t.ShowsInteraction=t.ShowsActivity|t.ShowsSelection,t.Actionable=t.Hoverable|t.Clickable|t.DoubleClickable|t.SelectableByClick,t.HandlesEvents=t.Actionable|t.ShowsTooltip,t.HandlesClickEvent=t.Clickable|t.SelectableByClick,e("pvc.visual.Interactive",e.Object.extend({"type.methods":[t,{ShowsAny:t.ShowsInteraction|t.ShowsTooltip,SelectableAny:t.Selectable|t.SelectableByClick|t.SelectableByRubberband|t.SelectableByFocusWindow}],methods:[{_ibits:-1,ibits:function(){return this._ibits
}},e.query(e.ownKeys(t)).object({name:e.firstLowerCase,value:function(e){var i=t[e];
return function(){return!!(this.ibits()&i)}}})]}))}),q.color={scale:f,scales:d,toGray:q.toGrayScale,isGray:h},e.type("pvc.color.ScalesBuild").init(function(i){this.keyArgs=i,this.data=i.data||e.fail.argumentRequired("keyArgs.data"),this.domainDimName=i.colorDimension||e.fail.argumentRequired("keyArgs.colorDimension"),this.domainDim=this.data.dimensions(this.domainDimName);
...
i=t.range(o,l+u,u)}return i}}),e.type("pvc.color.LinearScalesBuild",q.color.ScalesBuild).add({_createScale:function(e){var i=t.Scale.linear();
return e&&i.domain.apply(i,e),i.range.apply(i,this.range),i}}),e.type("pvc.color.DiscreteScalesBuild",q.color.ScalesBuild).init(function(e){this.base(e),this.domainRangeCountDif=1
...
}}),Object.defineProperty)try{Object.defineProperty(q.visual.Context.prototype,"parent",{get:function(){throw e.error.operationInvalid("The 'this.parent.index' idiom has no equivalent in this version. Please try 'this.pvMark.parent.index'.")
}})}catch(J){}q.text={getFitInfo:function(e,i,n,a,r){if(""===n)return{h:!0,v:!0,d:!0};
...
return q.text.trimToWidth(e,i,n,a,r,o)},trimToWidth:function(e,i,n,a,r,s){if(""===i)return i;
var o=t.Text.measureWidth(i,n);if(e>=o)return i;if(o>1.5*e)return q.text.trimToWidthBin(e,i,n,a,r,s);
...
else{a+=s*t-n,n+=t-r[0];for(var l=1;i>l;l++)r[l-1]=r[l];r[i-1]=t}return a/o}}}})}),e.MetaType.subType(p,{methods:{variable:function(t,i){var n;
if(this._vars[t])void 0!==i&&(n=e.set({},"_"+t+"EvalCore",e.fun.to(i)));else{this._vars[t]=!0;
var a=this.Ctor.prototype;n={};var r="_"+t+"Eval";n[t]=x(t,r);var s=r+"Core";e.hasOwn(a,r)||(n[r]=e.methodCaller(s)),e.hasOwn(a,s)||(n[s]=e.fun.to(void 0===i?null:i))
}return n&&this.methods(n),this}}});var et=p.Ctor;e("pvc.visual.Scene",et.configure({init:function(n,a){if(e.debug>=4&&(this.id=e.nextId("scene")),this._renderId=0,this.renderState={},t.Dom.Node.call(this,null),this.parent=n||null,n){this.root=n.root;
...
},methods:[t.Dom.Node,q.visual.Interactive,{source:null,groups:null,group:null,_datums:null,datum:null,isNull:!1,get:function(e,t){var i=this.vars[e];
...
},isActive:!1,setActive:function(e){e=!!e,this.isActive!==e&&m.call(this.root,this.isActive?null:this)
},clearActive:function(){return m.call(this.root,null)},anyActive:function(){return!!this.root._active
...
}}]}));var tt=q.visual.ValueLabelVar=function(e,t,i,n){this.value=e,this.label=t,void 0!==i&&(this.rawValue=i),void 0!==n&&(this.absLabel=n)
};e.set(tt.prototype,"rawValue",void 0,"absLabel",void 0,"setValue",function(e){return this.value=e,this
},"setLabel",function(e){return this.label=e,this},"clone",function(){return new tt(this.value,this.label,this.rawValue)
},"toString",function(){var e=this.label||this.value;return null==e?"":"string"!=typeof e?""+e:e
}),tt.fromComplex=function(e){return e?new tt(e.value,e.label,e.rawValue,e.absLabel):new tt(null,"",null)
},tt.fromAtom=tt.fromComplex,e.space("pvc.visual").TraversalMode=e.makeEnum(["Tree","FlattenLeafs","FlattenDfsPre","FlattenDfsPost"],{all:"AllMask"}),e.type("pvc.visual.Role").init(function(t,i){this.name=t,this.label=e.get(i,"label")||e.titleFromName(t),this.index=e.get(i,"index")||0,this.plot=e.get(i,"plot"),this._legend={visible:!0},this.dimensionDefaults=e.get(i,"dimensionDefaults")||{},e.get(i,"isRequired",!1)&&(this.isRequired=!0),e.get(i,"autoCreateDimension",!1)&&(this.autoCreateDimension=!0);
...
},setSourceRole:function(e){this.sourceRole=e},setIsReversed:function(e){e?this.isReversed=!0:delete this.isReversed
},setTraversalMode:function(t){var i=q.visual.TraversalMode;if(t=e.nullyTo(t,i.FlattenLeafs),t!==this.traversalMode){if(!(t&this.traversalModes))throw e.error.argumentInvalid("traversalMode","Value is not currently valid.");
...
}},_flatteningMode:function(){var e=q.visual.TraversalMode,t=i.FlatteningMode;switch(this.traversalMode){case e.FlattenDfsPre:return t.DfsPre;
...
}}),q.visual.rolesBinder=function(){function t(){if(_(w,0),!g)throw e.error.argumentRequired("context");
if(!m)throw e.error.argumentRequired("complexTypeProject");return w=1,S=!!x&&x.level()>=3,g.query().each(function(e){var t=g.getOptions(e);
void 0!==t&&n(e,t)||l(e)}),C.forEach(function(e){u(e)},this),C=[],c(),w=2,this}function n(e,t){var i,n=q.visual.Role.parse(g,e.name,t);
...
}function a(e){C.push(e)}function r(e,t){e.preBind(t),t.isNull()?y(e):s(e,t.dimensionNames())
...
}function h(){_(w,2),w=3,g.query().each(function(e){e.isPreBound()||d(e)}),C.forEach(function(e){u(e)||v(e)
}),c();var e=new i.ComplexType;return m.configureComplexType(e,b),S&&x(e.describe()),g.query().each(function(t){t.isPreBound()&&t.postBind(e)
}),S&&p(),w=4,e}function d(e){if(e.sourceRole)return a(e);var t=e.defaultDimensionGroup;
...
}v(e)}function f(e,t){var n=i.GroupingSpec.parse(t);r(e,n)}function v(e){y(e),e.bind(null),e.setSourceRole(null)
...
}),t.rowSep(!0),x("VISUAL ROLES MAP SUMMARY\n"+t()+"\n")}var g,m,b,x,S,w=0,C=[],k={},P={};
return{logger:function(e){return arguments.length?(_(w,0),x=e,this):x},dimensionsOptions:function(e){return arguments.length?(_(w,0),b=e,this):b
},context:function(e){return arguments.length?(_(w,0),g=e,this):g},complexTypeProject:function(e){return arguments.length?(_(w,0),m=e,this):m
...
if(o&&(this.role=n,this.sourceRoleName=n.sourceRole&&n.sourceRole.name,r=t.panel(),this.panel=r,o.isDiscrete()||(this.rootContDim=r.data.owner.dimensions(o.lastDimensionName()),s&&(this.percentFormatter=r.chart.options.percentValueFormat))),!i){if(!n)throw e.error.operationInvalid("Role is not defined, so the roleName argument is required.");
i=n.name}if(!o){var l=t.vars[i]=new tt(null,"");s&&(l.percent=new tt(null,""))}this.roleName=i,t["is"+e.firstUpperCase(i)+"Bound"]=!!o,e.get(a,"allowNestedVars")&&(this.allowNestedVars=!0)
...
if(o){var l,u,c=t.group,h=c?c.singleDatum():t.datum;if(h)h.isNull||(s=tt.fromAtom(h.atoms[o.name]),null!=s.value&&this.percentFormatter&&(c?(u=c.dimensions(o.name),l=u.valuePercent({visible:!0})):l=t.data().dimensions(o.name).percent(s.value)));
else if(c){u=c.dimensions(o.name);var d=u.value({visible:!0,zeroIfNone:!1});if(null!=d){var f=o.format(d);
s=new tt(d,f,d),this.percentFormatter&&(l=u.valuePercent({visible:!0}))}}s&&this.percentFormatter&&(s.percent=null==s.value?new tt(null,""):new tt(l,this.percentFormatter.call(null,l)))
}else{var v=t.datum;if(v&&!v.isNull){var p=this.grouping.view(v);s=tt.fromComplex(p)
}}s||(s=new tt(null,""),this.percentFormatter&&(s.percent=new tt(null,""))),t.vars[n]=s
...
}).add({legendVisible:function(){return this.role.legend().visible}}),e.type("pvc.visual.ColorDataCell",q.visual.DataCell).init(function(e,t,i,n,a){this.base(e,t,i,n,a),this._legendGroupScene=null,this._legendSymbolRenderer=null
}).add({legendSymbolRenderer:function(e){return arguments.length?(e&&"object"==typeof e&&(e=q.visual.legend.symbolRenderer(e)),this._legendSymbolRenderer=e,this):this._legendSymbolRenderer
}});var it=e("pvc.visual.Axis",q.visual.OptionsBase.extend({init:function(e,t,i,n){this.base(e,t,i,n),e._addAxis(this)
...
}),i.dataCell=i.dataCells[0],i.role=i.dataCell&&i.dataCell.role,i.scaleType=w(i.role.grouping),i._domainData=null,i._domainValues=null,i._domainItems=null,i._conciliateVisualRoles(),this
...
var t=this._domainData;if(!t){var i=this.dataCells.map(S),n=this.chart.partData(i);
...
for(u=1;t>u;u++){if(i=this.dataCells[u].role,n=this._getBoundRoleGrouping(i),this.scaleType!==w(n))throw h("The visual roles on axis '{0}', assumed continuous, should have scales of the same type.",[this.id]);
...
},this),this._domainItems=a,this._domainValues=n}}}));e("pvc.visual.ColorAxis",it.extend({methods:{scaleNullRangeValue:function(){return this.option("Missing")||null
...
}}}));var nt,at={resolveDefault:function(t){return!this.index&&this._specifyChartOption(t,e.firstLowerCase(t.name))?!0:void 0
}};q.visual.ColorAxis.options({Colors:{resolve:"_resolveFull",getDefault:k,data:{resolveV1:function(e){return"discrete"===this.scaleType?0===this.index?this._specifyChartOption(e,"colors"):1===this.index&&this.chart._allowV1SecondAxis&&this._specifyChartOption(e,"secondAxisColor"):this._specifyChartOption(e,"colorRange"),!0
},resolveDefault:function(e){0===this.index&&this._specifyChartOption(e,"colors")
}},cast:q.colorScheme},Map:{resolve:"_resolveFull",cast:C},Transform:{resolve:"_resolveFull",data:{resolveDefault:function(t){var i=this._plotList;
if(i.length){var n=!1;if(e.query(i).each(function(e){if(e.isMain)return n=!1;var t=e.name;
("plot2"===t||"trend"===t)&&(n=!0)}),n)return t.defaultValue(q.brighterColorTransform),!0
...
}},cast:q.parseContinuousColorScaleType,value:"linear"},UseAbs:{resolve:"_resolveFull",cast:Boolean,value:!1},Domain:{resolve:"_resolveFull",data:{resolveV1:function(e){return this._specifyV1ChartOption(e,"colorRangeInterval"),!0
...
return e().range()[0]||q.defaultColor},cast:t.color},LegendVisible:{resolve:"_resolveFull",data:at,cast:Boolean,value:!0},LegendClickMode:{resolve:"_resolveFull",data:at,cast:q.parseLegendClickMode,value:"togglevisible"},LegendDrawLine:{resolve:"_resolveFull",data:at,cast:Boolean,value:!1},LegendDrawMarker:{resolve:"_resolveFull",data:at,cast:Boolean,value:!0},LegendShape:{resolve:"_resolveFull",data:at,cast:q.parseShape}}),e("pvc.visual.SizeAxis",it.extend({init:function(t,i,n,a){a=e.set(a,"byNaked",!1),this.base(t,i,n,a)
...
}},options:{OriginIsZero:{resolve:"_resolveFull",cast:Boolean,value:!1},FixedMin:{resolve:"_resolveFull",cast:e.number.to},FixedMax:{resolve:"_resolveFull",cast:e.number.to},UseAbs:{resolve:"_resolveFull",cast:Boolean,value:!1}}})),e("pvc.visual.NormalizedAxis",it.extend({init:function(t,i,n,a){a=e.set(a,"byNaked",!1),this.base(t,i,n,a)
...
}},options:{OriginIsZero:{value:!0}}})),e.type("pvc.BasePanel",q.Abstract).add(q.visual.Interactive).init(function(t,i,a){if(this.chart=t,this.base(),this.axes=Object.create(t.axes),a){a.scenes&&(this._sceneTypeExtensions=a.scenes,delete a.scenes);
...
var s=a&&a.margins;i||void 0!==s||(s=3),this.margins=new Z(s),this.paddings=new Z(a&&a.paddings),this.size=new Q(a&&a.size),this.sizeMax=new Q(a&&a.sizeMax),this.parent=i||null,i?(this.isTopRoot=!1,this.isRoot=i.chart!==t,this.root=this.isRoot?this:i.root,this.topRoot=i.topRoot,this.isRoot&&(this.position.left=t.left,this.position.top=t.top),i._addChild(this)):(this.root=this,this.topRoot=this,this.isRoot=!0,this.isTopRoot=!0);
var o=i||t;if(this.data=o.data,this.isRoot)this.anchor=null,this.align=null,this.alignTo=null,this.offset=null;
else{this.align=q.parseAlign(this.anchor,this.align);var l=this.alignTo,u=this.anchor;
null==l||""===l||"left"!==u&&"right"!==u?l=this.align:"page-middle"!==l&&(l=isNaN(+l.charAt(0))?q.parseAlign(u,l):Y.parse(l)),this.alignTo=l,this.offset=new K(this.offset)
...
}this.borderWidth=null==c?0:1.5}var f=o.ibits(),v=q.visual.Interactive,p=t.ibits();
...
var s=this.borderWidth/2,o=(e.get(i,"margins")||this.margins).resolve(n),l=(e.get(i,"paddings")||this.paddings).resolve(n),u=Z.inflate(o,s),c=Z.inflate(l,s),h=u.width+c.width,d=u.height+c.height,f=new Q(Math.max(t.width-h,0),Math.max(t.height-d,0)),v=e.copyOwn(a);
...
try{c=new Z(0),h=e.copyOwn(u);for(var n,r=t>0,s=0,o=x.length;o>s;){n=x[s],d&&f.log.group("SIDE Child #"+(s+1)+" at "+n.anchor);
...
try{if(y.paddings=a,y.canChange=i>0,t.layout(new Q(h),y),t.isVisible){if(u=s.call(this,t,n))return!1;
var v=t._layoutInfo.requestPaddings;if(r(a,v)){if(a=v,i>0)return a=new Z(a),d&&this.log("Child requested paddings change: "+e.describe(a)),!0;
...
}},this),u}function r(t,i){return i?e.query(Z.names).each(function(e){var n=t&&t[e]||0,a=i&&i[e]||0;
...
}function l(e){var t=e.anchor,i=v[t],n=e[i];c[t]+=n,h[i]-=n}var u,c,h,d,f=this;if(f._children){var v=q.BasePanel.orthogonalLength,p=q.BasePanel.relativeAnchor,g=q.BasePanel.leftTopAnchor,m=K.namesSidesToOffset,b=[],x=[];
...
var o=new q.visual.Scene(null,{panel:this});this.pvRootPanel.lock("data",[o]),(r.width>0||r.height>0)&&(this.pvPanel.width(this.width).height(this.height),this.pvPanel=this.pvPanel.add(t.Panel))
...
var d=this._getExtensionId();if(new q.visual.Panel(this,null,{panel:l,extensionId:d}),!n)try{this._createCore(this._layoutInfo)
...
},animating:function(){return this.topRoot._animating>0},setPosition:function(t){for(var i in t)if(e.hasOwn(Z.namesSet,i)){var n=t[i];
null===n?delete this.position[i]:(n=+n,!isNaN(n)&&isFinite(n)&&(this.position[i]=n))
}},createAnchoredSize:function(e,t){return this.isAnchorTopOrBottom()?new Q(t.width,Math.min(t.height,e)):new Q(Math.min(t.width,e),t.height)
...
},_extendSceneType:function(t,i,n){var a=e.get(this._sceneTypeExtensions,t);a&&q.extendType(i,a,n)
...
},_getExtensionPrefix:function(){return this._extensionPrefix},_makeExtensionAbsId:function(e){return q.makeExtensionAbsId(e,this._getExtensionPrefix())
...
return!e||e.isPinned?e=this._context=new q.visual.Context(this):v.call(e),e},visualRolesOf:function(e,t){return t?this.chart.visualRolesOf(e):null
...
return h.isTrend&&e.push(S("tr",{"class":w("trendLabel","trend-"+x(h.trend.type))},S("td",{colspan:3},S("span",null,y(h.trend.label))))),I&&(e.push.apply(e,n()),p&&A&&e.push(S("tr",{"class":w("dimSep")},'<td colspan="3"><hr/></td>'))),e.push.apply(e,a()),A&&e.push(S("tr",{"class":w("datumCount")},'<td colspan="3"><span>'+D.length+"</span></td>")),e
...
var n,a,r,g,m,x,y;return T?(x=h.atoms[i],a=x.value,r=x.label,t.valueType===Number&&null!=a&&(m=l.bind(null,x)),y=h.isInterpolated&&h.interpDimName===i?h.interpolation:null):(v||(v=c.allGroup()),n=v.dimensions(i),t.valueType===Number?(A&&(g="sum"),a=n.value(b),r=n.format(a),m=null!=a?o.bind(null,n):null,null==f&&(f=C.interpolatable()),f&&(y=d(u).where(function(e){return e.isInterpolated&&e.interpDimName===i
}).select(function(e){return e.interpolation}).first())):(A&&(g="list"),a=r=n.atoms(b).filter(function(e){return null!=e.value
...
}).array(),R=t.sign.defaultColor(c),I=!!k&&1===c.groups.length,T=1===u.length,A=D.length>1;
...
if(null==t){var i=e.shapeSize();null!=i&&(t=Math.sqrt(i))}return t||n}var i=10,n=5,a=new q.visual.Dot(this,this.pvPanel,{noSelect:!0,noHover:!0,noClick:!0,noDoubleClick:!0,noTooltip:!1,freePosition:!0,extensionId:"multiChartOverflowMarker"}).lock("data").pvMark.shape("triangle").shapeRadius(n).top(null).left(null).bottom(function(){return t(this)+i
...
if(r||a){var s=i.data,o=i.pvRootPanel||i.pvPanel.paddingPanel;if(i._getExtensionAbs("base","fillStyle")||o.fillStyle(q.invisibleFill),o.lock("events","all"),r){var l=4;
i._selectingByRubberband=!1;var u,c,h,d=this.selectBar=new q.visual.Bar(i,o,{extensionId:"rubberBand",normalStroke:!0,noHover:!0,noSelect:!0,noClick:!0,noDoubleClick:!0,noTooltip:!0}).override("defaultStrokeWidth",e.fun.constant(1.5)).override("defaultColor",function(e,t){return"stroke"===t?"#86fe00":"rgba(203, 239, 163, 0.6)"
...
i=e.set(i,"index",n.length,"plot",this);var a=new q.visual.Role(t,i);return this.visualRoles[t]=a,n.push(a),a
...
}}},_getColorDataCell:function(){var e=this.visualRoles.color;return e?new q.visual.ColorDataCell(this,"color",this.option("ColorAxis")-1,e,this.option("DataPart")):void 0
...
return void 0!==t?e.specify(t):(t="point"!==this.type,e.defaultValue(t)),!0}}},cast:Boolean,value:!1},ValuesAnchor:{resolve:"_resolveFull",cast:q.parseAnchor},ValuesFont:{resolve:"_resolveFull",cast:String,value:"10px sans-serif"},ValuesMask:{resolve:"_resolveFull",cast:String,value:"{value}"},ValuesOptimizeLegibility:{resolve:"_resolveFull",cast:Boolean,value:!1},ValuesOverflow:{resolve:"_resolveFull",cast:q.parseValuesOverflow,value:"hide"},DataPart:{resolve:"_resolveFull",cast:String,value:"0"},ColorAxis:{resolve:q.options.resolvers([function(e){return 0===this.globalIndex?(e.specify(1),!0):void 0
},"_resolveFull"]),cast:function(t){return t=e.number.to(t),null!=t?e.between(t,1,10):1
},value:1}},"type.methods":{registerClass:function(e){rt[e.prototype.type]=e},getClass:function(t){return e.getOwn(rt,t)
}}}));var st={};e.type("pvc.PlotPanel",q.BasePanel).init(function(e,t,i,n){this.base(e,t,n),this.plot=i,this._extensionPrefix=i.extensionPrefixes,this.dataPartValue=i.option("DataPart"),this.axes.color=e._getAxis("color",(i.option("ColorAxis")||0)-1),this.orientation=i.option("Orientation"),this.valuesVisible=i.option("ValuesVisible"),this.valuesAnchor=i.option("ValuesAnchor"),this.valuesMask=i.option("ValuesMask"),this.valuesFont=i.option("ValuesFont"),this.valuesOverflow=i.option("ValuesOverflow"),this.valuesOptimizeLegibility=i.option("ValuesOptimizeLegibility"),this.visualRoles=i.visualRoles,this.visualRoleList=i.visualRoleList
...
}}).type().add({registerClass:function(e,t){st[t||e.prototype.plotType]=e},getClass:function(t){return e.getOwn(st,t)
}}),e.type("pvc.PlotBgPanel",q.BasePanel).init(function(e,t,i){this.base(e,t,i)}).add({anchor:"fill",_getExtensionId:function(){return"plotBg"
},_createCore:function(e){this.pvPanel.borderPanel.lock("zOrder",-13).antialias(!1),this.base(e)
}}),e("pvc.visual.Legend",q.visual.OptionsBase.extend({init:function(t,i,n,a){a=e.set(a,"byNaked",!1),this.base(t,i,n,a)
},options:{Position:{resolve:"_resolveFull",cast:q.parsePosition,value:"bottom"},Size:{resolve:"_resolveFull",cast:P},SizeMax:{resolve:"_resolveFull",cast:P},Align:{resolve:"_resolveFull",data:{resolveDefault:function(e){var t,i=this.option("Position");
return"top"!==i&&"bottom"!==i?t="top":this.chart.compatVersion()<=1&&(t="left"),e.defaultValue(t),!0
}},cast:M},Margins:{resolve:"_resolveFull",data:{resolveDefault:function(t){if(this.chart.compatVersion()>1){var i=this.option("Position"),n=e.set({},q.BasePanel.oppositeAnchor[i],5);
t.defaultValue(n)}return!0}},cast:Z.as},Paddings:{resolve:"_resolveFull",cast:Z.as,value:5},Font:{resolve:"_resolveFull",cast:String},ItemSize:{resolve:"_resolveFull",cast:D}}})),e.type("pvc.LegendPanel",q.BasePanel).init(function(e,t,i){if(this.base(e,t,i),void 0===i.font){var n=this._getConstantExtension("label","font");
...
}});var b=this.pvLegendPanel=new q.visual.Panel(this,m,{extensionId:"panel",wrapper:g,noSelect:!1,noHover:!0,noClick:!1,noClickSelect:!0}).pvMark.lock("data",function(e){return e.items
...
}:function(){return this.parent.width()}),x=new q.visual.Panel(this,b,{extensionId:"markerPanel"}).pvMark.left(0).top(0).right(null).bottom(null).width(function(e){return e.vars.markerSize
}).height(function(e){return e.vars.itemClientSize.height});e.debug>=20&&(m.strokeStyle("red").lineWidth(.5).strokeDasharray("."),b.strokeStyle("green").lineWidth(.5).strokeDasharray("."),x.strokeStyle("blue").lineWidth(.5).strokeDasharray(".")),a.childNodes.forEach(function(e){var t=new q.visual.Panel(this,x).pvMark.visible(function(t){return t.parent===e
});e.renderer()(this,t,g)},this),this.pvLabel=new q.visual.Label(this,x.anchor("right"),{extensionId:"label",noTooltip:!1,noClick:!1,wrapper:g}).intercept("textStyle",function(e){this._finished=!1;
var t=this.delegateExtension()||"black";return this._finished||e.isOn()?t:q.toGrayScale(t,null,void 0,150)
}).pvMark.textAlign("left").text(function(e){var t=e.labelText(),i=e.vars;return i.textSize.width>i.labelWidthMax&&(t=q.text.trimToWidthB(i.labelWidthMax,t,i.font,"..",!1)),t
...
}),e.debug>=16&&x.anchor("right").add(t.Panel)[this.anchorLength()](0)[this.anchorOrthoLength()](0).fillStyle(null).strokeStyle(null).lineWidth(0).add(t.Line).data(function(e){var t=e.vars,i=q.text.getLabelBBox(Math.min(t.labelWidthMax,t.textSize.width),2*t.textSize.height/3,"left","middle",0,t.textMargin),n=i.source.points();
...
},_getRootScene:function(){var e=this._rootScene;return e||(this._rootScene=e=new q.visual.legend.LegendRootScene(null,{panel:this,source:this.chart.data,horizontal:this.isAnchorTopOrBottom(),font:this.font,markerSize:this.markerSize,textMargin:this.textMargin,itemPadding:this.itemPadding,itemSize:this.itemSize})),e
...
return i!==n?i:""}}}),e.type("pvc.visual.legend.LegendRootScene",q.visual.Scene).init(function(t,i){this.base(t,i),this._unresolvedMarkerDiam=e.get(i,"markerSize"),this._unresolvedItemPadding=new Z(e.get(i,"itemPadding",5)),this._unresolvedItemSize=Q.to(e.get(i,"itemSize"))||new Q,e.set(this.vars,"horizontal",e.get(i,"horizontal",!1),"font",e.get(i,"font"),"textMargin",e.get(i,"textMargin",6)-3)
...
h?r=!h.items.length:(h=new q.visual.legend.LegendItemSceneSection(0),r=!0);var g=h.size[v]+f[v];
...
}}function n(e){var t=h.size;m[p]+=t[p],g.length&&(m[p]+=s[p]),m[v]=Math.max(m[v],t[v]),g.push(h),e||(h=new q.visual.legend.LegendItemSceneSection(g.length))
}var a=t.clientSize;if(!(a.width>0&&a.height>0))return new Q(0,0);var r=t.desiredClientSize,s=this._unresolvedItemPadding.resolve(a),o={width:a.width+s.width,height:a.height+s.height},l=this._unresolvedItemSize.resolve(o),u={width:l.width&&Math.max(0,l.width-s.width),height:l.height&&Math.max(0,l.height-s.height)},c=this._unresolvedMarkerDiam||u.height||15;
this.vars.itemPadding=s,this.vars.desiredItemSize=l,this.vars.desiredItemClientSize=u,this.vars.markerSize=c;
var h,d=c+this.vars.textMargin,f=Math.max(0,Math.min(u.width||1/0,r.width||1/0,a.width)-d),v=this.vars.horizontal?"width":"height",p=q.BasePanel.oppositeLength[v],g=[],m={width:0,height:0},b=r[v],x=b;
if((!x||0>x)&&(x=a[v]),this.childNodes.forEach(function(e){e.childNodes.forEach(i,this)
},this),!h)return new Q(0,0);n(!0),e.set(this.vars,"sections",g,"contentSize",m,"labelWidthMax",f);
...
},defaultGroupSceneType:function(){var t=this._groupType;return t||(t=e.type(q.visual.legend.LegendGroupScene),this._groupType=t),t
},createGroup:function(e){var t=this.defaultGroupSceneType();return new t(this,e)
}}),e.type("pvc.visual.legend.LegendGroupScene",q.visual.Scene).init(function(t,i){this.base(t,i),this.legendBaseIndex=e.get(i,"legendBaseIndex")||0,this.colorAxis=e.get(i,"colorAxis"),this.clickMode=e.get(i,"clickMode"),!this.clickMode&&this.colorAxis&&(this.clickMode=this.colorAxis.option("LegendClickMode"))
}).add({_rendererCreate:function(t,i,n){function a(e){var n=new q.visual.Panel(t,i).pvMark;
return u&&n.visible(function(t){return!!t.group.dimensions(u).atom(e)}),n}function r(){var a=new q.visual.Panel(t,i).pvMark,r={drawLine:s.option("LegendDrawLine"),drawMarker:s.option("LegendDrawMarker"),markerShape:s.option("LegendShape")},l=q.visual.legend.symbolRenderer(r);
...
},renderer:function(e){return arguments.length?(e&&"object"==typeof e&&(e=q.visual.legend.symbolRenderer(e)),this._renderer=e,this):this._renderer||(this._renderer=this._rendererCreate.bind(this))
...
var a=q.makeExtensionAbsId(q.makeExtensionAbsId("ItemScene",[this.extensionPrefix,"$"]),n._getExtensionPrefix()),r=n.chart._getExtension(a,"value");
...
}),e.type("pvc.visual.legend.LegendItemScene",q.visual.Scene).add({_ibits:null,ibits:function(){var e=this._ibits;
if(null==e){if(this.executable())e=-1;else{var t=q.visual.Interactive;e=t.Interactive|t.ShowsInteraction|t.Hoverable|t.SelectableAny
...
},_valueEval:function(){var e=this._valueEvalCore();return e instanceof tt||(e=new tt(e,e)),e
},_valueEvalCore:function(){var e,t,i,n,a,r=this.group||this.datum;return r&&(e=r.value,t=r.rawValue,a=this._getTrendLineSuffix(r),i=r.ensureLabel()+a,n=r.absLabel?r.absLabel+a:i),new tt(e||null,i||"",t,n)
...
}}),e.space("pvc.visual.legend").symbolRenderer=function(t){function i(e,t){var i=q.makeExtensionAbsId(e,t);
return u?i.concat(q.makeExtensionAbsId(e,u)):i}function n(e,t,n,u){var c=q.extensionTag,h=function(e){return e.color
},d=["$",u];if(s){var f=(new U).left(0).top(function(){return this.parent.height()/2
...
});l&&(f=l.extend(f)),new q.visual.Rule(e,t,{proto:f,noSelect:!1,noHover:!1,activeSeriesAware:!1,extensionId:i("Rule",d),showsInteraction:!0,wrapper:n})
}if(o){var v=(new U).left(function(){return this.parent.width()/2}).top(function(){return this.parent.height()/2
...
});r&&(v=r.extend(v)),new q.visual.Dot(e,t,{proto:v,freePosition:!0,activeSeriesAware:!1,noTooltip:!0,noClick:!0,extensionId:i("Dot",d),wrapper:n}).pvMark.pointingRadiusMax(0)
}}var a,r,s=e.get(t,"drawLine",!1),o=!s||e.get(t,"drawMarker",!0),l=s?e.get(t,"rulePvProto"):null,u=e.array.to(e.get(t,"extensionPrefix"));
return o&&(a=e.get(t,"markerShape","square"),r=e.get(t,"markerPvProto")),n},e.type("pvc.TitlePanelAbstract",q.BasePanel).init(function(e,t,i){i||(i={});
var n=i.anchor||this.anchor;if(null==i.size){var a=i.titleSize;null!=a&&(i.size=(new Q).setSize(a,{singleProp:this.anchorOrthoLength(n)}))
}if(null==i.sizeMax){var r=i.titleSizeMax;null!=r&&(i.sizeMax=(new Q).setSize(r,{singleProp:this.anchorOrthoLength(n)}))
}if(null==i.paddings&&(i.paddings=this.defaultPaddings),this.base(e,t,i),void 0===i.font){var s=this._getExtension("label","font");
"string"==typeof s&&(this.font=s)}}).add({pvLabel:null,anchor:"top",title:null,titleSize:void 0,font:"12px sans-serif",defaultPaddings:2,_extensionPrefix:"title",_calcLayout:function(e){var i=new Q,n=this.anchor,a=this.anchorLength(n),r=this.anchorOrthoLength(n),s=t.Text.measureWidth(this.title,this.font)+2,o=e.clientSize[a],l=e.desiredClientSize[a];
null==l?l=s>o?o:s:l>o&&(l=o);var u=this.title,c=u?s>l?q.text.justify(u,l,this.font):[u]:[],h=t.Text.fontHeight(this.font),d=c.length*h,f=e.clientSize[r],v=e.desiredClientSize[r];
if(null==v?v=d:v>f&&(v=f),d>v){var p=Math.max(1,Math.floor(v/h));if(c.length>p){var g=c[p];
c.length=p,d=v=p*h;var m=c[p-1]+" "+g;c[p-1]=q.text.trimToWidthB(l,m,this.font,"..")
}}return e.lines=c,e.topOffset=(v-d)/2,e.lineSize={width:l,height:h},e.a_width=a,e.a_height=r,i[a]=l,i[r]=v,i
},_createCore:function(e){var t,i=this._buildScene(e),n={top:0,right:Math.PI/2,bottom:0,left:-Math.PI/2},a=q.BasePanel.horizontalAlign[this.align],r=q.BasePanel.leftTopAnchor[this.anchor];
this.compatVersion()<=1&&(t=function(e){return function(){return e.call(this)}}),this.pvLabel=new q.visual.Label(this,this.pvPanel,{extensionId:"label",wrapper:t}).lock("data",i.lineScenes).pvMark[r](function(t){return e.topOffset+t.vars.size.height/2+this.index*t.vars.size.height
...
}).font(this.font).textBaseline("middle").textAngle(n[this.anchor])},_buildScene:function(t){var i=new q.visual.Scene(null,{panel:this,source:this.chart.data}),n=t.lines;
return i.vars.size=t.lineSize,i.vars.textLines=n,i.lineScenes=e.array.create(n.length,i),i
},_getExtensionId:e.fun.constant("")}),e.type("pvc.TitlePanel",q.TitlePanelAbstract).init(function(e,t,i){i||(i={});
...
}).add({font:"14px sans-serif",defaultPaddings:4}),e.type("pvc.GridDockingPanel",q.BasePanel).add({anchor:"fill",_calcLayout:function(t){function i(n,a){m&&g.log.group("LayoutCycle "+(O?"- Disaster MODE":"#"+(a+1)));
try{for(var r,l,u=t.canChange!==!1&&!O&&n>0,c=!1,h=!1,d=0,f=M.length;f>d;){m&&g.log.group("SIDE Child #"+(d+1));
try{if(r=o(M[d],u),!O&&r){if(l=!1,0!==(r&T)&&(m&&g.log("SIDE Child #"+(d+1)+" changed overflow paddings"),c||(c=!0,t.requestPaddings=t.paddings)),0!==(r&I)&&(n>0?(m&&g.log("SIDE Child #"+(d+1)+" changed normal paddings"),l=!0):e.debug>=2&&g.log.warn("SIDE Child #"+(d+1)+" changed paddings but no more iterations possible.")),0!==(r&R))return O=!0,i(0),!1;
if(l)return!0}}finally{m&&g.log.groupEnd()}d++}if(c)return m&&g.log("Restarting due to overflowPaddings change"),!1;
for(d=0,f=P.length;f>d;){m&&g.log.group("FILL Child #"+(d+1));try{if(r=s(P[d],u),!O&&r){if(l=!1,0!==(r&A)&&(h=!0,m&&g.log("FILL Child #"+(d+1)+" increased client size")),0!==(r&I)&&(n>0?(e.debug>=5&&g.log("FILL Child #"+(d+1)+" increased paddings"),h||(l=!0)):e.debug>=2&&g.log.warn("FILL Child #"+(d+1)+" increased paddings but no more iterations possible.")),0!==(r&R))return O=!0,i(0),!1;
...
x=Z.resolvedMax(x,n)}else e.hasOwn(w,i)||e.fail.operationInvalid("Unknown anchor value '{0}'",[i]),M.push(t)
}function r(e,i){m&&g.log.group("SIDE Child #"+(i+1));try{var n=0,a=e.anchor,r=t.canChange!==!1;
return k.paddings=h(a,x),e.layout(new Q(y),k),e.isVisible&&(n|=d(a,x,e)|v(e,r,!1),l(a,e),u(a,e)),n
}finally{m&&g.log.groupEnd()}}function s(e,t){var i=0,n=e.anchor;return k.paddings=h(n,x),k.canChange=t,e.layout(new Q(y),k),e.isVisible&&(i|=d(n,x,e,t)|v(e,t,!0),l(n,e),c(e,n)),i
}function o(i,n){var a=0;if(i.isVisible){var r=i.anchor,s=C[r],o=S[r],l=y[s],u=i[o],p=new Q(e.set({},s,l,o,u));
...
}function h(e,t){var i=new Z;return p(e).forEach(function(e){i.set(e,t[e])}),i}function d(t,i,n,a){var r=n._layoutInfo.requestPaddings,s=0;
...
}),s)){var o=Z.names.map(function(e){return(i[e]||0).toFixed(0)}).join("|");e.hasOwn(D,o)?(e.debug>=2&&g.log.warn("LOOP detected!!!!"),s|=R):D[o]=!0,i.width=i.left+i.right,i.height=i.top+i.bottom
...
l>=u&&(a?(s|=T,i[t]=o,m&&g.log("changed overflow padding "+t+" <- "+o)):e.debug>=2&&g.log.warn("CANNOT change overflow padding but child wanted to: "+t+"="+o))
}}),s&&(i.width=i.left+i.right,i.height=i.top+i.bottom),s}function v(i,n,a){function r(a){var r=(y[a]||0)+_[a],o=i[a]||0,l=o-r;
l>0&&(n?(_[a]+=l,s|=A,t.clientSize[a]+=l,m&&g.log("changed child size "+a+" <- "+o)):e.debug>=2&&g.log.warn("CANNOT change child size but child wanted to: "+a+"="+o+" available="+r))
}var s=0;return a?Q.names.forEach(r):r(i.anchorLength()),s}function p(e){switch(e){case"left":case"right":return Z.vnames;
case"top":case"bottom":return Z.hnames;case"fill":return Z.names}}var g=this;if(g._children){var m=e.debug>=5,b=new Z(0),x=new Z(0),y=e.copyOwn(t.clientSize),_=new Q(0,0),S=q.BasePanel.orthogonalLength,w=q.BasePanel.relativeAnchor,C=q.BasePanel.parallelLength,k={force:!0,referenceSize:t.clientSize},P=[],M=[],D={},R=1,I=2,T=4,A=8,L=new Z,O=!1;
...
try{!function(){for(var e=0,i=M.length;i>e;e++)if(0!=(r(M[e],e)&A))return m&&g.log("Restarting due to clientSize increase"),t.clientSize
...
}return t.gridMargins=new Z(b),t.gridPaddings=new Z(x),t.gridSize=new Q(y),t.clientSize
}finally{m&&g.log.groupEnd()}}}}),e.type("pvc.BaseChart",q.Abstract).add(q.visual.Interactive).init(function(t){var n=t,a=this.parent=e.get(t,"parent")||null;
a?t||e.fail.argumentRequired("options"):(ot&&ot(),t=e.mixin.copy({},this.defaults,t)),this.options=t,a?(this.root=a.root,this.smallColIndex=t.smallColIndex,this.smallRowIndex=t.smallRowIndex):(this.root=this,this._format=i.format.language().createChild()),this.base(),e.debug>=3&&this.log.info("NEW CHART\n"+e.logSeparator.replace(/-/g,"=")+"\n  DebugLevel: "+e.debug),e.debug>=3&&!a&&n&&(this.log.info("OPTIONS:\n",n),e.debug>=5&&this.log.debug(e.describe(n,{ownOnly:!1,funs:!0}))),a&&a._addChild(this),this._constructData(t),this._constructVisualRoles(t)
...
}if(t){var n=this,a=n.basePanel;i("left")|i("top")&&a&&e.set(a.position,"left",this.left,"top",this.top),i("width")|i("height")&&a&&(a.size=new Q(this.width,this.height)),i("margins")&&a&&(a.margins=new Z(this.margins)),i("paddings")&&a&&(a.paddings=new Z(this.paddings))
...
else{var a="batik"!==t.renderer();a&&null==(a=e.interactive)&&(a=!0);var r=0;if(a){var s=q.visual.Interactive;
r=s.Interactive|s.ShowsInteraction,this._processTooltipOptions(e)&&(r|=s.ShowsTooltip),e.animate&&n.support.svg&&(r|=s.Animatable);
var o=!1;if(e.selectable)switch(r|=s.Selectable,q.parseSelectionMode(e.selectionMode)){case"rubberband":r|=s.SelectableByRubberband|s.SelectableByClick;
break;case"focuswindow":r|=s.SelectableByFocusWindow,o=!0}o||"emptyspaceclick"!==q.parseClearSelectionMode(e.clearSelectionMode)||(r|=s.Unselectable),e.hoverable&&(r|=s.Hoverable),e.clickable&&(r|=s.Clickable|s.DoubleClickable),this._processPointingOptions(e)
...
}},_processPointingOptions:function(t){var i=t.pointing,n=t.pointingMode;null==n&&(i&&(n=i.mode),n||(n="near")),i=i?e.copyOwn(i):{},i.mode=q.parsePointingMode(n),e.eachOwn(this._pointingDefaults,function(e,t){void 0===i[t]&&(i[t]=e)
}),i.collapse=q.parsePointingCollapse(i.collapse),i.painted=!0,this._pointingOptions=i||{}
...
try{this.useTextMeasureCache(function(){try{for(;;){if(this.parent||q.removeTipsyLegends(),(!this.isCreated||i)&&this._create({reloadData:n}),this.basePanel.render({bypassAnimation:t,recreate:i}),!this._isMultiChartOverflowClip){this._isMultiChartOverflowClipRetry=!1;
...
},isOrientationVertical:function(e){return(e||this.options.orientation)===q.orientation.vertical
},isOrientationHorizontal:function(e){return(e||this.options.orientation)===q.orientation.horizontal
...
var ot=function(){var e=q.BaseChart.prototype.defaults;e.valueFormat||(e.valueFormat=i.format.defaults.number()),e.percentValueFormat||(e.percentValueFormat=i.format.defaults.percent()),ot=null
};q.BaseChart.add({visualRoles:null,visualRoleList:null,_measureVisualRoles:null,visualRole:function(t){var i=e.getOwn(this.visualRoles,t);
...
},_addVisualRole:function(t,i){i=e.set(i,"index",this.visualRoleList.length);var n=new q.visual.Role(t,i),a=[t];
...
}}),q.BaseChart.add({dataEngine:null,data:null,_partsDataCache:null,_visibleDataCache:null,resultset:[],metadata:[],_constructData:function(t){this.parent&&(this.dataEngine=this.data=t.data||e.fail.argumentRequired("options.data"))
...
},_loadData:function(){W&&(!this.data&&!this._translation||e.assert("Invalid state."));
var t,n,a,r=this.options,s=this._createDimensionsOptions(r),o=this._createComplexTypeProject(),l=q.visual.rolesBinder().dimensionsOptions(s).logger(this._createLogger()).context(this._createVisualRolesContext()).complexTypeProject(o).begin(),u=this._getDataPartDimName(!0);
...
}return u},_initMultiCharts:function(){var t=this;t.multiOptions=new q.visual.MultiChart(t),t.smallOptions=new q.visual.SmallChart(t);
...
}}),q.BaseChart.add({_initPlots:function(){var e=this.parent;if(e)this.plots=e.plots,this.plotList=e.plotList,this.plotsByType=e.plotsByType;
...
var a=q.visual.Plot.getClass(i);if(!a)throw e.error.argumentInvalid("plots","The plot type '{0}' is not defined.",[i]);
return!this.plotList.length,new a(this,{name:t,isInternal:!1,spec:n})},_createPlotTrend:function(){},_addPlot:function(t){var i=this.plots,n=t.index,a=t.name,r=t.id;
...
e.array.lazy(n,t.axisIndex).push(t)})}}),q.BaseChart.add({colors:null,axes:null,axesList:null,axesByType:null,_axisClassByType:{color:q.visual.ColorAxis,size:q.visual.SizeAxis},_axisCreateChartLevel:{color:1,size:2,base:3,ortho:3},_axisSetScaleChartLevel:{color:1,size:2,base:2,ortho:2},_axisCreationOrder:["color","size","base","ortho"],_axisCreateIfUnbound:{},_chartLevel:function(){var e=0;
...
a?(n=this._axisClassByType[e]||q.visual.Axis,a.forEach(function(t){var i=t[0].axisIndex;
new n(this,e,i)},this)):this._axisCreateIfUnbound[e]&&(n=this._axisClassByType[e]||q.visual.Axis,n&&new n(this,e,0))
...
if(i){var a=i.min,r=i.max,s=1;normalize=function(){var e=r-a;e&&Math.abs(e)<s&&(r=a=new Date(Math.round((a+r)/2)),e=0),e?0>e&&(!i.maxLocked||i.minLocked?r=new Date(a.getTime()+q.time.intervals.h):a=new Date(r.getTime()-q.time.intervals.h)):(i.minLocked||(a=new Date(a.getTime()-q.time.intervals.h)),(!i.maxLocked||i.minLocked)&&(r=new Date(r.getTime()+q.time.intervals.h)))
...
},this),n?(a=function(t){var i=""+t;return e.hasOwnProp.call(r,i)?r[i]:r[i]=n(t)},e.copy(a,n),a):q.createColorScheme()()
},_onLaidOut:function(){}}),q.BaseChart.add({basePanel:null,titlePanel:null,legendPanel:null,_multiChartPanel:null,_initChartPanels:function(e){this._initBasePanel(),this._initTitlePanel();
...
}},_initBasePanel:function(){var e=this.parent;this.basePanel=new q.BasePanel(this,e&&e._multiChartPanel,{margins:this.margins,paddings:this.paddings,size:{width:this.width,height:this.height}})
},_initTitlePanel:function(){var t=this,i=t.options,n=i.title;e.empty(n)||(this.titlePanel=new q.TitlePanel(t,t.basePanel,{title:n,font:i.titleFont,anchor:i.titlePosition,align:i.titleAlign,alignTo:i.titleAlignTo,offset:i.titleOffset,keepInBounds:i.titleKeepInBounds,margins:i.titleMargins,paddings:i.titlePaddings,titleSize:i.titleSize,titleSizeMax:i.titleSizeMax}))
},_initLegendPanel:function(){var t=this.options;if(t.legend){var i=new q.visual.Legend(this,"legend",0);
return this.legendPanel=new q.LegendPanel(this,this.basePanel,{anchor:i.option("Position"),align:i.option("Align"),alignTo:t.legendAlignTo,offset:t.legendOffset,keepInBounds:t.legendKeepInBounds,size:i.option("Size"),sizeMax:i.option("SizeMax"),margins:i.option("Margins"),paddings:i.option("Paddings"),font:i.option("Font"),scenes:e.getPath(t,"legend.scenes"),textMargin:t.legendTextMargin,itemPadding:t.legendItemPadding,itemSize:i.option("ItemSize"),markerSize:t.legendMarkerSize})
}},_getLegendRootScene:function(){return this.legendPanel&&this.legendPanel._getRootScene()
},_initMultiChartPanel:function(){var e=this.basePanel,t=this.options;this._multiChartPanel=new q.MultiChartPanel(this,e,{margins:t.contentMargins,paddings:t.contentPaddings}),this._multiChartPanel.createSmallCharts(),e._children.unshift(e._children.pop())
...
},this)},_createPlotPanel:function(t,i,n){var a=q.PlotPanel.getClass(t.type);if(!a)throw e.error.invalidOperation("There is no registered panel class for plot type '{0}'.",[t.type]);
...
}}),q.BaseChart.add({_updateSelectionSuspendCount:0,_lastSelectedDatums:null,clearSelections:function(){return this.data.owner.clearSelected()&&this.updateSelections(),this
...
var i=this._calcSelectedChangedDatums();if(!i)return this;q.removeTipsyLegends(),this._inUpdateSelections=!0;
...
}return this.root._onUserSelection(e)}}),q.BaseChart.add({_processExtensionPoints:function(){this.parent?this._components=this.parent._components:(this._processExtensionPointsIn(this.options),this._processExtensionPointsIn(this.options.extensionPoints))
...
if(a){t.borderPanel&&(t=t.borderPanel);var r=e.debug>=3?[]:null,s=e.get(n,"constOnly",!1),o=t.wrap,l={tag:q.extensionTag},u=t instanceof U,c=u&&(o||s),h=function(i,n){if(null!=i){var a=typeof i;
...
}}),e("pvc.visual.MultiChart",q.visual.OptionsBase.extend({init:function(e){this.base(e,"multiChart",0,{byV1:!1,byNaked:!1})
},options:{Max:{resolve:"_resolveFull",cast:e.number.toPositive,value:1/0},ColumnsMax:{resolve:"_resolveFull",cast:e.number.toPositive,value:3},SingleRowFillsHeight:{resolve:"_resolveFull",cast:Boolean,value:!0},SingleColFillsHeight:{resolve:"_resolveFull",cast:Boolean,value:!0},Overflow:{resolve:"_resolveFull",cast:q.parseMultiChartOverflow,value:"grow"}}})),e.type("pvc.MultiChartPanel",q.BasePanel).add({anchor:"fill",createSmallCharts:function(){var t,i=this.chart,n=i._multiInfo;
...
if(!i.isNull){var n=i.domain();return{min:n[0],max:n[1]}}}).reduce(q.unionExtents,null);
...
null!=c&&(c=Y.resolve(c,l));var h=r("Height");null!=h&&(h=Y.resolve(h,u));var d=r("AspectRatio"),f=n.rowCount,v=n.colCount;
...
}}),e("pvc.visual.SmallChart",q.visual.OptionsBase.extend({init:function(e){this.base(e,"small",0,{byV1:!1,byNaked:!1})
},options:{Width:{resolve:"_resolveFull",cast:Y.parse,value:null},Height:{resolve:"_resolveFull",cast:Y.parse,value:null},AspectRatio:{resolve:"_resolveFull",cast:e.number.toPositive,getDefault:function(){return this.chart instanceof q.PieChart?10/7:5/4
}},Margins:{resolve:"_resolveFull",cast:Z.as,value:new Z(new Y(.02))},Paddings:{resolve:"_resolveFull",cast:Z.as,value:0}}})),U.prototype.getSign=function(){return this.sign||R(this)
},U.prototype.getScene=function(){return this.getSign().scene()},U.prototype.getContext=function(){return this.getSign().context()
},U.prototype.preBuildInstance=function(e){var t=e.data;t instanceof q.visual.Scene&&g.call(t,this.renderId())
...
},delegate:function(e,t){return this.pvMark.delegate(e,t)},delegateExtension:function(e){return this.pvMark.delegate(e,q.extensionTag)
},delegateNotExtension:function(e){return this.pvMark.delegateExcept(e,q.extensionTag)
...
}))},scene:function(){var e=this.pvMark.instance(),t=e&&e.data;return t instanceof q.visual.Scene?t:null
...
},postInit:function(e,t,i){this._addInteractive(i),e._addSign(this)},methods:[q.visual.Interactive],"type.methods":{properties:function(t){var i;
...
},o[s]=function(e,t){return t},this.methods(o)})}},{properties:["color"]},{methods:{extensionAbsIds:null,createDefaultWrapper:function(){var e=this;
...
},_extensionKeyArgs:{tag:q.extensionTag},_bindProperty:function(t,i,n){var a=this;
n||(n=i);var r="default"+e.firstUpperCase(n);if(e.fun.is(a[r])&&!a.pvMark.hasDelegateValue(t,q.extensionTag)){var s=function(e){return a[r](e,a._arg)
...
},_initDefColorScale:function(){var t=this.panel.axes.color;return t?t.sceneScale({sceneVarName:"color"}):e.fun.constant(q.defaultColor)
...
if(r){var s=e.get(t,"tipsyEvent")||("near"===n.mode?"point":"mouseover");this.pvMark.localProperty("tooltip").tooltip(this._createTooltipProp(r,a.isLazy)).title(e.fun.constant("")).ensureEvents().event(s,i).tooltipOptions=a
...
},function(e){return e&&e.showsTooltip()?i(e):void 0}},_addPropHoverable:function(){var e,t,i=this.chart._pointingOptions,n=this.panel;
"near"===i.mode?(e="point",t="unpoint"):(e="mouseover",t="mouseout"),this.pvMark.ensureEvents().event(e,function(e){!e.hoverable()||n.selectingByRubberband()||n.animating()||(e.setActive(!0),n.renderInteractive())
}).event(t,function(e){!e.hoverable()||n.selectingByRubberband()||n.animating()||e.clearActive()&&n.renderInteractive()
})},_ignoreClicks:0,_propCursorClick:function(e){var t=this.ibits()&e.ibits(),i=q.visual.Interactive;
...
},_onDoubleClick:function(e){e.doubleClick()}}}])),q.finished=function(t){return void 0===t?function(){return this.finished(this.delegate())
}:e.fun.is(t)?function(){return(this.finished?this:this.getSign()).finished(t.apply(this,arguments))
}:function(){return(this.finished?this:this.getSign()).finished(t)}},e("pvc.visual.Panel",q.visual.Sign.extend({init:function(i,n,a){var r=e.get(a,"panel");
...
}}})),e("pvc.visual.Label",q.visual.Sign.extend({init:function(e,i,n){var a=i.add(t.Label);
...
if(!this.hideOrTrimOverflowed)return this.delegate(!0);var i;if(this.hasDelegate(q.extensionTag)&&(i=this.delegateExtension(),null!=i))return i;
...
if(i&&i!==lt&&this.isAnchoredInside(e,t))return i}return lt},getAnchoredToMark:function(){return this.pvMark.target||this.pvMark.parent
...
return n&&n!==lt&&n.isDark()===t.isDark()?t.complementary().alpha(.9):t}return t},normalColor:function(e,t,i){return this.maybeOptimizeColorLegibility(e,t,i)
...
this._lockDynamic(o,"x")._lockDynamic(l,"y")}this._bindProperty("shape","shape")._bindProperty("shapeRadius","radius")._bindProperty("shapeSize","size"),this.optional("strokeDasharray",void 0).optional("lineWidth",1.5)
},properties:["size","shape"],methods:{y:e.fun.constant(0),x:e.fun.constant(0),radius:function(){this.instanceState().cccRadius=this.delegateExtension()
},baseSize:function(t){var i=this.instanceState().cccRadius;return null!=i?e.sqr(i):this.base(t)
},defaultSize:e.fun.constant(12),interactiveSize:function(e,t){return this.mayShowActive(e,!0)?2.5*Math.max(t,5):t
...
}}})),e("pvc.visual.DotSizeColor",q.visual.Dot.extend({init:function(e,i,n){if(this.base(e,i,n),this._bindProperty("lineWidth","strokeWidth").intercept("visible",function(e){if(!this.canShow(e))return!1;
...
}this._sceneDefColor=i||e.fun.constant(t||q.defaultColor)},_initSize:function(){var t,i,n=this.panel,a=n.plot,r=a.option("Shape"),s=a.option("NullShape"),o=n.visualRoles.size;
...
return a&&a.data&&a.data.isIntermediate&&n+1<e.length&&n++,n},e("pvc.visual.Line",q.visual.Sign.extend({init:function(i,n,a){var r=n.add(t.LineInterm);
...
return a&&a.data&&a.data.isIntermediate&&n+1<e.length&&n++,n},e("pvc.visual.Area",q.visual.Sign.extend({init:function(i,n,a){var r=n.add(t.AreaInterm);
...
}}})),e.space("pvc.visual").discreteBandsLayout=T;var ut=e("pvc.visual.CartesianAxis",it.extend({init:function(e,t,i,n){var a=e.options;
this.orientation=ut.getOrientation(t,a.orientation),this.orientedId=ut.getOrientedId(this.orientation,i),e._allowV1SecondAxis&&1===i&&(this.v1SecondOrientedId="second"+this.orientation.toUpperCase()),this.base(e,t,i,n),e.axes[this.orientedId]=this,this.v1SecondOrientedId&&(e.axes[this.v1SecondOrientedId]=this),this.extensionPrefixes=z.call(this)
},methods:{bind:function(e){return this.base(e),this._syncExtensionPrefixes(),this
},_syncExtensionPrefixes:function(){this.extensionPrefixes=z.call(this)},setScale:function(e){var t=this.scale;
...
},getScaleRangeInfo:function(){if(!this.isDiscrete())return null;var e=q.visual.discreteBandsLayout(this.domainItemCount(),this.option("BandSize"),this.option("BandSizeMin")||0,this.option("BandSizeMax"),this.option("BandSpacing"),this.option("BandSpacingMin")||0,this.option("BandSpacingMax"),this.option("BandSizeRatio"));
...
},_resolveByOrientedId:q.options.specify(function(e){return this._chartOption(this.orientedId+"Axis"+e.name)
}),_resolveByV1OptionId:q.options.specify(function(e){return this._chartOption("secondAxis"+e.name)
}),_resolveByScaleType:q.options.specify(function(e){var t=this.scaleType;if(t){var i=e.name,n=this._chartOption(t+"Axis"+i);
return void 0===n&&"discrete"!==t&&(n=this._chartOption("continuousAxis"+i)),n}}),_resolveByCommonId:q.options.specify(function(e){return this._chartOption("axis"+e.name)
})}}));ut.getOrientation=function(e,t){return"base"===e==("vertical"===t)?"x":"y"
},ut.getOrientedId=function(e,t){return 0===t?e:e+(t+1)};var ct={resolve:"_resolveFull",data:{resolveV1:function(e){return this.index||"ortho"!==this.type||this._specifyChartOption(e,this.id+e.name),!0
}}},ht={resolveV1:function(e){if(this.index){if(this._resolveByV1OptionId(e))return!0
}else if(this._resolveByOrientedId(e))return!0;return this._resolveDefault(e),!0}},dt=q.options.defaultValue(function(){if(!this.typeIndex)return"x"===this.orientation?"bottom":"left";
var e=this.chart.axesByType[this.type].first,t=e.option("Position");return q.BasePanel.oppositeAnchor[t]
});ut.options({Visible:{resolve:"_resolveFull",data:{resolveV1:function(t){if(this.index<=1){var i=0===this.index?e.firstUpperCase(this.orientation):"Second";
...
}},cast:Boolean,value:!1},Size:{resolve:"_resolveFull",data:ht,cast:B},SizeMax:{resolve:"_resolveFull",cast:B},Position:{resolve:"_resolveFull",data:{resolveV1:ht.resolveV1,resolveDefault:dt},cast:O},FixedMin:ct,FixedMax:ct,OriginIsZero:{resolve:"_resolveFull",data:{resolveV1:function(e){switch(this.index){case 0:this._specifyChartOption(e,"originIsZero");
break;case 1:this.chart._allowV1SecondAxis&&this._specifyChartOption(e,"secondAxisOriginIsZero")
}return!0}},cast:Boolean,value:!0},DomainScope:{resolve:"_resolveFull",cast:A,value:"global"},Offset:{resolve:"_resolveFull",data:{resolveV1:function(e){switch(this.index){case 0:this._specifyChartOption(e,"axisOffset");
...
}},BandSize:{resolve:"_resolveFull",cast:e.number.toNonNegative},BandSpacing:{resolve:"_resolveFull",cast:e.number.toNonNegative},BandSizeMin:{resolve:"_resolveFull",cast:e.number.toNonNegative},BandSpacingMin:{resolve:"_resolveFull",cast:e.number.toNonNegative},BandSizeMax:{resolve:"_resolveFull",cast:e.number.toNonNegative},BandSpacingMax:{resolve:"_resolveFull",cast:e.number.toNonNegative},LabelSpacingMin:{resolve:"_resolveFull",cast:e.number.to},OverlappedLabelsMode:{resolve:"_resolveFull",cast:q.parseOverlappedLabelsMode,value:"rotatethenhide"},Grid:{resolve:"_resolveFull",data:{resolveV1:function(e){return this.index||this._specifyChartOption(e,this.orientation+"AxisFullGrid"),!0
}},cast:Boolean,value:!1},GridCrossesMargin:{resolve:"_resolveFull",cast:Boolean,value:!0},EndLine:{resolve:"_resolveFull",cast:Boolean},ZeroLine:{resolve:"_resolveFull",cast:Boolean,value:!0},RuleCrossesMargin:{resolve:"_resolveFull",cast:Boolean,value:!0},Ticks:{resolve:"_resolveFull",cast:Boolean},DesiredTickCount:{resolve:"_resolveFull",data:{resolveV1:ht.resolveV1,resolveDefault:function(e){return this.chart.compatVersion()<=1?(e.defaultValue(5),!0):void 0
}},cast:e.number.toPositive},MinorTicks:{resolve:"_resolveFull",data:ht,cast:Boolean,value:!0},TickFormatter:{resolve:"_resolveFull",cast:e.fun.as},DomainRoundMode:{resolve:"_resolveFull",data:{resolveV1:ht.resolveV1,resolveDefault:function(e){return this.chart.compatVersion()<=1?(e.defaultValue("none"),!0):void 0
}},cast:q.parseDomainRoundingMode,value:"tick"},TickExponentMin:{resolve:"_resolveFull",cast:e.number.to},TickExponentMax:{resolve:"_resolveFull",cast:e.number.to},TickUnit:{resolve:"_resolveFull"},TickUnitMin:{resolve:"_resolveFull"},TickUnitMax:{resolve:"_resolveFull"},Title:{resolve:"_resolveFull",cast:String},TitleSize:{resolve:"_resolveFull",cast:V},TitleSizeMax:{resolve:"_resolveFull",cast:V},TitleFont:{resolve:"_resolveFull",cast:String},TitleMargins:{resolve:"_resolveFull",cast:Z.as},TitlePaddings:{resolve:"_resolveFull",cast:Z.as},TitleAlign:{resolve:"_resolveFull",cast:function(e){var t=this.option("Position");
return q.parseAlign(t,e)}},Font:{resolve:"_resolveFull",cast:String},ClickAction:{resolve:"_resolveFull",data:ht},DoubleClickAction:{resolve:"_resolveFull",data:ht},TooltipEnabled:{resolve:"_resolveFull",cast:Boolean,value:!0},TooltipFormat:{resolve:"_resolveFull",cast:e.fun.as,value:null},TooltipAutoContent:{resolve:"_resolveFull",cast:q.parseTooltipAutoContent,value:"value"}}),e.type("pvc.visual.CartesianAxisRootScene",q.visual.Scene),e.type("pvc.visual.CartesianAxisTickScene",q.visual.Scene).init(function(t,i){this.base(t,i),this.vars.tick=new tt(e.get(i,"tick"),e.get(i,"tickLabel"),e.get(i,"tickRaw")),e.get(i,"isHidden")&&(this.isHidden=!0)
}).add({isHidden:!1}),e.type("pvc.AxisPanel",q.BasePanel).init(function(t,i,n,a){a=e.create(a,{anchor:n.option("Position")});
...
o.step=o.base=q.time.intervals.d,o.mult=1,o.format=function(e){return h(e)},a=function(e,t){return s.call(o,o[t],o.step,t)
...
},i),n.maxLabelBBox=t},_calcLabelBBox:function(e){var t=this._layoutInfo;return q.text.getLabelBBox(e,t.textHeight,t.textAlign,t.textBaseline,t.textAngle,t.textMargin)
...
this._rSize=l;var u=this._getRootScene();this.pvRule=new q.visual.Rule(this,this.pvPanel,{extensionId:"rule"}).lock("data",[u]).override("defaultColor",e.fun.constant("#666666")).lock(this.anchorOpposite(),0).lock(n,s).lock(r,l).pvMark.zOrder(30).strokeDasharray(null).lineCap("square"),this.isDiscrete?this.useCompositeAxis?this.renderCompositeOrdinalAxis():this.renderOrdinalAxis():this.renderLinearAxis()
}},_getExtensionId:function(){return""},_getRootScene:function(){if(!this._rootScene){var t=this._rootScene=new q.visual.CartesianAxisRootScene(null,{panel:this,source:this._getRootData()}),i=this._layoutInfo,n=i.ticks,a=i.ticksText;
...
}).join(u),i=s.slice(0,10).join(", ")+(s.length>10?", ...":""),n=new q.visual.CartesianAxisTickScene(t,{source:r,tick:e,tickRaw:e,tickLabel:i,isHidden:!0});
n.dataIndex=l,r=s=l=null}),n.forEach(function(e,i){var n=i%c!==0;if(n&&c>2)null==l&&(l=i),(r||(r=[])).push(e),(s||(s=[])).push(a[i]);
else{r&&o();var u=new q.visual.CartesianAxisTickScene(t,{source:e,tick:e.value,tickRaw:e.rawValue,tickLabel:a[i],isHidden:n});
u.dataIndex=i}}),r&&o()}else n.forEach(function(e,i){var n=new q.visual.CartesianAxisTickScene(t,{tick:e,tickRaw:e,tickLabel:a[i]});
...
}a.childCount()&&a.children().each(function(i){var a=n?n(i.value,i.label):i.label,r=new q.visual.CartesianAxisTickScene(e,{source:i,tick:i.value,tickRaw:i.rawValue,tickLabel:a});
r.dataIndex=i.childIndex(),t(r)})}var i=this.compatVersion()<=1,n=this.axis.option("TickFormatter");
e.vars.tick=new tt("",""),t(e)},_getRootData:function(){var e;if(this.isDiscrete&&this.useCompositeAxis){var t=this.anchor,i={visible:this.axis.domainVisibleOnly()?!0:null,isNull:this.chart.options.ignoreNulls||this.axis.domainIgnoreNulls()?!1:null,reverse:"bottom"==t||"left"==t};
...
return i.index=this.parent.index,e.call(i,new v(t.vars.tick))}}}var p=new q.visual.Panel(this,this.pvPanel,{extensionId:"ticksPanel"}).lock("data",h.childNodes).lock(s,0).lockMark(l,function(e){return e.isHidden?i(e.previousSibling.vars.tick.value)+r:i(e.vars.tick.value)
}).lock("strokeDasharray",null).lock("strokeStyle",null).lock("fillStyle",null).lock("lineWidth",0).pvMark.zOrder(20);
(f||this.showTicks)&&(this.pvTicks=new q.visual.Rule(this,p,{extensionId:"ticks",wrapper:e}).lock("data").intercept("visible",function(e){return!e.isHidden&&this.delegateExtension(!0)
...
}).pvMark);var g=this.font,m=this._layoutInfo.maxTextWidth;isFinite(m)||(m=0),this.pvLabel=new q.visual.Label(this,p,{extensionId:"label",showsInteraction:!0,noClick:!1,noDoubleClick:!1,noSelect:!1,noTooltip:!1,noHover:!1,wrapper:e}).intercept("visible",function(e){return e.isHidden?!!e.vars.hiddenLabelText:this.delegateExtension(!0)
}).intercept("text",function(e){var t;return e.isHidden?t=n:(t=this.delegateExtension(),void 0===t&&(t=e.vars.tick.label),!m||this.showsInteraction()&&e.isActive||(t=q.text.trimToWidthB(m,t,g,"..",!1))),t
...
if("value"===i)return e.isLazy=!1,function(e){return e.scene.vars.tick.label}}},_getTooltipPanelClasses:function(){return["cart-axis"]
...
return i.index=this.parent.index,e.call(i,t.vars.tick.rawValue)}});var l=new q.visual.Panel(this,this.pvPanel,{extensionId:"ticksPanel"}).lock("data",o.childNodes).lock(n,0).lockMark(r,function(e){return t(e.vars.tick.value)
}).lock("strokeStyle",null).lock("fillStyle",null).lock("lineWidth",0).pvMark.zOrder(20);
if(this.showTicks){var u=this.pvTicks=new q.visual.Rule(this,l,{extensionId:"ticks",wrapper:e}).lock("data").override("defaultColor",function(){return i.scene?i.scene[0].strokeStyle:"#666666"
...
this.pvMinorTicks=new q.visual.Rule(this,this.pvTicks,{extensionId:"minorTicks",wrapper:e}).lock("data").intercept("visible",function(e){var t=e.childIndex()<d-1&&(!u.scene||u.scene[0].visible);
...
isFinite(r)||(r=0);var s=this.pvLabel=new q.visual.Label(this,e,{extensionId:"label",noHover:!1,showsInteraction:!0,wrapper:t}).lock("data").optional("text",function(e){var t=e.vars.tick.label;
return!r||this.showsInteraction()&&e.isActive||(t=q.text.trimToWidthB(r,t,a,"..",!1)),t
...
}}),this.pvLabel=new q.visual.Label(this,h.label,{extensionId:"label",noClick:!1,noDoubleClick:!1,noSelect:!1,noTooltip:!1,noHover:!1,showsInteraction:!0,wrapper:i,tooltipArgs:{options:{offset:2*c}}}).pvMark.def("lblDirection","h").textAngle(function(e){if(e.depth>=l&&e.depth<o)return this.lblDirection("v"),-Math.PI/2;
...
switch(this.lblDirection()){case"h":if(!n.h)return q.text.trimToWidthB(t.dx,i,u,"..");
break;case"v":if(!n.v)return q.text.trimToWidthB(t.dy,i,u,"..");break;case"d":if(!n.d){var a=Math.sqrt(e.sqr(t.dy)+e.sqr(t.dx));
return q.text.trimToWidthB(a-c,i,u,"..")}}}return i})},_getCompositeLayoutSingleCluster:function(){var i=this._getRootScene(),n=this.anchor,a=i.group.treeHeight+1,r=this._layoutInfo.axisSize,s=a>2?1/12*r:0,o=r/a-s,l=a/(a-1),u=q.BasePanel.orthogonalLength[n],c="width"==u?"left"===n?[-o,0]:[o,0]:"top"===n?[0,-o]:[0,o];
...
case"left":return"w";case"right":return"e"}return"s"}}),e.type("pvc.AxisTitlePanel",q.TitlePanelAbstract).init(function(e,t,i,n){this.axis=i,this.base(e,t,n),this._extensionPrefix=i.extensionPrefixes.map(function(e){return e+"Title"
})}).add({_calcLayout:function(e){var t=this.axis.scale;return!t||t.isNull?new Q(0,0):this.base(e)
},_createCore:function(e){var t=this.axis.scale;return t&&!t.isNull?this.base(e):void 0
}}),e("pvc.visual.CartesianFocusWindow",q.visual.OptionsBase.extend({init:function(e){this.base(e,"focusWindow",0,{byNaked:!1});
var t=e.axes.base;this.base=new q.visual.CartesianFocusWindowAxis(this,t)},methods:{_exportData:function(){return{base:e.copyProps(this.base,q.visual.CartesianFocusWindowAxis.props)}
...
e&&e.call(this.chart.basePanel.context())}},options:{Changed:{resolve:"_resolveFull",cast:e.fun.as}}})),e("pvc.visual.CartesianFocusWindowAxis",q.visual.OptionsBase.extend({init:function(t,i){this.window=t,this.axis=i,this.isDiscrete=i.isDiscrete(),this.base(i.chart,"focusWindow"+e.firstUpperCase(i.type),0,{byNaked:!1})
...
};if(q.visual.CartesianFocusWindowAxis.props.forEach(n,this),i)return t}},_updateSelection:function(t){var n,a,r=this,s=r.axis,o=s.isDiscrete(),l=s.chart,u=s.dataCell,c=u.role,h=l.partData(u.dataPartValue);
...
}},options:{Resizable:{resolve:"_resolveFull",cast:Boolean,value:!0},Movable:{resolve:"_resolveFull",cast:Boolean,value:!0},Begin:{resolve:"_resolveFull"},End:{resolve:"_resolveFull"},Length:{resolve:"_resolveFull"},Constraint:{resolve:"_resolveFull",cast:e.fun.as}}})),e.type("pvc.visual.CartesianOrthoDataCell",q.visual.DataCell).init(function(e,t,i,n,a,r,s,o){this.base(e,t,i,n,a),this.isStacked=r,this.nullInterpolationMode=s,this.trend=o
}),e("pvc.visual.CartesianPlot",q.visual.Plot.extend({init:function(t,i){if(this.base(t,i),!(t instanceof q.CartesianAbstract))throw e.error(e.format("Plot type '{0}' can only be used from within a cartesian chart.",[this.type]))
...
if(t&&this._addDataCell(new q.visual.DataCell(this,"base",this.option("BaseAxis")-1,t,e)),i){var n=this.option("OrthoAxis")-1,a=this.option.isDefined("Stacked")?this.option("Stacked"):void 0,r=this.option("NullInterpolationMode"),s=this.option("Trend");
i.forEach(function(t){this._addDataCell(new q.visual.CartesianOrthoDataCell(this,"ortho",n,t,e,a,r,s))
...
return t?(e.defaultValue({type:t}),!0):void 0}},cast:N},TrendType:{resolve:"_resolveFull",cast:q.parseTrendType},TrendLabel:{resolve:"_resolveFull",cast:String},NullInterpolationMode:{resolve:"_resolveFull",cast:q.parseNullInterpolationMode,value:"none"}}})),e.type("pvc.CartesianAbstract",q.BaseChart).init(function(e){this.axesPanels={},this.base(e)
}).add({_axisClassByType:{base:ut,ortho:ut},_gridDockPanel:null,_defaultAxisBandSizeRatio:.9,axesPanels:null,yAxisPanel:null,xAxisPanel:null,secondXAxisPanel:null,secondYAxisPanel:null,yScale:null,xScale:null,_setAxisScale:function(e,t){this.base(e,t);
...
a&&a.forEach(function(i){e.call(t,i)})})},_calcPlotsClientSizeInfo:function(){if(!this.parent){var e=new Q(0,0),i=new Q(1/0,1/0),n=new Q;
...
}var i={},n=!1;return this._eachCartAxis(t),n?i:null},_createContent:function(t,i){this._createFocusWindow(),this._gridDockPanel=new q.CartesianGridDockingPanel(this,t,{margins:i.margins,paddings:i.paddings}),["base","ortho"].forEach(function(t){var i=this.axesByType[t];
...
t&&(e=t._exportData()),t=this.focusWindow=new q.visual.CartesianFocusWindow(this),e&&t._importData(e),t._initFromOptions()
}else this.focusWindow&&delete this.focusWindow},_createAxisPanel:function(t){if(t.option("Visible")){var i,n=t.option("Title");
e.empty(n)||(i=new q.AxisTitlePanel(this,this._gridDockPanel,t,{title:n,font:t.option("TitleFont")||t.option("Font"),anchor:t.option("Position"),align:t.option("TitleAlign"),margins:t.option("TitleMargins"),paddings:t.option("TitlePaddings"),titleSize:t.option("TitleSize"),titleSizeMax:t.option("TitleSizeMax")}));
var a=new q.AxisPanel(this,this._gridDockPanel,t,{anchor:t.option("Position"),size:t.option("Size"),sizeMax:t.option("SizeMax"),clickAction:t.option("ClickAction"),doubleClickAction:t.option("DoubleClickAction"),useCompositeAxis:t.option("Composite"),font:t.option("Font"),labelSpacingMin:t.option("LabelSpacingMin"),grid:t.option("Grid"),gridCrossesMargin:t.option("GridCrossesMargin"),ruleCrossesMargin:t.option("RuleCrossesMargin"),zeroLine:t.option("ZeroLine"),showTicks:t.option("Ticks"),showMinorTicks:t.option("MinorTicks")});
...
},defaults:{timeSeries:!1,timeSeriesFormat:"%Y-%m-%d"}}),e.type("pvc.CartesianGridDockingPanel",q.GridDockingPanel).init(function(e,t,i){this.base(e,t,i),this._plotBgPanel=new q.PlotBgPanel(e,this)
...
}});var x=new q.visual.Rule(this,this.pvPanel,{extensionId:i.extensionPrefixes.map(function(e){return e+"Grid"
...
}}},_getAxisGridRootScene:function(e){var t=e.isDiscrete(),i=t?e.domainData():this.data,n=new q.visual.CartesianAxisRootScene(null,{panel:this,source:i});
if(t)i.childNodes.forEach(function(e){new q.visual.CartesianAxisTickScene(n,{source:e,tick:e.value,tickRaw:e.rawValue,tickLabel:e.label})
});else{var a=e.ticks||e.calcContinuousTicks();a.forEach(function(t,i){new q.visual.CartesianAxisTickScene(n,{tick:t,tickRaw:t,tickLabel:e.scale.tickFormat(t,i)})
...
return this.compatVersion()<=1&&o.push("xAxisEndLine","yAxisEndLine"),o.push("plotFrame"),new q.visual.Panel(this,this.pvPanel,{extensionId:o}).pvMark.lock("left",n).lock("right",a).lock("top",r).lock("bottom",s).lock("fillStyle",null).events("none").strokeStyle("#666666").lineWidth(1).antialias(!1).zOrder(-8)
}},_createZeroLine:function(i,n){var a=i.scale;if(!a.isNull){var r=a.domain();if(r[0]*r[1]<-1e-12){var s="x"===i.orientation?"left":"bottom",o=this.anchorLength(s),l=this.anchorOrtho(s),u=this.anchorOpposite(l),c=n.gridMargins,h=n.gridPaddings,d=c[s]+h[s]+a(0),f=c[l],v=c[u],p=new q.visual.Scene(null,{panel:this});
return new q.visual.Rule(this,this.pvPanel,{extensionId:i.extensionPrefixes.map(function(e){return e+"ZeroLine"
...
}}},_createFocusWindow:function(i){function n(){F[D]=0-T[_],F[R]=z+T[_]+T[k]}function a(e){return function(){return F[e]
}}function r(){var e=F[P];return Math.max(0,Math.min(V,e))}function s(){var e=r(),t=F[P]+F[M];
return t=Math.max(0,Math.min(V,t)),t-e}function o(e,t){return new q.visual.Bar(c,e,{extensionId:t,normalStroke:!0,noHover:!0,noSelect:!0,noClick:!0,noDoubleClick:!0,noTooltip:!0,showsInteraction:!1}).pvMark.lock("data").lock("visible").lock(y,r).lock(S,s).lock(_,a(D)).lock(C,a(R)).lock(k).lock(w).sign
}function l(){var e=arguments[arguments.length-1],t="end"===e.drag.phase;h._selectingByRubberband=!t,G.render(),j.render();
var i=F[P],n=F[P]+F[M];if(!x){var a=V-i;i=V-n,n=a}f._updatePosition(i,n,t,!0)}function u(e,t){var i,n,a=e.m,r=a[Q],s=F[X];
switch(t){case"new":i=0,n="begin";break;case"resize-begin":i=F[Q]+s-r,n="begin";break;
case"move":i=s,n="begin";break;case"resize-end":i=r-F[Q],n="end"}var o=e.min[Q],l=e.max[Q],u={type:t,target:n,point:r,length:i,length0:s,min:o,max:l,minView:0,maxView:V};
...
if(!p.isNull){var g=f.option("Resizable"),m=f.option("Movable"),b=v.isDiscrete(),x=d.isOrientationVertical(),y=x?"left":"top",_=x?"top":"left",S=c.anchorOrthoLength(y),w=c.anchorOpposite(y),C=c.anchorOrthoLength(_),k=c.anchorOpposite(_),P=x?"x":"y",M="d"+P,D=x?"y":"x",R="d"+D,I=i.gridMargins,T=i.gridPaddings,A={left:I.left+T.left,right:I.right+T.right,top:I.top+T.top,bottom:I.bottom+T.bottom},L=i.clientSize,O=L[S],B=L[C];
A.width=A.left+A.right,A.height=A.top+A.bottom;var V=O-A[S],z=B-A[C],N=T[y],E=T[w],F=new q.visual.Scene(null,{panel:this}),W=b?p.range().step:0,H=W/2;
F[P]=p(f.begin)-H,F[M]=W+(p(f.end)-H)-F[P],n();var G=this._plotBgPanel.pvPanel.borderPanel;
G.lock("data",[F]),m&&g?G.paddingPanel.events("all").cursor("crosshair").event("mousedown",t.Behavior.select().autoRender(!1).collapse(x?"y":"x").positionConstraint(function(e){var t="start"===e.phase?"new":"resize-end";
return u(e,t)})).event("selectstart",function(){n(),l.apply(null,arguments)}).event("select",l).event("selectend",l):G.paddingPanel.events("all");
var U=o(G.paddingPanel,"focusWindowBg").override("defaultColor",e.fun.constant(q.invisibleFill)).pvMark;
m?U.events("all").cursor("move").event("mousedown",t.Behavior.drag().autoRender(!1).collapse(x?"y":"x").positionConstraint(function(e){u(e,"move")
})).event("drag",l).event("dragend",l):U.events("none");var j=new q.visual.Panel(c,c.pvPanel).pvMark.lock("data",[F]).lock("visible").lock("fillStyle",q.invisibleFill).lock("left",A.left).lock("right",A.right).lock("top",A.top).lock("bottom",A.bottom).lock("zOrder",10).events(function(){var e=F.drag;
...
}).antialias(!1),K="rgba(20, 20, 20, 0.1)";new q.visual.Bar(c,j,{extensionId:"focusWindowBaseCurtain",normalStroke:!0,noHover:!0,noSelect:!0,noClick:!0,noDoubleClick:!0,noTooltip:!0,showsInteraction:!1}).override("defaultColor",function(e,t){return"stroke"===t?null:K
...
}).lock(_,a(D)).lock(C,a(R)).lock(k);var Y=o(j,"focusWindow").override("defaultColor",e.fun.constant(null)).pvMark.events("none"),Z=function(i){var n="left"===i||"top"===i?"begin":"end",a=c.anchorOpposite(i),r="linear-gradient(to "+a+", "+K+", #444 90%)",s=new q.visual.Bar(c,Y.anchor(i),{extensionId:f.id+"Grip"+e.firstUpperCase(n),normalStroke:!0,noHover:!0,noSelect:!0,noClick:!0,noDoubleClick:!0,noTooltip:!0,showsInteraction:!1}).override("defaultColor",function(e,t){return"stroke"===t?null:r
...
return s};Z(y),Z(w);var Q=P,X=M}},_getDatumsOnRect:function(t,i,n){var a,r,s=this.chart,o=s.axesPanels.x,l=s.axesPanels.y;
...
},this)}}),e.type("pvc.CartesianAbstractPanel",q.PlotPanel).init(function(e,t,i,n){function a(e){r[e.type]=e,r[e.orientedId]=e,e.v1SecondOrientedId&&(r[e.v1SecondOrientedId]=e)
...
if(i){var n=this.chart._getAxesRoundingPaddings(),a=e.clientSize,r=e.paddings;Z.names.forEach(function(e){var s=q.BasePanel.orthogonalLength[e],o=a[s],l=r[s],u=o+l;
if(!n[e+"Locked"]){var c=u*(i[e]||0),h=o*(n[e]||0);(t||(t={}))[e]=Math.max(c-h,0)
}},this)}return t},_createCore:function(){this.pvPanel.zOrder(-10);var t,i=this.chart.options.leafContentOverflow||"auto";
t="auto"===i?e.query(["ortho","base"]).select(function(e){return this.axes[e]},this).any(function(e){return null!=e.option("FixedMin")||null!=e.option("FixedMax")
}):"hidden"===i,t&&this.pvPanel.borderPanel.overflow("hidden")}}),e("pvc.visual.CategoricalPlot",q.visual.CartesianPlot.extend({methods:{createVisibleData:function(t,i){var n=this.visualRoles.series,a=n&&n.flattenedGrouping(),r=this.visualRole("category").flattenedGrouping();
...
},_reduceStackedCategoryValueExtent:function(e,t,i){return q.unionExtents(t,i)},_getBaseRole:function(){return this.visualRoles.category
...
y.each(r)}},options:{Stacked:{resolve:"_resolveFull",cast:Boolean,value:!1}}})),e.type("pvc.CategoricalAbstract",q.CartesianAbstract),e.type("pvc.CategoricalAbstractPanel",q.CartesianAbstractPanel).init(function(e,t,i,n){this.base(e,t,i,n),this.stacked=i.option("Stacked")
}),e("pvc.visual.MetricXYPlot",q.visual.CartesianPlot.extend({methods:{_initVisualRoles:function(){this.base(),this._addVisualRole("x",{isMeasure:!0,isRequired:!0,requireSingleDimension:!0,requireIsDiscrete:!1,defaultDimension:"x",dimensionDefaults:{valueType:this.chart.options.timeSeries?Date:Number}}),this._addVisualRole("y",{isMeasure:!0,isRequired:!0,requireSingleDimension:!0,requireIsDiscrete:!1,defaultDimension:"y",dimensionDefaults:{valueType:Number}})
...
},value:0},OverflowMarkersVisible:{resolve:"_resolveFull",cast:Boolean,value:!0},ValuesAnchor:{value:"center"},ValuesNormalized:{resolve:"_resolveFull",cast:"boolean","default":!1}}})),e.type("pvc.BarAbstractPanel",q.CategoricalAbstractPanel).add({pvBar:null,pvBarLabel:null,pvCategoryPanel:null,pvSecondLine:null,pvSecondDot:null,_creating:function(){var e=this.plot.dataCellsByRole.color[0];
...
}}),n.pvBarPanel=new q.visual.Panel(n,n.pvPanel,{panelType:t.Layout.Band,extensionId:"panel"}).lock("layers",f.childNodes).lockMark("values",function(e){return e.childNodes
...
var D=4>=e||2>k,R=this.pvBar=new q.visual.Bar(n,n.pvBarPanel.item,{extensionId:"bar",freePosition:!0,wrapper:M}).lockDimensions().optional("visible",function(e){return null!=e.getValue()
}).pvMark.antialias(function(e){if(D)return!0;var t=g(e),i=null==t?0:Math.abs(t-p);
return 1e-8>i});r.option("OverflowMarkersVisible")&&this._addOverflowMarkers(M);var I=q.visual.ValueLabel.maybeCreate(n,R,{wrapper:M});
if(I){var T;I.hideOrTrimOverflowed&&(T=w,!s&&i>1&&(T/=i)),n.pvBarLabel=I.override("calcTextFitInfo",function(e,i){var n=this.pvMark,a=n.textMargin();
...
if(o)if(l){if(h=w||y===_,!h)return;C|=w&&"middle"!==_?b+a>p/2:b+2*a>p}else C|=b>p,d="center"===S,h=w,h||d||(h=s>=1e-6?"left"===S?"top"===y:"bottom"===y:"left"===S?"bottom"===y:"top"===y),h?(c=!w||d?p-2*a:(p-a)/2,C|=("middle"===_?b>g:b>g/2)||this.hideOverflowed&&x>c):C|=b>=Math.max(g,T);
else C|=b>p,h=w||y===S,h?(c=w&&"center"!==S?(p-a)/2:p-2*a,C|=("middle"===_?b>g:b>g/2)||this.hideOverflowed&&x>c):C|=b>=Math.max(g,T);
...
if(t){var i=Object.create(t);i.percent=e.vars.value.percent,t=i}return t},_addOverflowMarkers:function(e){var t=this.axes.ortho;
null!=t.option("FixedMax")&&(this.pvOverflowMarker=this._addOverflowMarker(!1,t.scale,e)),null!=t.option("FixedMin")&&(this.pvUnderflowMarker=this._addOverflowMarker(!0,t.scale,e))
},_addOverflowMarker:function(e,t,i){var n,a=this.isOrientationVertical(),r=a?"bottom":"left",s=this.anchorOpposite(r),o=this.anchorOrthoLength(r),l=this.anchorLength(r),u=this.plot.option("BarOrthoSizeMin")/2,c=this._layoutInfo.paddings,h=e?t.min-c[r]:t.max+c[s];
return n=e?a?0:Math.PI/2:a?Math.PI:-Math.PI/2,new q.visual.Dot(this,this.pvBar.anchor("center"),{noSelect:!0,noHover:!0,noClick:!0,noDoubleClick:!0,noTooltip:!0,freePosition:!0,extensionId:e?"underflowMarker":"overflowMarker",wrapper:i}).intercept("visible",function(t){var i=this.delegateExtension();
if(void 0!==i&&!i)return!1;var n=t.vars.value.value;if(null==n)return!1;var a=this.pvMark.scene.target[this.pvMark.index],s=a[r]+(e?0:a[o]),l=e?h-s:s-h;
return l>0&&(0!==n||l>u)}).lock(s,null).lock("shapeSize").pvMark.shape("triangle").shapeRadius(function(){return Math.min(Math.sqrt(10),this.scene.target[this.index][l]/2)
}).shapeAngle(n).lineWidth(1.5).strokeStyle("red").fillStyle("white")[r](function(){return h+(e?1:-1)*(this.shapeRadius()+2)
})},renderInteractive:function(){this.pvPanel.render()},_buildScene:function(e,t,i){function n(t){var n=new q.visual.Scene(a,{source:t}),r=t.key;
n.vars.series=tt.fromComplex(t),o.onNewScene(n,!1),i.forEach(function(t){var i=e.child(t.key),a=i&&i.child(r),l=new q.visual.Scene(n,{source:a}),u=l.vars.category=tt.fromComplex(i);
u.group=i,s.onNewScene(l,!0),o.onNewScene(l,!0)})}var a=new q.visual.Scene(null,{panel:this,source:e}),r=this.visualRoles,s=new q.visual.RoleVarHelper(a,"value",r.value,{hasPercentSubVar:this.stacked}),o=new q.visual.RoleVarHelper(a,"color",r.color);
return t.forEach(n),a}}),t.PieSlice=function(){t.Wedge.call(this)},t.PieSlice.prototype=t.extend(t.Wedge).property("offsetRadius");
var ft=t.Shape.normalizeAngle;return t.PieSlice.prototype.midAngle=function(){var e=this.instance();
return ft(e.startAngle)+ft(e.angle)/2},t.PieSlice.prototype.defaults=(new t.PieSlice).extend(t.Wedge.prototype.defaults).offsetRadius(0),e("pvc.visual.PieSlice",q.visual.Sign.extend({init:function(i,n,a){var r=n.add(t.PieSlice);
...
},baseOffsetRadius:function(e){var t=this.base(e)||0;return this._resolvePctRadius(Y.parse(t))
},interactiveOffsetRadius:function(e,t){return t+(this.mayShowActive(e,!0)?this._activeOffsetRadius:0)
}}})),e("pvc.visual.PiePlot",q.visual.Plot.extend({init:function(t,i){if(this.base(t,i),!(t instanceof q.PieChart))throw e.error(e.format("Plot type '{0}' can only be used from within a pie chart.",[this.type]))
...
var e=this.option("DataPart");this._addDataCell(new q.visual.DataCell(this,"category",this.index,this.visualRole("category"),e)),this._addDataCell(new q.visual.DataCell(this,"angle",this.index,this.visualRoles.value,e))
}},options:{ActiveSliceRadius:{resolve:"_resolveFull",cast:Y.parse,value:new Y(.05)},ExplodedSliceRadius:{resolve:"_resolveFull",cast:Y.parse,value:0},ExplodedSliceIndex:{resolve:"_resolveFull",cast:e.number.to,value:null},ValuesAnchor:{cast:q.parseAnchorWedge,value:"outer"},ValuesVisible:{value:!0},ValuesLabelStyle:{resolve:function(e){return this.chart.compatVersion()>1?this._resolveFull(e):(e.specify("inside"),!0)
...
}}},LinkInsetRadius:{resolve:"_resolveFull",cast:Y.parse,value:new Y(.05)},LinkOutsetRadius:{resolve:"_resolveFull",cast:Y.parse,value:new Y(.025)},LinkMargin:{resolve:"_resolveFull",cast:Y.parse,value:new Y(.025)},LinkHandleWidth:{resolve:"_resolveFull",cast:e.number.to,value:.5},LinkLabelSize:{resolve:"_resolveFull",cast:Y.parse,value:new Y(.15)},LinkLabelSpacingMin:{resolve:"_resolveFull",cast:e.number.to,value:.5}}})),q.visual.Plot.registerClass(q.visual.PiePlot),e.type("pvc.PiePanel",q.PlotPanel).init(function(e,t,i,n){var a=i.option("ValuesLabelStyle");
...
if(t){var i=Object.create(t);i.percent=e.vars.value.percent,t=i}return t},_calcLayout:function(i){function n(t){return e.between(Y.resolve(t,o),0,o)
}function a(t){return e.between(Y.resolve(t,s),0,s)}var r=i.clientSize,s=r.width,o=Math.min(s,r.height)/2;
if(!o)return new Q(0,0);var l=t.vector(r.width/2,r.height/2),u=this._getConstantExtension("label","font");
...
var k=w+C,P=c-k;return 0>P?new Q(0,0):(i.resolvePctRadius=n,i.center=l,i.clientRadius=o,i.normalRadius=P,i.explodedOffsetRadius=w,i.activeOffsetRadius=C,i.maxOffsetRadius=k,i.labelFont=u,void 0)
...
}}),this.pvPie=new q.visual.PieSlice(this,this.pvPanel,{extensionId:u,center:o,activeOffsetRadius:i.activeOffsetRadius,maxOffsetRadius:i.maxOffsetRadius,resolvePctRadius:i.resolvePctRadius,wrapper:n,tooltipArgs:{options:{useCorners:!0,gravity:function(){var e=this.midAngle(),t=Math.cos(e)>=0,i=Math.sin(e)>=0;
...
}).optionalMark("outerRadius",function(){return r.animate(0,l)}).localProperty("innerRadiusEx",Y.parse).intercept("innerRadius",function(){var e=this.delegateExtension();
if(null==e){var t=this.pvMark.innerRadiusEx();e=null!=t?Y.resolve(t,this.pvMark.outerRadius())||0:0
}return e>0?r.animate(0,e):0}).pvMark,this.valuesVisible){if(this.valuesFont=i.labelFont,"inside"===this.labelStyle)this.pvPieLabel=q.visual.ValueLabel.maybeCreate(this,this.pvPie,{wrapper:n}).override("defaultText",function(e){return e.vars.value.sliceLabel
}).override("calcTextFitInfo",function(e,i){var n=this.pvMark,r=n.textMargin();if(!(-1e-6>r)){var s=n.textBaseline();
if("middle"===s){var o=q.normAngle(a.pvPie.midAngle()),l=q.normAngle(n.textAngle()),u=Math.abs(o-l)<1e-6,c=!1;
...
}).lock("left",function(e){return e.x}),this.pvPieLabel=new q.visual.Label(this,this.pvLinkPanel,{extensionId:"label",noClick:h,noDoubleClick:h,noSelect:h,noHover:h,showsInteraction:d}).lockMark("data",function(e){return e.lineScenes
...
},_buildScene:function(){var e=new q.visual.PieRootScene(this);return this.sum=e.vars.sumAbs.value,e
}}),q.PlotPanel.registerClass(q.PiePanel),e.type("pvc.visual.PieRootScene",q.visual.Scene).init(function(t){function i(e,t){if(t){var i=t._datums;
if(1===i.length)return i[0].atoms[s].label}return o.format(e)}var n=t.axes.category,a=n.domainData();
this.base(null,{panel:t,source:a});var r=new q.visual.RoleVarHelper(this,"color",t.visualRoles.color),s=t.visualRoles[t.valueRoleName].lastDimensionName(),o=a.dimensions(s),l=t.chart.options.percentValueFormat,u=t.axes.angle.scale,c=u.isNull?0:u.domain()[1],h=this;
this.vars.sumAbs=new tt(c,i(c));var d=e.type(q.visual.PieCategoryScene).init(function(e,t){this.base(h,{source:e}),this.vars.category=tt.fromComplex(e);
var n=new tt(t,i(t,e));n.angle=u(t);var a=Math.abs(t)/c;n.percent=new tt(a,l(a)),this.vars.value=n,n.sliceLabel=this.sliceLabel(),r.onNewScene(this,!0)
...
},labelBottom:function(){return this.targetY+this.labelHeight/2}}),e.type("pvc.visual.PieCategoryScene",q.visual.Scene).add({sliceLabelMask:function(){return this.panel().valuesMask
},sliceLabel:function(){return this.format(this.sliceLabelMask())},layoutI:function(t,i){var n=this.vars.value,a=i+n.angle,r=(i+a)/2,s=this.vars.link=new q.visual.PieLinkLabelVar,o=t.link,l=q.text.justify(n.sliceLabel,o.maxTextWidth,t.labelFont),u=l.length;
...
return new q.visual.PieLinkLineScene(this,g,m),new q.visual.PieLinkLineScene(this,b,m),s.elbowY=m,s.targetY=m+0,s.targetX=x,s.dir=f,a
},layoutII:function(e){var t=this.vars.link,i=t.targetY,n=t.targetX,a=e.link.handleWidth;
a>0&&new q.visual.PieLinkLineScene(this,n-t.dir*a,i),new q.visual.PieLinkLineScene(this,n,i),t.labelX=n,t.labelY=i-t.labelHeight/2
}}),e.type("pvc.visual.PieLinkLineScene",q.visual.Scene).init(function(e,t,i,n){this.base(e,{source:e.group,index:n}),this.x=t,this.y=i
}).add(t.Vector),e.type("pvc.PieChart",q.BaseChart).add({_axisClassByType:{category:q.visual.Axis,angle:q.visual.NormalizedAxis},_axisCreateChartLevel:{category:2,angle:2},_axisSetScaleChartLevel:{category:2,angle:2},_axisCreationOrder:function(){var e=q.BaseChart.prototype._axisCreationOrder.slice();
return e.push("category","angle"),e}(),_createPlotsInternal:function(){this._addPlot(new q.visual.PiePlot(this))
...
a=e.between(a,.1,1),i.paddings=(100*(1-a)/2).toFixed(2)+"%"}else null==i.paddings&&(i.paddings=new Y(.025));
i.scenes=e.getPath(this.options,"pie.scenes"),this.base(t,i)}}),e("pvc.visual.BarPlot",q.visual.BarPlotAbstract.extend({methods:{type:"bar"}})),q.visual.Plot.registerClass(q.visual.BarPlot),e.type("pvc.BarPanel",q.BarAbstractPanel).add({plotType:"bar",_ibits:-1}),q.PlotPanel.registerClass(q.BarPanel),e.type("pvc.BarChart",q.BarAbstract).add({_allowV1SecondAxis:!0,_createPlotsInternal:function(){this._createMainPlot(),this.options.plot2&&this._addPlot(new q.visual.PointPlot(this,{name:"plot2",defaults:{DataPart:"1",ColorAxis:2,LinesVisible:!0,DotsVisible:!0}}))
},_createMainPlot:function(){this._addPlot(new q.visual.BarPlot(this))},_createPlotTrend:function(){this._addPlot(new q.visual.PointPlot(this,{name:"trend",spec:{visualRoles:{color:{from:"series"}}},fixed:{TrendType:"none",NullInterpolatioMode:"none"},defaults:{DataPart:"trend",ColorAxis:2,LinesVisible:!0,DotsVisible:!1}}))
...
}}),e.type("pvc.NormalizedBarChart",q.BarChart).add({_createMainPlot:function(){this._addPlot(new q.visual.BarPlot(this,{fixed:{ValuesNormalized:!0,Stacked:!0}}))
}}),q.parseWaterDirection=function(t){if(t){switch(t=(""+t).toLowerCase()){case"up":case"down":return t
}e.debug>=2&&e.log("[Warning] Invalid 'WaterDirection' value: '"+t+"'.")}},e("pvc.visual.WaterfallPlot",q.visual.BarPlotAbstract.extend({init:function(e,t){this.base(e,t),e._registerInitLegendScenes(this._initLegendScenes.bind(this))
},methods:{type:"water",_waterColor:t.color("#1f77b4").darker(),_initEnd:function(){var e=q.makeExtensionAbsId("line",this.extensionPrefixes),i=this.chart._getConstantExtension(e,"strokeStyle");
...
return e.traversalModes=q.visual.TraversalMode[t],e.rootLabel=this.option("AllCategoryLabel"),e
...
},_initLegendScenes:function(t){var i=t._getLegendRootScene();new q.visual.legend.WaterfallLegendGroupScene(i,this,{extensionPrefix:e.indexedId("",1),label:this.option("TotalLineLabel"),color:this._waterColor})
...
}},cast:Boolean},Direction:{resolve:"_resolveFull",cast:q.parseWaterDirection,value:"down"},AreasVisible:{resolve:"_resolveFull",cast:Boolean,value:!0},AllCategoryLabel:{resolve:"_resolveFull",cast:String,value:"All"}}})),q.visual.Plot.registerClass(q.visual.WaterfallPlot),e.type("pvc.visual.legend.WaterfallLegendGroupScene",q.visual.legend.LegendGroupScene).init(function(t,i,n){n=e.set(n,"clickMode","none"),this.base(t,n),this.plot=i,this.createItem(n)
}).add({itemSceneType:function(){return q.visual.legend.WaterfallLegendItemScene}}),e.type("pvc.visual.legend.WaterfallLegendItemScene",q.visual.legend.LegendItemScene).init(function(t,i){this.base.apply(this,arguments);
var n=q.visual.Interactive;this._ibits=n.Interactive|n.ShowsInteraction,this.color=e.get(i,"color"),this.vars.value=new tt(null,e.get(i,"label"))
}),e.type("pvc.WaterfallPanel",q.BarAbstractPanel).init(function(e,t,i,n){this.base(e,t,i,n),e.wfChartPanel||(e.wfChartPanel=this)
...
this.pvWaterfallGroupPanel=new q.visual.Panel(this,this.pvPanel,{extensionId:"group"}).lock("data",S.childNodes).pvMark.zOrder(-1).fillStyle(function(){return _(0).alpha(.15)
...
return"fill"!==i||e.vars.category.group._isFlattenGroup?n:t.color(n).alpha(.5)}),this.pvWaterfallLine=new q.visual.Rule(this,this.pvPanel,{extensionId:"line",noTooltip:!1,noHover:!1,noSelect:!1,noClick:!1,noDoubleClick:!1}).lock("data",c.childNodes).optional("visible",function(e){return x&&!!e.previousSibling||!x&&!!e.nextSibling
}).optional(a,function(e){return d+i.animate(0,f(e)-d)}).optional(this.anchorLength(a),b+m).optional(r,x?function(e){return v(e)-b-g
}:function(e){return v(e)-g}).override("defaultColor",e.fun.constant(y)).pvMark.antialias(!0).lineCap("butt"),this.plot.option("TotalValuesVisible")&&(this.pvWaterfallLabel=new q.visual.Label(this,this.pvWaterfallLine,{extensionId:"lineLabel"}).intercept("visible",function(e){return!e.vars.category.group._isFlattenGroup&&(x||!!e.nextSibling)
...
}))},_buildRuleScene:function(t){function i(e){var t=e.group,i=new q.visual.Scene(o,{source:t}),n=i.vars.category=tt.fromComplex(t),a=e.offset;
n.group=t,i.vars.value=new tt(a,s.format(a))}function n(e,t){var i=e.vars.value.value;
e.vars.direction=t&&a!==i?r===i>a?"up":"down":null,a=i}var a,r,s,o=new q.visual.Scene(null,{panel:this,source:this.visibleData({ignoreNulls:!1})});
...
});if(a.next()){t&&n(e,t),t++;do i(a.item,t);while(a.next())}}function n(e,t){var i=new q.visual.Scene(c,{source:e}),n=i.vars.category=tt.fromComplex(e);
...
return i?r(i):e}var s,o,l=this.chart,u=this.visualRoles.category.select(l.partData(this.dataPartValue),{visible:!0}),c=new q.visual.Scene(null,{panel:this,source:u});
return t&&(s=e.query(t).object({name:function(e){return e.group.absKey}}),o=this.plot.isFalling(),i(u,0)),c
}}),q.PlotPanel.registerClass(q.WaterfallPanel),e.type("pvc.WaterfallChart",q.BarAbstract).add({_processOptionsCore:function(e){e.baseAxisComposite=!1,this.base(e)
},_createPlotsInternal:function(){this._addPlot(new q.visual.WaterfallPlot(this))
}}),e("pvc.visual.PointPlot",q.visual.CategoricalPlot.extend({methods:{type:"point",_initVisualRoles:function(){this.base(),this._addVisualRole("value",{isMeasure:!0,isRequired:!0,isPercent:this.option("Stacked"),requireSingleDimension:!0,requireIsDiscrete:!1,valueType:Number,defaultDimension:"value"})
}},options:{DotsVisible:{resolve:"_resolveFull",data:E("Dots",!0),cast:Boolean,value:!1},LinesVisible:{resolve:"_resolveFull",data:E("Lines",!0),cast:Boolean,value:!1},AreasVisible:{resolve:"_resolveFull",data:E("Areas",!1),cast:Boolean,value:!1},ValuesAnchor:{value:"right"}}})),q.visual.Plot.registerClass(q.visual.PointPlot),e.type("pvc.PointPanel",q.CategoricalAbstractPanel).init(function(e,t,i,n){this.base(e,t,i,n),this.linesVisible=i.option("LinesVisible"),this.dotsVisible=i.option("DotsVisible"),this.areasVisible=i.option("AreasVisible"),this.linesVisible||this.dotsVisible||this.areasVisible||(this.linesVisible=!0,i.option.specify({LinesVisible:!0})),e.scatterChartPanel||(e.scatterChartPanel=this)
...
if(!i.legendSymbolRenderer()&&i.legendVisible()){var n=this.axes.color,a=e.nullyTo(n.option("LegendDrawMarker",!0),this.dotsVisible||this.areasVisible),r=!a||e.nullyTo(n.option("LegendDrawLine",!0),this.linesVisible&&!this.areasVisible),s=q.uniqueExtensionAbsPrefix(),o={drawMarker:a,drawLine:r,extensionPrefix:{abs:s}};
if(this.chart._processExtensionPointsIn(i.role.legend(),s),a){var l=n.option("LegendShape",!0);
o.markerPvProto=new t.Dot,this.dotsVisible&&(l||(l="circle"),o.markerPvProto.lineWidth(1.5,q.extensionTag).shapeSize(12,q.extensionTag)),o.markerShape=l,this._applyV1BarSecondExtensions&&this.chart.extend(o.markerPvProto,"barSecondDot",{constOnly:!0}),this.extend(o.markerPvProto,"dot",{constOnly:!0})
}r&&(o.rulePvProto=(new t.Rule).lineWidth(1.5,q.extensionTag),this._applyV1BarSecondExtensions&&this.chart.extend(o.rulePvProto,"barSecondLine",{constOnly:!0}),this.extend(o.rulePvProto,"line",{constOnly:!0})),i.legendSymbolRenderer(o)
...
this.pvPanel.zOrder(o?-7:1),this.pvScatterPanel=new q.visual.Panel(this,this.pvPanel,{extensionId:"panel"}).lock("data",v.childNodes).pvMark;
var p=o&&l&&!r?.5:null;this.compatVersion()<=1&&(i=r?function(e){return function(t){return e.call(this,t.vars.value.rawValue)
...
},b=d&&r?m:g,x=a.selectableByFocusWindow();this.pvArea=new q.visual.Area(this,this.pvScatterPanel,{extensionId:"area",noTooltip:!1,wrapper:i,noSelect:x,noRubberSelect:!0,showsSelection:!x}).lockMark("data",function(e){return e.childNodes
...
}).override("baseColor",function(e,t){var i=this.base(e,t);return!this._finished&&i&&null!=p?i.alpha(p):i
}).override("dimColor",function(e,t){return r?q.toGrayScale(e,1,null,null).brighter():this.base(e,t)
}).lock("events",o?"painted":"none").pvMark;var y=s&&!l&&!o,_=r&&o,S=["line"];this._applyV1BarSecondExtensions&&S.push({abs:"barSecondLine"});
var w=y?!1:d&&r&&o?m:g,C=o&&!l;this.pvLine=new q.visual.Line(this,this.pvArea.anchor(this.anchorOpposite(u)),{extensionId:S,freePosition:!0,wrapper:i,noTooltip:C,noDoubleClick:C,noClick:C,noHover:C,noSelect:C||x,showsSelection:!x}).lockMark("visible",w).override("defaultColor",function(e,t){var i=this.base(e,t);
...
S=["dot"],this._applyV1BarSecondExtensions&&S.push({abs:"barSecondDot"}),this.pvDot=new q.visual.Dot(this,this.pvLine,{extensionId:S,freePosition:!0,wrapper:i,tooltipArgs:{options:{ignoreRadius:l}}}).intercept("visible",function(e){return!e.isNull&&!e.isIntermediate&&this.delegateExtension(!0)
}).override("color",function(e,i){if(!s){var n=e.isActive||!k&&e.isSingle||k&&e.isAlone;
if(!n)return q.invisibleFill}var a=this.base(e,i);return e.isInterpolated&&"fill"===i?a&&t.color(a).brighter(.5):a
}).override("defaultColor",function(e,t){var i=this.base(e,t);return!this._finished&&_&&i?i.darker(.6):i
}).override("baseSize",function(t){if(!s){var i=t.isActive||!k&&t.isSingle||k&&t.isAlone;
if(i&&!t.isActive){var a=Math.max(n.pvLine.lineWidth(),.2)/2;return e.sqr(a)}}var r=this.base(t);
return t.isInterpolated?.8*r:r}).pvMark;var P=q.visual.ValueLabel.maybeCreate(this,this.pvDot,{wrapper:i});
P&&(this.pvLabel=P.pvMark)},renderInteractive:function(){this.pvScatterPanel.render()
},_buildScene:function(t,i,n){function a(e){for(var t,i=[],n=e.childNodes,a=0,o=null,l=0,u=0,c=n.length;c>l;l++,u++){var d=n[u],f=2*l;
...
}var S=new q.visual.Scene(e,{index:a,source:i.source});S.dataIndex=i.dataIndex,S.vars.category=i.vars.category;
var w=new tt(s,p.format(s),s);return w.accValue=o,S.vars.value=w,S.ownerScene=i,S.isInterpolated=i.isInterpolated,S.isIntermediate=!0,S.isSingle=!1,S.isNull=u,S.isAlone=u&&i.isNull&&t.isNull,S.basePosition=l,S.orthoPosition=x,S.orthoLength=m(o)-x,f.onNewScene(S,!0),S
}var o=new q.visual.Scene(null,{panel:this,source:t}),l=this.chart,u=this.visualRoles.series,c=this.visualRoles.value,h=this.stacked,d=new q.visual.RoleVarHelper(o,"value",c,{hasPercentSubVar:h}),f=new q.visual.RoleVarHelper(o,"color",this.visualRoles.color),v=c.lastDimensionName(),p=t.owner.dimensions(v),g=u.isBound()?u.flatten(this.partData(),{visible:!0,isNull:l.options.ignoreNulls?!1:null}):null,m=this.axes.ortho.scale,b=e.scope(function(){var e=m.domain(),t=e[0],i=e[1];
return t*i>=0?t>=0?t:i:0}),x=m(b),y=this.axes.base.sceneScale({sceneVarName:"category"});
(g?g.children():e.query([null])).each(function(n){var a=new q.visual.Scene(o,{source:n||t});
a.vars.series=tt.fromComplex(n),f.onNewScene(a,!1),i.forEach(function(i,r){var s=t.child(i.key),o=s;
o&&n&&(o=o.child(n.key));var l=new q.visual.Scene(a,{source:o});l.dataIndex=r,l.vars.category=tt.fromComplex(s),d.onNewScene(l,!0);
...
}}),q.PlotPanel.registerClass(q.PointPanel),e.type("pvc.PointAbstract",q.CategoricalAbstract).add({_defaultAxisBandSizeRatio:1,_createPlotsInternal:function(){this._addPlot(this._createPointPlot()),this.options.plot2&&this._addPlot(new q.visual.PointPlot(this,{name:"plot2",defaults:{DataPart:"1",ColorAxis:2,LinesVisible:!0,DotsVisible:!0}}))
},_createPlotTrend:function(){this._addPlot(new q.visual.PointPlot(this,{name:"trend",spec:{visualRoles:{color:{from:"series"}}},fixed:{TrendType:"none",NullInterpolatioMode:"none"},defaults:{DataPart:"trend",ColorAxis:2,LinesVisible:!0,DotsVisible:!1}}))
...
}),this.base()},defaults:{tooltipOffset:10}}),e.type("pvc.DotChart",q.PointAbstract).add({_createPointPlot:function(){return new q.visual.PointPlot(this,{fixed:{DotsVisible:!0}})
}}),e.type("pvc.LineChart",q.PointAbstract).add({_createPointPlot:function(){return new q.visual.PointPlot(this,{fixed:{LinesVisible:!0}})
}}),e.type("pvc.AreaChart",q.PointAbstract).add({_createPointPlot:function(){return new q.visual.PointPlot(this,{fixed:{AreasVisible:!0}})
}}),q.mStackedLineChart=e.type("pvc.StackedLineChart",q.PointAbstract).add({_createPointPlot:function(){return new q.visual.PointPlot(this,{fixed:{LinesVisible:!0,Stacked:!0}})
}}),e.type("pvc.StackedDotChart",q.PointAbstract).add({_createPointPlot:function(){return new q.visual.PointPlot(this,{fixed:{DotsVisible:!0,Stacked:!0}})
}}),q.mStackedAreaChart=e.type("pvc.StackedAreaChart",q.PointAbstract).add({_createPointPlot:function(){return new q.visual.PointPlot(this,{fixed:{AreasVisible:!0,Stacked:!0},defaults:{LinesVisible:!0}})
}}),e("pvc.visual.MetricPointPlot",q.visual.MetricXYPlot.extend({methods:{type:"scatter",_initVisualRoles:function(){this.base(),this._addVisualRole("size",{isMeasure:!0,requireSingleDimension:!0,requireIsDiscrete:!1,defaultDimension:"size",dimensionDefaults:{valueType:Number}})
...
},_initDataCells:function(){this.base(),this.option("DotsVisible")&&this._addDataCell(new q.visual.DataCell(this,"size",this.option("SizeAxis")-1,this.visualRoles.size,this.option("DataPart")))
}},options:{SizeRole:{resolve:"_resolveFixed",value:"size"},SizeAxis:{resolve:"_resolveFixed",value:1},Shape:{resolve:"_resolveFull",cast:q.parseShape,value:"circle"},NullShape:{resolve:"_resolveFull",cast:q.parseShape,value:"cross"},DotsVisible:{resolve:"_resolveFull",data:F("Dots"),cast:Boolean,value:!1},LinesVisible:{resolve:"_resolveFull",data:F("Lines"),cast:Boolean,value:!1},ValuesAnchor:{value:"right"},ValuesMask:{value:"{x},{y}"},AutoPaddingByDotSize:{resolve:"_resolveFull",cast:Boolean,value:!0}}})),q.visual.Plot.registerClass(q.visual.MetricPointPlot),q.parseMetricPointSizeAxisRatioTo=q.makeEnumParser("ratioTo",["minWidthHeight","height","width"],"minWidthHeight"),e("pvc.visual.MetricPointSizeAxis",q.visual.SizeAxis.extend({options:{Ratio:{resolve:"_resolveFull",cast:e.number.toNonNegative,value:.2},RatioTo:{resolve:"_resolveFull",cast:q.parseMetricPointSizeAxisRatioTo,value:"minwidthheight"}}})),e.type("pvc.MetricPointPanel",q.CartesianAbstractPanel).init(function(e,t,i,n){this.base(e,t,i,n);
...
if(a||r){var s=q.uniqueExtensionAbsPrefix(),o={drawMarker:a,drawLine:r,extensionPrefix:{abs:s}};
this.chart._processExtensionPointsIn(i.role.legend(),s),a&&(o.markerShape=n.option("LegendShape",!0)||"circle",o.markerPvProto=(new t.Dot).lineWidth(1.5,q.extensionTag).shapeSize(12,q.extensionTag),this.extend(o.markerPvProto,"dot",{constOnly:!0})),r&&(o.rulePvProto=(new t.Rule).lineWidth(1.5,q.extensionTag),this.extend(o.rulePvProto,"line",{constOnly:!0})),i.legendSymbolRenderer(o)
...
}n={};var p,g=this.chart._axisOffsetPaddings;g&&(p={},Z.names.forEach(function(e){var t=q.BasePanel.orthogonalLength[e];
...
this._finalizeScene(n),t.pvPanel.zOrder(1),this.pvScatterPanel=new q.visual.Panel(t,t.pvPanel,{extensionId:"panel"}).lock("data",n.childNodes).pvMark;
var s=i.selectableByFocusWindow(),o=n.isColorBound&&this.visualRoles.color.isDiscrete(),l=new q.visual.Line(t,t.pvScatterPanel,{extensionId:"line",wrapper:a,noTooltip:!1,noSelect:s,showsSelection:!s}).lockMark("data",function(e){return e.childNodes
...
});t.pvLine=l.pvMark;var u=new q.visual.DotSizeColor(t,t.pvLine,{extensionId:"dot",wrapper:a,activeSeriesAware:t.linesVisible,tooltipArgs:{options:{ignoreRadius:n.isSizeBound?!1:t.linesVisible}}}).override("x",function(e){return e.basePosition
}).override("y",function(e){return e.orthoPosition}).override("color",function(e,i){return t.dotsVisible||e.isActive||e.isSingle?this.base(e,i):q.invisibleFill
});if(n.isSizeBound?t.autoPaddingByDotSize&&"minwidthheight"===t.sizeAxisRatioTo||t.pvPanel.borderPanel.overflow("hidden"):u.override("baseSize",function(i){if(!t.dotsVisible&&i.isSingle){var n=Math.max(t.pvLine.scene[this.pvMark.index].lineWidth,.2)/2;
return e.sqr(n)}return this.base(i)}),t.pvDot=u.pvMark,t.pvDot.rubberBandSelectionMode="center",q.visual.ValueLabel.isNeeded(t)){var c=["label"];
r&&c.push("lineLabel");var h=q.visual.ValueLabel.maybeCreate(t,t.pvDot,{extensionId:c,wrapper:a});
...
},_buildScene:function(){function e(e){var t=new q.visual.Scene(a,{source:e});t.vars.series=tt.fromComplex(e),s.onNewScene(t,!1),e.datums().each(function(e,i){var n=e.atoms[l.name];
if(null!=n.value){var a=e.atoms[u.name];if(null!=a.value){var r=new q.visual.Scene(t,{source:e});
r.dataIndex=i,r.vars.x=tt.fromAtom(n),r.vars.y=tt.fromAtom(a),o.onNewScene(r,!0),s.onNewScene(r,!0),r.isIntermediate=!1
}}})}function t(e){for(var t,n=e.childNodes,a=0,r=0,s=n.length;s>a;a++,r++){var o=n[r];
if(o.isSingle=!t&&!o.nextSibling,t){var l=i(e,t,o,r);l&&r++}t=o}}function i(e,t,i,n){var a=+i.vars.y.value,r=+t.vars.y.value,c=+i.vars.x.value,h=+t.vars.x.value,d=u.type.cast.call(null,(a+r)/2),f=l.type.cast.call(null,(c+h)/2),v=new q.visual.Scene(e,{index:n,source:i.datum});
return v.dataIndex=i.dataIndex,v.vars.x=new tt(f,l.format(f),f),v.vars.y=new tt(d,u.format(d),d),o.onNewScene(v,!0),s.onNewScene(v,!0),v.ownerScene=i,v.isIntermediate=!0,v.isSingle=!1,v
}var n=this.visibleData({ignoreNulls:!1}),a=new q.visual.Scene(null,{panel:this,source:n}),r=this.visualRoles,s=new q.visual.RoleVarHelper(a,"color",r.color),o=new q.visual.RoleVarHelper(a,"size",r.size),l=n.owner.dimensions(r.x.lastDimensionName()),u=n.owner.dimensions(r.y.lastDimensionName());
...
}),e}}),q.PlotPanel.registerClass(q.MetricPointPanel),e.type("pvc.MetricPointAbstract",q.MetricXYAbstract).add({_axisClassByType:{size:q.visual.MetricPointSizeAxis},_createPlotsInternal:function(){this._addPlot(this._createPointPlot())
},_createPointPlot:function(){},_createPlotTrend:function(){this._addPlot(new q.visual.MetricPointPlot(this,{name:"trend",spec:{visualRoles:{color:{from:"series"},size:null}},fixed:{TrendType:"none",NullInterpolatioMode:"none",SizeRole:null,SizeAxis:null,OrthoAxis:1},defaults:{DataPart:"trend",ColorAxis:2,LinesVisible:!0,DotsVisible:!1}}))
...
}})},_calcAxesOffsetPaddings:function(){var e=this.base();return e||new Z(.01)},defaults:{axisOriginIsZero:!1,tooltipOffset:10}}),e.type("pvc.MetricDotChart",q.MetricPointAbstract).add({_createPointPlot:function(){return new q.visual.MetricPointPlot(this,{fixed:{DotsVisible:!0}})
}}),e.type("pvc.MetricLineChart",q.MetricPointAbstract).add({_createPointPlot:function(){return new q.visual.MetricPointPlot(this,{fixed:{LinesVisible:!0}})
}}),e("pvc.visual.HeatGridPlot",q.visual.CategoricalPlot.extend({methods:{type:"heatGrid",interpolatable:function(){return!1
...
},_initDataCells:function(){this.base(),this.option("UseShapes")&&this._addDataCell(new q.visual.DataCell(this,"size",this.option("SizeAxis")-1,this.visualRoles.size,this.option("DataPart")))
},_getOrthoRoles:function(){return[this.visualRole("series")]}},options:{SizeRole:{value:"size"},SizeAxis:{value:1},UseShapes:{resolve:"_resolveFull",cast:Boolean,value:!1},Shape:{resolve:"_resolveFull",cast:q.parseShape,value:"square"},NullShape:{resolve:"_resolveFull",cast:q.parseShape,value:"cross"},ValuesVisible:{getDefault:function(){return!this.option("UseShapes")
},value:null},ValuesMask:{value:null},ValuesAnchor:{value:"center"},OrthoAxis:{resolve:null},NullInterpolationMode:{resolve:null,value:"none"},Stacked:{resolve:null,value:!1}}})),q.visual.Plot.registerClass(q.visual.HeatGridPlot),e.type("pvc.HeatGridPanel",q.CategoricalAbstractPanel).init(function(e,t,i,n){this.base(e,t,i,n),this.axes.size=e._getAxis("size",i.option("SizeAxis")-1);
...
t.base();var i=t._calcCellSize(),n=t.isOrientationVertical()?"bottom":"left",a=q.BasePanel.relativeAnchor[n],r=q.BasePanel.parallelLength[n],s=q.BasePanel.orthogonalLength[n],o=t.visualRoles.series.flatten(t.partData(),{visible:!0,isNull:t.chart.options.ignoreNulls?!1:null}),l=t._buildScene(t.visibleData({ignoreNulls:!1}),o,i),u=l.isColorBound,c=l.isSizeBound,h=t._buildSignsWrapper(l),d=t.compatVersion()<=1,f=this.axes.base.scale,v=this.axes.ortho.scale,p=f.range().band,g=v.range().band,m=p/2,b=g/2,x=new q.visual.Panel(t,t.pvPanel).pvMark.data(l.childNodes)[n](function(e){return v(e.vars.series.value)-b
...
}t.pvHeatGrid=new q.visual.Panel(t,x,_).pvMark.lock("data",function(e){return e.childNodes
...
var w=q.visual.ValueLabel.maybeCreate(t,t.pvHeatGrid,{wrapper:h});w&&(t.pvHeatGridLabel=w.pvMark,t.useShapes&&w.override("getAnchoredToMark",e.fun.constant(t.shapes)))
...
var o={extensionId:"dot",freePosition:!0,activeSeriesAware:!1,wrapper:i,tooltipArgs:r._buildShapesTooltipArgs(n,a)},l=new q.visual.DotSizeColor(r,r.pvHeatGrid,o).override("dimColor",function(e){return q.toGrayScale(e,.6)
...
return r.call(a,n,s,l)}}}},renderInteractive:function(){this.pvPanel.render()},_buildScene:function(e,t,i){function n(e){var t=new q.visual.Scene(s,{source:e});
t.vars.series=tt.fromComplex(e),o.forEach(function(i){a.call(r,t,i,e)})}function a(t,i,n){var a=e.child(i.key).child(n.key),r=new q.visual.Scene(t,{source:a});
r.vars.category=tt.fromComplex(i),u.onNewScene(r,!0),c.onNewScene(r,!0)}var r=this,s=new q.visual.Scene(null,{panel:r,source:e}),o=e.childNodes,l=r.visualRoles,u=new q.visual.RoleVarHelper(s,"color",l.color),c=new q.visual.RoleVarHelper(s,"size",l.size);
return s.cellSize=i,t.children().each(n),s}}),q.PlotPanel.registerClass(q.HeatGridPanel),e.type("pvc.HeatGridChart",q.CategoricalAbstract).add({_allowColorPerCategory:!0,_defaultAxisBandSizeRatio:1,_axisCreateIfUnbound:{color:!0},_processOptionsCore:function(e){this.base(e),e.legend=!1
},_createPlotsInternal:function(){this._addPlot(new q.visual.HeatGridPlot(this))},defaults:{colorValIdx:0,sizeValIdx:1,measuresIndexes:[2],axisOffset:0,plotFrameVisible:!1,colorNormByCategory:!0,numSD:2}}),q.parseBoxLayoutMode=q.makeEnumParser("layoutMode",["overlapped","grouped"],"grouped"),e("pvc.visual.BoxPlot",q.visual.CategoricalPlot.extend({methods:{type:"box",_initVisualRoles:function(){this.base();
...
},this)},_getOrthoRoles:function(){return q.visual.BoxPlot.measureRolesNames.map(this.visualRole,this)
},_getCategoryRoleSpec:function(){return e.set(this.base(),"requireIsDiscrete",!0)
}},type:{methods:{measureRolesNames:["median","lowerQuartil","upperQuartil","minimum","maximum"]}},options:{Stacked:{resolve:null,value:!1},LayoutMode:{resolve:"_resolveFull",cast:q.parseBoxLayoutMode,value:"grouped"},BoxSizeRatio:{resolve:"_resolveFull",cast:function(t){return t=e.number.to(t),null==t?1:.05>t?.05:t>1?1:t
},value:.9},BoxSizeMax:{resolve:"_resolveFull",data:{resolveV1:function(e){return this._specifyChartOption(e,"maxBoxSize"),!0
}},cast:function(t){return t=e.number.to(t),null==t?1/0:1>t?1:t},value:1/0}}})),q.visual.Plot.registerClass(q.visual.BoxPlot),e.type("pvc.BoxplotPanel",q.CategoricalAbstractPanel).init(function(e,t,i,n){this.base(e,t,i,n),this.boxSizeRatio=i.option("BoxSizeRatio"),this.boxSizeMax=i.option("BoxSizeMax"),e.bpChartPanel||(e.bpChartPanel=this)
...
})}function r(e){return n(i(e))}this.base();var s=this.visibleData({ignoreNulls:!1}),o=this.axes.base,l=o.domainItems(),u=this.visualRoles.series.flatten(this.partData(),{visible:!0,isNull:this.chart.options.ignoreNulls?!1:null}).childNodes,c=this._buildScene(s,u,l),h=this.isOrientationVertical()?"bottom":"left",d=this.anchorOrtho(h),f=this.anchorLength(h),v=this.anchorOrthoLength(h),p=new q.visual.Panel(this,this.pvPanel).lock("data",c.childNodes).pvMark,g=["panel"];
this.compatVersion()<=1&&g.push(""),this.pvBoxPanel=new q.visual.Panel(this,p,{extensionId:g}).lock("data",function(e){return e.childNodes
}).pvMark[f](function(e){return e.vars.category.boxWidth})[d](function(e){var t=e.vars.category;
return t.boxLeft+t.boxWidth/2-this[f]()/2}),this.pvBar=i(new q.visual.Bar(this,this.pvBoxPanel,{extensionId:"boxBar",freePosition:!0,normalStroke:!0})).intercept("visible",function(e){return e.vars.category.showBox&&this.delegateExtension(!0)
...
}).pvMark,this.pvRuleWhiskerUpper=a(new q.visual.Rule(this,this.pvBoxPanel,{extensionId:"boxRuleWhisker",freePosition:!0,noHover:!1,noSelect:!1,noClick:!1,noDoubleClick:!1,noTooltip:!1,showsInteraction:!0})).intercept("visible",function(e){return e.vars.category.showRuleWhiskerUpper&&this.delegateExtension(!0)
...
}),this.pvRuleWhiskerLower=a(new q.visual.Rule(this,this.pvBoxPanel,{extensionId:"boxRuleWhisker",freePosition:!0,noHover:!1,noSelect:!1,noClick:!1,noDoubleClick:!1,noTooltip:!1,showsInteraction:!0})).intercept("visible",function(e){return e.vars.category.showRuleWhiskerBelow&&this.delegateExtension(!0)
...
}),this.pvRuleMin=r(new q.visual.Rule(this,this.pvBoxPanel,{extensionId:"boxRuleMin",freePosition:!0,noHover:!1,noSelect:!1,noClick:!1,noDoubleClick:!1,noTooltip:!1,showsInteraction:!0})).intercept("visible",function(e){return null!=e.vars.minimum.value&&this.delegateExtension(!0)
}).pvMark.lock(h,function(e){return e.vars.minimum.position}),this.pvRuleMax=r(new q.visual.Rule(this,this.pvBoxPanel,{extensionId:"boxRuleMax",freePosition:!0,noHover:!1,noSelect:!1,noClick:!1,noDoubleClick:!1,noTooltip:!1,showsInteraction:!0})).intercept("visible",function(e){return null!=e.vars.maximum.value&&this.delegateExtension(!0)
}).pvMark.lock(h,function(e){return e.vars.maximum.position}),this.pvRuleMedian=r(new q.visual.Rule(this,this.pvBoxPanel,{extensionId:"boxRuleMedian",freePosition:!0,noHover:!1,noSelect:!1,noClick:!1,noDoubleClick:!1,noTooltip:!1,showsInteraction:!0})).intercept("visible",function(e){return null!=e.vars.median.value&&this.delegateExtension(!0)
}).lockMark(h,function(e){return e.vars.median.position}).override("defaultStrokeWidth",e.fun.constant(2)).pvMark
},renderInteractive:function(){this.pvBoxPanel.render()},_buildScene:function(t,i,n){function a(e,t){var i=new q.visual.Scene(h,{source:e}),a=e.key;
i.vars.series=tt.fromComplex(e),g.onNewScene(i,!1),n.forEach(function(e){r(i,a,e,t)
})}function r(i,n,a,r){var h=t.child(a.key),v=h&&h.child(n),b=new q.visual.Scene(i,{source:v}),x=b.vars,y=x.category=tt.fromComplex(h),_=d(h.value),S=_+(m?l+r*o:-s/2);
e.set(y,"group",h,"x",_,"width",f,"boxWidth",s,"boxLeft",S),u.forEach(function(e){var t,i;
if(v&&(t=e.dimName)){var n=v.dimensions(t),a=n.value(c);i=new tt(a,n.format(a)),i.position=p(a)
}else i=new tt(null,""),i.position=null;x[e.roleName]=i}),g.onNewScene(b,!0);var w,C,k=null!=x.minimum.value,P=null!=x.lowerQuartil.value,M=null!=x.median.value,D=null!=x.upperQuartil.value,R=P||D;
...
o=s+w}else o=0}else s=Math.min(f,v);return i.forEach(a),h}}),q.PlotPanel.registerClass(q.BoxplotPanel),e.type("pvc.BoxplotChart",q.CategoricalAbstract).add({_defaultAxisBandSizeRatio:1/3,_getTranslationClass:function(t){return e.type(this.base(t)).methods({_configureTypeCore:function(){this._configureTypeByPhysicalGroup("series"),this._configureTypeByPhysicalGroup("category"),q.visual.BoxPlot.measureRolesNames.forEach(function(e){this._configureTypeByPhysicalGroup("value",e,1,1)
},this)}})},_createPlotsInternal:function(){this._addPlot(new q.visual.BoxPlot(this)),this.options.plot2&&this._addPlot(new q.visual.PointPlot(this,{name:"plot2",spec:{visualRoles:{value:{from:"main.median"}}},defaults:{LinesVisible:!0,DotsVisible:!0,ColorAxis:2,OrthoAxis:1}}))
},_initAxesEnd:function(){var e=this.axesByType.ortho;e&&e.forEach(function(e){e.option.defaults({Offset:.02})
}),this.base()},defaults:{crosstabMode:!1}}),q.parseTreemapLayoutMode=q.makeEnumParser("layoutMode",["squarify","slice-and-dice","slice","dice"],"squarify"),q.parseTreemapColorMode=q.makeEnumParser("colorMode",["byParent","bySelf"],"byParent"),e("pvc.visual.TreemapPlot",q.visual.Plot.extend({init:function(t,i){if(this.base(t,i),!(t instanceof q.TreemapChart))throw e.error(e.format("Plot type '{0}' can only be used from within a treemap chart.",[this.type]))
...
},createVisibleData:function(e,t){return this.visualRoles.category.select(e,t)},_initDataCells:function(){this.base(),this._addDataCell(new q.visual.DataCell(this,"size",this.option("SizeAxis")-1,this.visualRole("size"),this.option("DataPart")))
}},options:{SizeRole:{resolve:"_resolveFixed",value:"size"},SizeAxis:{resolve:"_resolveFixed",value:1},ValuesAnchor:{cast:q.parseAnchor,value:"center"},ValuesVisible:{value:!0},ValuesMask:{resolve:"_resolveFull",value:"{category}"},ValuesOptimizeLegibility:{value:!0},LayoutMode:{resolve:"_resolveFull",cast:q.parseTreemapLayoutMode,value:"squarify"},ColorMode:{resolve:"_resolveFull",cast:q.parseTreemapColorMode,value:"byparent"},RootCategoryLabel:{resolve:"_resolveFull",cast:String,value:"All"}}})),q.visual.Plot.registerClass(q.visual.TreemapPlot),e.type("pvc.visual.TreemapDiscreteColorAxis",q.visual.ColorAxis).init(function(e,t,i,n){this.base(e,t,i,n),this.isByParent="byparent"===e.plots.treemap.option("ColorMode")
...
}:function(e){return(!e.parent||n(e))&&s(e)})}}),e.type("pvc.TreemapPanel",q.PlotPanel).init(function(e,t,i,n){this.base(e,t,i,n),this.axes.size=e._getAxis("size",(i.option("SizeAxis")||0)-1),this.layoutMode=i.option("LayoutMode")
...
}):100,c=n.pvTreemapPanel=new q.visual.Panel(n,n.pvPanel,{panelType:t.Layout.Treemap,extensionId:"panel"}).pvMark.lock("visible",!0).lock("nodes",r.nodes()).lock("left",l).lock("top",l).lock("width",a.width-o).lock("height",a.height-o).lock("size",u).lock("mode",n.layoutMode).lock("order",null).lock("round",!1);
c.node.left(function(e){return e.x+l}).top(function(e){return e.y+l}).width(function(e){return e.dx-o
}).height(function(e){return e.dy-o});var h=n.axes.color,d=n.visualRoles.color.isBound()?h.sceneScale({sceneVarName:"color"}):e.fun.constant(h.option("Unbound")),f=new q.visual.Bar(n,c.leaf,{extensionId:"leaf"}).lockMark("visible").override("defaultColor",function(e){return d(e)
...
});new q.visual.Bar(n,c.node,{extensionId:"ascendant",noHover:!0,noSelect:!0,noClick:!0,noDoubleClick:!0,noTooltip:!0}).intercept("visible",function(e){return!!e.parent&&!!e.firstChild&&this.delegateExtension(!0)
...
}return null}).pvMark.antialias(!1);var v=q.visual.ValueLabel.maybeCreate(n,c.label,{noAnchor:!0});
...
},_buildScene:function(){function e(t){var i=t.group;if(t.vars.category=tt.fromComplex(i),a.onNewScene(t,!0),r&&!t.vars.size.value)return t.parentNode&&t.parentNode.removeChild(t),t;
var n=i.children().where(function(e){return null!=e.value}).array();if(s){var l=o&&!n.length?i.parent:i;
if(l){var u=s.view(l);t.vars.color=new tt(u.keyTrimmed(),u.label)}else t.vars.color=new tt(null,"")
}else t.parent||(t.vars.color=new tt(null,""));return n.forEach(function(i){e(new q.visual.Scene(t,{source:i}))
}),t}var t=this.visibleData({ignoreNulls:!1});if(!t.childCount())return null;var i=this.visualRoles,n=new q.visual.Scene(null,{panel:this,source:t}),a=new q.visual.RoleVarHelper(n,"size",i.size,{allowNestedVars:!0,hasPercentSubVar:!0}),r=i.size.isBound(),s=i.color&&i.color.grouping,o=s&&"byparent"===this.plot.option("ColorMode");
return e(n)}}),q.PlotPanel.registerClass(q.TreemapPanel),e.type("pvc.TreemapChart",q.BaseChart).add({_axisClassByType:{size:q.visual.NormalizedAxis},_axisCreateIfUnbound:{color:!0},_getTranslationClass:function(t){return e.type(this.base(t)).methods({_configureTypeCore:function(){this._configureTypeByOrgLevel(["category"],["size"])
...
},_initAxes:function(t){return this.visualRoles.color.isDiscrete()?(e.hasOwnProp.call(this,"_axisClassByType")||(this._axisClassByType=Object.create(this._axisClassByType)),this._axisClassByType.color=q.visual.TreemapDiscreteColorAxis):delete this._axisClassByType,this.base(t)
},defaults:{legend:null}}),q.parseSunburstSliceOrder=q.makeEnumParser("sliceOrder",["bySizeAscending","bySizeDescending","none"],"bySizeDescending"),q.parseSunburstColorMode=q.makeEnumParser("colorMode",["fan","slice"],"fan"),e("pvc.visual.SunburstPlot",q.visual.Plot.extend({init:function(t,i){if(this.base(t,i),!(t instanceof q.SunburstChart))throw e.error(e.format("Plot type '{0}' can only be used from within a sunburst chart.",[this.type]))
...
},createVisibleData:function(e,t){return this.visualRoles.category.select(e,t)},_initDataCells:function(){this.base(),this._addDataCell(new q.visual.DataCell(this,"size",this.option("SizeAxis")-1,this.visualRoles.size,this.option("DataPart")))
}},options:{SizeRole:{resolve:"_resolveFixed",value:"size"},SizeAxis:{resolve:"_resolveFixed",value:1},ValuesAnchor:{cast:q.parseAnchor,value:"center"},ValuesVisible:{value:!0},ValuesMask:{resolve:"_resolveFull",value:"{category}"},ValuesOptimizeLegibility:{value:!0},ColorMode:{resolve:"_resolveFull",cast:q.parseSunburstColorMode,value:"fan"},RootCategoryLabel:{resolve:"_resolveFull",cast:String,value:"All"},SliceOrder:{resolve:"_resolveFull",cast:q.parseSunburstSliceOrder,value:"bySizeDescending"},EmptySlicesVisible:{resolve:"_resolveFull",cast:Boolean,value:!1},EmptySlicesLabel:{resolve:"_resolveFull",cast:String,value:""}}})),q.visual.Plot.registerClass(q.visual.SunburstPlot),e("pvc.visual.SunburstDiscreteColorAxis",q.visual.ColorAxis.extend({methods:{domainItemValueProp:function(){return this.role&&this.role.grouping.isSingleDimension?"value":"absKey"
...
}):e.fun.constant(100),s=n.pvSunburstPanel=new q.visual.Panel(n,n.pvPanel,{panelType:t.Layout.Partition.Fill,extensionId:"panel"}).pvMark.lock("visible",!0).lock("nodes",a.nodes()).lock("size",r).lock("orient","radial"),o=new q.visual.SunburstSlice(this,s.node,{extensionId:"slice",tooltipArgs:{options:{useCorners:!0,gravity:function(){var e=this.midAngle(),t=Math.cos(e)>=0,i=Math.sin(e)>=0;
return t?i?"nw":"sw":i?"ne":"se"}}}}),l=q.visual.ValueLabel.maybeCreate(n,s.label,{noAnchor:!0});
...
if(!(-1e-6>a)&&"center"===n.textAlign()&&i){var r=q.normAngle(e.midAngle),s=q.normAngle(n.textAngle()),o=Math.abs(r-s)<1e-6,l=!1;
...
},_buildScene:function(){function t(e){var i=e.group,n=e.vars.category=tt.fromComplex(i);
...
e.vars.color=new tt(o.keyTrimmed(),o.label)}else e.vars.color=new tt(null,"");return s.each(function(i){t(new q.visual.SunburstScene(e,{source:i}))
...
})}return i(o,0),o}}),q.PlotPanel.registerClass(q.SunburstPanel),e.type("pvc.visual.SunburstScene",q.visual.Scene).add({_createSelectedInfo:function(){var e=this.chart().data.owner.selectedCount()>0,t=e&&this.datums().all(i.Datum.isSelected);
return{any:e,is:t}}}),e.type("pvc.SunburstChart",q.BaseChart).add({_axisClassByType:{size:q.visual.NormalizedAxis,color:q.visual.SunburstDiscreteColorAxis},_axisCreateIfUnbound:{color:!0},_getTranslationClass:function(t){return e.type(this.base(t)).methods({_configureTypeCore:function(){this._configureTypeByOrgLevel(["category"],["size"])
}})},_getIsNullDatum:e.fun.constant(),_createPlotsInternal:function(){var e=new q.visual.SunburstPlot(this);
this._addPlot(e),this.options.legend=!1}}),e("pvc.visual.SunburstSlice",q.visual.Sign.extend({init:function(i,n,a){var r=n.add(t.Wedge);
...
}})},_createPlotsInternal:function(){this._addPlot(new q.visual.BulletPlot(this))
...
},crosstabMode:!1,seriesInRows:!1,dataTypeCheckingMode:"extended"}}),e.type("pvc.BulletChartPanel",q.PlotPanel).add({plotType:"bullet",pvBullets:null,pvBullet:null,data:null,onSelectionChange:null,_createCore:function(e){var i,n,a,r,s,o,l,u,c,h=this.chart,d=h.options,f=this.buildData(),v=this,p="horizontal"==d.orientation?"left":"bottom";
...
}}if(this.pvBullets=this.pvPanel.add(t.Panel).data(f)[q.BasePanel.orthogonalLength[p]](i)[q.BasePanel.parallelLength[p]](this.chart.options.bulletSize).margin(20).left(l).top(u),this.pvBullet=this.pvBullets.add(t.Layout.Bullet).orient(p).ranges(function(e){return e.ranges
...
},this).array():[v]}}),q.PlotPanel.registerClass(q.BulletChartPanel),e.type("pvc.ParallelCoordinates",q.BaseChart).init(function(e){e=e||{},e.dimensions=e.dimensions||{},e.dimensions.value||(e.dimensions.value={valueType:null}),this.base(e)
}).add({parCoordPanel:null,_createContent:function(t,i){this.parCoordPanel=new q.ParCoordPanel(this,t,e.create(i,{topRuleOffset:this.options.topRuleOffset,botRuleOffset:this.options.botRuleOffset,leftRuleOffset:this.options.leftRuleOffset,rightRuleOffset:this.options.rightRuleOffset,sortCategorical:this.options.sortCategorical,mapAllDimensions:this.options.mapAllDimensions,numDigits:this.options.numDigits}))
},defaults:e.create(q.BaseChart.prototype.defaults,{compatVersion:1,topRuleOffset:30,botRuleOffset:30,leftRuleOffset:60,rightRuleOffset:60,sortCategorical:!0,mapAllDimensions:!0,numDigits:0})}),e.type("pvc.ParCoordPanel",q.BasePanel).add({anchor:"fill",pvParCoord:null,dimensions:null,dimensionDescr:null,data:null,retrieveData:function(){var e=this.chart.data,t=this.chart.options.numDigits;
...
return _[t].min=Math.max(x[t].domain()[0],x[t].invert(a-e.y-e.dy)),_[t].max=Math.min(x[t].domain()[1],x[t].invert(a-e.y)),S=t,A.render(),!1
}function i(e){if(e.dy<3){var t=e.dim;_[t].min=Math.max(x[t].domain()[0],x[t].invert(0)),_[t].max=Math.min(x[t].domain()[1],x[t].invert(a)),e.y=o,e.dy=h,S=t,A.render()
...
for(var T in R.map)R.map.hasOwnProperty(T)&&(k[k.length]={x:I,y:x[R.id](R.map[T])+M,label:T})
}}this.pvPanel.add(t.Panel).data(k).add(t.Label).left(function(e){return e.x}).bottom(function(e){return e.y
}).text(function(e){return e.label}).textAlign("left");var A=this.pvPanel.add(t.Panel);
A.add(t.Panel).data(n.data).visible(w).add(t.Line).data(f).left(function(e){return b(e)
}).bottom(function(e,t){return x[e](t[e])}).strokeStyle(function(e,t){var i=v[S],n=i.orgValue&&!i.categorical?i.orgValue[t[S]]:t[S];
return y[S](n)}).lineWidth(1);var L=A.add(t.Panel).data(f.map(function(e){return{y:o,dy:h,dim:e}
...
}),this.extend(this.pvParCoord,"parCoord"),this.extend(this.pvPanel,"chart")}}),e.type("pvc.DataTree",q.BaseChart).init(function(e){e=e||{},e.dimensionGroups=e.dimensionGroups||{},e.dimensionGroups.value||(e.dimensionGroups.value={valueType:null}),this.base(e)
...
o.configureType(),a||(a=this.structEngine=new i.Data({type:r})),a.load(o.execute(a)),e.debug>=3&&this.log(this.structEngine.getInfo()),this.dataTreePanel=new q.DataTreePanel(this,t,e.create(n,{topRuleOffset:this.options.topRuleOffset,botRuleOffset:this.options.botRuleOffset,leftRuleOffset:this.options.leftRuleOffset,rightRuleOffset:this.options.rightRuleOffset,boxplotColor:this.options.boxplotColor,valueFontsize:this.options.valueFontsize,headerFontsize:this.options.headerFontsize,border:this.options.border,perpConnector:this.options.perpConnector,numDigits:this.options.numDigits,minVerticalSpace:this.options.minVerticalSpace,connectorSpace:this.options.connectorSpace,minAspectRatio:this.options.minAspectRatio}))
},defaults:{compatVersion:1,topRuleOffset:30,botRuleOffset:30,leftRuleOffset:60,rightRuleOffset:60,boxplotColor:"grey",headerFontsize:16,valueFontsize:20,border:2,perpConnector:!1,numDigits:0,connectorSpace:.15,minVerticalSpace:.05,minAspectRatio:2}}),e.type("pvc.DataTreePanel",q.PlotPanel).add({pvDataTree:null,treeElements:null,structMap:null,structArr:null,hRules:null,vRules:null,rules:null,generatePerpConnectors:function(e){this.hRules=[],this.vRules=[],this.rules=[];
...
},applyExtensions:function(){this.extend(this.pvDataTree,"dataTree")}}),q});