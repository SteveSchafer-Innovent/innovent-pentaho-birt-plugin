...
r=l?l(s,i):s}r=e.string.to(r),!r&&e.debug>=2&&e.log("Only the null value should have an empty label."),o=new It.Atom(this,s,r,i,n),a&&(o.isVirtual=!0)
...
i=new It.Atom(this,null,s,null,""),this.data._atomsBase[this.name]=i}else i=_.call(this.parent||this.linkParent,t);
this._atomsByKey[""]=this._nullAtom=i,this._atoms.unshift(i)}return i}function y(){return this.owner===this||e.assert("Can only create atoms on an owner dimension."),this._virtualNullAtom||(this._virtualNullAtom=new It.Atom(this,null,"",null,""),this.data._atomsBase[this.name]=this._virtualNullAtom),this._virtualNullAtom
...
i[s]=(r||0)+(t?1:-1),this._visibleAtoms=this._sumCache=this._visibleIndexes=null}}function I(){var e=this._atomVisibleDatumsCount;
return e||(e={},this.data.datums(null,{visible:!0}).each(function(t){var i=t.atoms[this.name],n=i.key;
e[n]=(e[n]||0)+1},this),this._atomVisibleDatumsCount=e),e}function x(e){var t=[];
...
return new It.GroupingDimensionSpec(s,a,i)})}function Y(t,i){function n(){var n={},r=e.query(s.source).select(function(e){i(e,n);
...
if(s.region&&(n=e.getOwn(Ft,s.primary)))return n}return e.getOwn(Ft,qt,null)}var It=e.globalSpace("cdo",{});
...
var a=e.get(s,"valueType")||null,o=It.DimensionType.valueTypeName(a),l=e.getOwn(It.DimensionType.cast,o,null);
...
m?d=It.format(e.set({},p,m),f):this.isDiscreteValueType?d=Et(null,f):(d=e.get(s,"format"),d||u||(d=e.get(s,"rawFormat"),d&&(d=d.replace(/-/g,"/"))),d?e.is(d,Et)||((e.string.is(d)||e.fun.is(d)&&!e.classOf(d))&&(d=e.set({},p,d)),d=Et(d,f)):d=Et(null,f),m=d[p]()),this._formatter=m||null,this._format=d||null
...
}}),It.DimensionType.cast={Date:function(e){return e instanceof Date?e:new Date(e)
},Number:function(e){return e=Number(e),isNaN(e)?null:e},String:String,Boolean:Boolean,Object:Object,Any:null},It.DimensionType.dimensionGroupName=function(e){return e.replace(/^(.*?)(\d*)$/,"$1")
},It.DimensionType.valueTypeName=function(t){if(null==t)return"Any";switch(t){case Boolean:return"Boolean";
...
}},It.DimensionType.extendSpec=function(t,i,n){var s=It.DimensionType.dimensionGroupName(t),r=e.get(n,"dimensionGroups");
...
var n=new It.DimensionType(this,t,i);this._dims[t]=n,this._dimsIndexByName=null;var s,r=n.group;
...
var n=this._dims[t];if(!n){var s=It.DimensionType.extendSpec(t,null,i);this.addDimension(t,s)
...
},_createDim:function(t,i){var n=It.DimensionType.dimensionGroupName(t),s=this._dimGroupSpecs[n];
...
s=It.DimensionType.extendSpec(n,s,t),e.addDimension(n,s)}),this._calcList.forEach(function(i){e.addCalculation(i,t)
...
}});var xt=1;e.type("cdo.Complex").init(function(t,i,n,s,r,a){var o=this;o.id=xt++;
...
n&&(t?t+=i+n:t=n)}),this.label=t}return t},view:function(e){return new It.ComplexView(this,e)
...
},this),t.join(" ")},rightTrimKeySep:function(e){return e&&It.Complex.rightTrimKeySep(e,this.owner.keySep)
},absKeyTrimmed:function(){return this.rightTrimKeySep(this.absKey)},keyTrimmed:function(){return this.rightTrimKeySep(this.key)
}}),It.Complex.rightTrimKeySep=function(e,t){if(e&&t)for(var i,n=t.length;e.lastIndexOf(t)===(i=e.length-n)&&i>=0;)e=e.substr(0,i);
return e},It.Complex.values=function(e,t){var i=e.atoms;return t.map(function(e){return i[e].value
})},It.Complex.compositeKey=function(e,t){var i=e.atoms;return t.map(function(e){return i[e].key
}).join(e.owner.keySep)},It.Complex.labels=function(e,t){var i=e.atoms;return t.map(function(e){return i[e].label
})};var Rt=e.propGet("id");e.type("cdo.ComplexView",It.Complex).init(function(e,t){this.source=e,this.viewDimNames=t,this.base(e,e.atoms,t,e.owner.atoms,!0)
}).add({values:function(){return It.Complex.values(this,this.viewDimNames)},labels:function(){return It.Complex.labels(this,this.viewDimNames)
}}),e.type("cdo.Datum",It.Complex).init(function(e,t){this.base(e,t,null,null,!1,!0)
...
},toggleVisible:function(){return this.setVisible(!this.isVisible)}});var Lt=It.Datum.isSelected=e.propGet("isSelected");
It.Datum.isSelectedT=u,It.Datum.isSelectedF=c,It.Datum.isVisibleT=h,It.Datum.isVisibleF=d,It.Datum.isNullT=m,It.Datum.isNullF=f,e.type("cdo.TrendDatum",It.Datum).init(function(e,t,i){this.base(e,t),this.trend=i
}).add({isVirtual:!0,isTrend:!0}),e.type("cdo.InterpolationDatum",It.Datum).init(function(e,t,i,n){this.base(e,t),this.interpolation=i,this.interpDimName=n
...
},isVisible:function(t){return this._lazyInit&&this._lazyInit(),e.hasOwn(this._atomsByKey,t.key)||e.assert("Atom must exist in this dimension."),I.call(this)[t.key]>0
...
},indexes:function(i){this._lazyInit&&this._lazyInit();var n=e.get(i,"visible");return null==n?t.range(0,this._atoms.length):(n=!!n,this._visibleIndexes||(this._visibleIndexes={}),this._visibleIndexes[n]||(this._visibleIndexes[n]=x.call(this,n)))
},atom:function(e){if(null==e||""===e)return this._nullAtom;if(e instanceof It.Atom)return e;
...
}return n?r||0:r},percent:function(e,t){var i=e instanceof It.Atom?e.value:e;if(!i)return 0;
...
},intern:function(t,i){if(null==t||""===t)return this._nullAtom||_.call(this,t);if(t instanceof It.Atom){if(t.dimension!==this)throw e.error.operationInvalid("Atom is of a different dimension.");
...
}}),e.type("cdo.Data",It.Complex).init(function(i){i||e.fail.argumentRequired("keyArgs"),this._visibleNotNullDatums=new e.Map;
...
return!(t instanceof It.Atom)||null==t.value},this)),e},isOwner:function(){return this.owner===this
...
}},disposeChildren:function(){A.call(this)}}),It.Data.add({selectedCount:function(){return this.isOwner()?this._selectedNotNullDatums.count:this.datums(null,{selected:!0}).count()
...
});return n|=It.Data.setSelected(t,!0)},clearSelected:function(e){if(this.owner!==this)return this.owner.clearSelected(e);
...
}),this._selectedNotNullDatums.clear()),t}}),It.Data.setSelected=function(t,i){var n=0;
return t&&e.query(t).each(function(e){n|=e.setSelected(i)}),!!n},It.Data.toggleSelected=function(t,i){e.array.isLike(t)||(t=e.query(t).array());
var n=e.query(t),s=i?n.any(Lt):n.all(l);return this.setSelected(t,!s)},It.Data.setVisible=function(t,i){var n=0;
return t&&e.query(t).each(function(e){n|=e.setVisible(i)}),!!n},It.Data.toggleVisible=function(t){e.array.isLike(t)||(t=e.query(t).array());
var i=e.query(t).all(e.propGet("isVisible"));return It.Data.setVisible(t,!i)},It.Data.add({load:function(t,i){O.call(this);
var n=e.get(i,"where"),s=e.get(i,"isNull"),r=e.query(t).select(function(e){var t=new It.Datum(this,e);
...
},groupBy:function(t,i){var n,s,r=new It.GroupingOper(this,t,i),a=r.key;return a&&(n=this._groupByCache,s=n&&n[a]),s?e.debug>=7&&e.log("[GroupBy] Cache key hit '"+a+"'"):(e.debug>=7&&e.log("[GroupBy] "+(a?"Cache key not found: '"+a+"'":"No Cache key")),s=r.execute(),a&&((n||(this._groupByCache={}))[a]=s)),s
},where:function(t,i){var n;if(t)t=K.call(this,t,i),n=U.call(this,t,i);else{if(!i)return e.query(this._datums);
n=j(e.query(this._datums),i)}var s=z(t,i);return new It.Data({linkParent:this,datums:n,where:s})
...
}return a}}),It.whereSpecPredicate=Q,It.Data.add({getInfo:function(){var t=["DATA SUMMARY",e.logSeparator,"  Dimension",e.logSeparator];
...
}).add({key:null,execute:e.abstractMethod}),e.type("cdo.GroupingOper",It.DataOper).init(function(t,i,n){i||e.fail.argumentRequired("groupingSpecs"),this.base(t,n),this._where=e.get(n,"where"),this._visible=e.get(n,"visible",null),this._selected=e.get(n,"selected",null);
...
var o=[];this._groupSpecs=e.array.as(i).map(function(i){if(i instanceof It.GroupingSpec){if(i.type!==t.type)throw e.error.argumentInvalid("groupingSpecText","Invalid associated complex type.")
}else i=It.GroupingSpec.parse(i,t.type);return o.push(i.id),i}),r&&(this.key=o.join("!!")+"$"+[this._visible,this._isNull,a].join("||"))
...
}}u||this._groupSpecRecursive(t,g,s+1)}var a=n.flatteningMode===It.FlatteningMode.DfsPost,o=n.levels,l=o.length,u=s===this._groupSpecs.length-1,c=[],h={},d={key:"",absKey:"",atoms:{},datums:[],label:n.rootLabel,dimNames:[]},m=function(e){c.push(e),h[e.key]=e
...
n.absKey=a,n.key=It.Complex.rightTrimKeySep(a,i)}else n.absKey=t},_generateData:function(t,i,n,s){var r,a;
if(t.isRoot)s?(r=s,F.call(r,t.datums)):(a=!0,r=new It.Data({linkParent:n,datums:t.datums}),r.treeHeight=t.treeHeight,r._groupOper=this);
else if(s&&(r=n.child(t.key),r&&E.call(r,t.datums)),!r){a=!0;var o,l;s&&(l=n.childNodes)&&(o=~e.array.binarySearch(l,t.datums[0],i.groupLevelSpec.comparer)),r=new It.Data({parent:n,atoms:t.atoms,atomsDimNames:t.dimNames,datums:t.datums,index:o})
...
return n!==i.flatteningMode||s!==i.rootLabel?new It.GroupingSpec(i.levels,i.type,{flatteningMode:n,rootLabel:s}):i
},_singleLevelGrouping:function(t){var i=!!e.get(t,"reverse"),n=this.dimensions().select(function(e){return i?new It.GroupingDimensionSpec(e.name,!e.reverse,e.type.complexType):e
}),s=new It.GroupingLevelSpec(n,this.type);return new It.GroupingSpec([s],this.type,{flatteningMode:null,rootLabel:e.get(t,"rootLabel")||this.rootLabel})
},_reverse:function(t){var i=e.query(this.levels).select(function(t){var i=e.query(t.dimensions).select(function(e){return new It.GroupingDimensionSpec(e.name,!e.reverse,e.type.complexType)
});return new It.GroupingLevelSpec(i,this.type)},this);return new It.GroupingSpec(i,this.type,{flatteningMode:e.get(t,"flatteningMode")||this.flatteningMode,rootLabel:e.get(t,"rootLabel")||this.rootLabel})
...
}}),It.GroupingSpec.parse=function(t,i){if(!t)return new It.GroupingSpec(null,i);
var n=e.string.is(t)?t.split(/\s*,\s*/):e.array.as(t),s=e.query(n).select(function(e){var t=$(e,i);
return new It.GroupingLevelSpec(t,i)});return new It.GroupingSpec(s,i)};var kt=/^\s*(.+?)(?:\s+(asc|desc))?\s*$/i;
...
this._isCatDiscrete=s.grouping.isDiscrete(),this._stretchEnds=o,this._catInfos=l.select(function(e,t){var i=n.child(e.key);
return catInfo={data:i||e,value:e.value,isInterpolated:!1,serInfos:null,index:t},catInfo.serInfos=u.map(function(e){var t=i;
t&&e&&(t=t.child(e.key));var n=t?t.dimensions(c.name).value(h):null;return{data:e,group:t,value:n,isNull:null==n,catInfo:catInfo}
}),catInfo}).array(),this._serCount=u.length,this._serStates=e.range(0,this._serCount).select(function(e){return new It.LinearInterpolationOperSeriesState(this,e)
...
e.copyOwn(d,l.data.atoms);var m=o._valDim,f=m.intern(r,!0);d[m.name]=f,o._newDatums.push(new It.InterpolationDatum(a.owner,d,"linear",m.name))
...
return{data:e,group:t,value:n,isNull:null==n,catInfo:s}}),s}).array(),this._serCount=u.length,this._serStates=e.range(0,this._serCount).select(function(e){return new It.ZeroInterpolationOperSeriesState(this,e)
},this).array()}).add({interpolate:function(){for(var e;e=this._catInfos.shift();)e.serInfos.forEach(this._visitSeries,this);
var t=this._newDatums;t.length&&this._data.owner.add(t)},_visitSeries:function(e,t){this._serStates[t].visit(e)
},nextUnprocessedNonNullCategOfSeries:function(e){for(var t=0,i=this._catInfos.length;i>t;){var n=this._catInfos[t++],s=n.serInfos[e];
...
c[h.name]=d,a._newDatums.push(new It.InterpolationDatum(r.owner,c,"zero",h.name))
...
}return s.length?s:null}}),e.type("cdo.MatrixTranslationOper",It.TranslationOper).add({_initType:function(){this.J=this.metadata.length,this.I=this.source.length,this._processMetadata(),this.base()
...
case"object":return e instanceof Date?1:0}return 0},logSource:function(){var t=It.previewRowsMax,i=It.previewColsMax,n=this.metadata,s=n.length,r=e.array.prepend;
...
},this)}}),It.previewRowsMax=15,It.previewColsMax=6,e.type("cdo.CrosstabTranslationOper",It.MatrixTranslationOper).add({_translType:"Crosstab",logicalColumnCount:function(){return this.R+this.C+this.M
...
if(s){var r=e.fun.constant(this._plot2SeriesKeySet);this._dataPartGet(r)}}}}),e.type("cdo.RelationalTranslationOper",It.MatrixTranslationOper).add({M:0,C:0,S:0,_translType:"Relational",_processMetadata:function(){this.base();
...
},this)}});var Tt=It.numberFormatStyle=function(e,t){return new Ot(e,t)},At=e.priv.key().property(),Ot=Tt.of=e("cdo.NumberFormatStyle",e.FieldsBase.extend({init:function(){e.classify(this,Tt)
...
var Gt=It.numberFormat=function(t,i){function n(e){return r||(r=Z(s.mask)),r(e,At(s.style))
...
var Mt={},Pt=0,Vt=It.dateFormat=function(t,i){function n(e){return r||(r=gt(s.mask)),r(e)
}var s,r;return n.format=n,n.tryConfigure=vt,e.classify(n,Vt),s=e.instance(n,t,i,{mask:{cast:String,change:function(){r=null
}}}),arguments.length&&e.configure(n,arguments[0]),n};Vt.defaults=Vt();var Bt=It.customFormat=function(t,i){function n(){var e=s.formatter;
...
};Bt.defaults=Bt().formatter(yt);var qt="en-us",Et=It.format=function(t,i){function n(){}n.tryConfigure=wt;
...
};Et.defaults=Et({number:"#,0.##",percent:"#,0.#%",date:"%Y/%m/%d",any:Bt()});var Ft={},Kt=Ft[qt]=Et.defaults,jt=It.format.language=function(t,i){var n=arguments.length;
...
return It.format}}return St(t,!0)}if(2==n)return Dt(t,i);throw e.error.operationInvalid("Wrong number of arguments")
};return jt({"en-gb":{number:{mask:"#,0.##",style:{integerPad:"0",fractionPad:"0",decimal:".",group:",",groupSizes:[3],abbreviations:["k","m","b","t"],negativeSign:"-",currency:"£"}},date:{mask:"%d/%m/%Y"}},"pt-pt":{number:{mask:"#,0.##",style:{integerPad:"0",fractionPad:"0",decimal:",",group:" ",groupSizes:[3],abbreviations:["k","m","b","t"],negativeSign:"-",currency:"€"}},date:{mask:"%d/%m/%Y"}}}),It
});