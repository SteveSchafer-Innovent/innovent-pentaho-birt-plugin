define(
	...
	function(util, ReportFormatUtil, Messages, registry) {
		return function() {
			return logged({
				...
				load: function() {
					pentaho.common.Messages.addUrlBundle(
						'reportviewer', 
						CONTEXT_PATH + 'i18n?plugin=reporting&name=reportviewer/messages/messages');
				},
				...
				_hideLoadingIndicator: function() {
					try{
						...
						// Ignore "Same-origin policy" violation in embedded IFrame
					}
				},
